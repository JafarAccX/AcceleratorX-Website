...
const features = [
  {
    ...
    description:
      "Secure digital identity verification through decentralized systems.",
    size: "small",
    image: (
  ...
  },
  {
    ...
    description: "Seamless blockchain integration for enhanced security.",
    size: "large",
    image: (
      <motion.svg className="w-full h-full" viewBox="0 0 200 200">
        <defs>
  ...
  },
  {
    ...
    description: "Monitor and manage digital assets in real-time.",
    size: "large",
    image: (
      <motion.svg className="w-full h-full" viewBox="0 0 200 200">
        <defs>
  ...
  },
  {
    ...
    description: "Effortlessly handle business needs of any size.",
    size: "small",
    image: (
      <motion.svg className="w-full h-full" viewBox="0 0 200 200">
        <defs>
