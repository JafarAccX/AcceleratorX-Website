...
export const MetaTrackingDebugger: React.FC = () => {
  ...
  // Guard against SSR where window is undefined and wait for client hydration
  if (!isMounted || typeof window === 'undefined' || import.meta.env.MODE !== 'development' || !window.location.hostname.includes('localhost')) {
    return null;
  }
