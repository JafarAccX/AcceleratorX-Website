...
const cards = [
  {
    ...
    description: "Master the future of product management with AI integration",
    icon: Sparkles,
    className:
  ...
  },
  {
    ...
    description: "Build your portfolio with actual products",
    icon: Code,
    className: "bg-gradient-to-br from-blue-500/10 to-cyan-500/10",
  },
  {
    title: "Career Growth",
    description: "94% placement rate",
    icon: Target,
