...
interface YearEndEnrollmentModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSubmit?: () => void;
...
// Central brochure map (reused for consistency)
const BROCHURES: Record<string, { title: string; url: string }> = {
    ...
    "AI Product Management": { // Mapping specifically for the card title
        title: "Product Management",
        url: "https://firebasestorage.googleapis.com/v0/b/acceleratorx-lms.firebasestorage.app/o/class-notes%2F1762861871432_notes_AcceleratorX_PM_Brochure-compressed.pdf?alt=media&token=f21f29c9-522a-4d26-a948-2ab6f19a4760",
    }
};
...
export default function YearEndEnrollmentModal({ isOpen, onClose, onSubmit, initialCourse }: YearEndEnrollmentModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const submissionData = {
                ...
                utm_source: "Year End Landing Page",
                utm_medium: utmData.utm_medium,
                utm_campaign: "Year End Campaign",
                            ...
                            <div className="sticky top-0 bg-gray-800/95 px-4 py-3 border-b border-gray-700 z-10">
                                ...
                                <div className="flex flex-col gap-1 pr-8">
                                    ...
                                    <p className="text-xs md:text-sm text-gray-300">
                                        Unlock your potential with our expert-led programs.
                                    </p>
                                </div>
                            </div>
                                ...
                                <form onSubmit={handleSubmit} className="p-4 space-y-3 flex flex-col gap-4">
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            ...
                                            >
                                                ...
                                                <option value="AI Digital Marketing">AI Digital Marketing</option>
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <button
                                            ...
                                            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 rounded-lg transition-colors focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800 text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                                        >
