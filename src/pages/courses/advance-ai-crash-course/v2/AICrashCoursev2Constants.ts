...
export const CRASH_PHASES = [
  { icon: "/assets/skills/Container (2).png", title: "Discovery", description: "Understand AI fundamentals, use cases, and how Advanced AI solves real business problems.", phase: "PHASE 01" },
  { icon: "/assets/skills/Icon.png", title: "Strategy", description: "Design AI-first solutions, automation strategies, and system workflows.", phase: "PHASE 02" },
  { icon: "/assets/skills/Container (3).png", title: "Design", description: "Build structured AI workflows using prompt engineering and system design thinking.", phase: "PHASE 03" },
  { icon: "/assets/skills/Container (4).png", title: "Build", description: "Create AI agents, automation systems, and AI-powered tools.", phase: "PHASE 04" },
  { icon: "/assets/skills/Icon (1).png", title: "Analyze", description: "Optimize AI outputs, track performance, and improve system efficiency.", phase: "PHASE 05" },
  { icon: "/assets/skills/Container (5).png", title: "Grow", description: "Scale AI systems across business use cases and deploy production-level solutions.", phase: "PHASE 06" },
];
...
export const PRICING_PLANS = [
  {
    ...
    features: [
      ...
      "Advanced Agentic Learning Track",
      "Multi-Agent Strategy Workshops",
      "Deep-dive Simulation Access",
