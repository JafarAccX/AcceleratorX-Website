            ...
            <div className="w-full max-w-[1295px] mx-auto relative flex flex-col lg:flex-row items-center lg:items-start px-4 sm:px-6 lg:px-0 z-10 gap-10 lg:gap-0">
                <div className="w-full lg:w-[612px] flex flex-col gap-6 sm:gap-8 lg:mt-[60px] text-center lg:text-left">
                    <div className="flex flex-col gap-4 sm:gap-6">
                        <h1 className="text-[28px] sm:text-[36px] md:text-[42px] lg:text-[48px] font-medium leading-[1.1] tracking-tight max-w-[700px] text-white mx-auto lg:mx-0">
                            20 Weeks{" "}
                ...
                <div className="w-full lg:w-[649px] h-auto relative flex justify-center lg:justify-end">
                    <div className="relative w-full max-w-[400px] sm:max-w-[500px] lg:max-w-[649px] lg:w-[649px] aspect-[649/683] lg:h-[683px] bg-gradient-to-b from-[#000000] to-[#FC6401] rounded-[32px] sm:rounded-[48px] border-t border-t-black border-b border-b-white/5 border-x-0 overflow-hidden mt-6 lg:mt-0">
                        ...
                        <div className="absolute top-6 sm:top-10 right-0 z-10">
                            <img src={ASSETS.ibmLogo} alt="IBM" className="h-[50px] sm:h-[64px] lg:h-[84px] brightness-200" />
                        </div>

                        <div className="absolute top-4 sm:top-8 left-4 sm:left-8 z-10 drop-shadow-[0_20px_40px_rgba(0,0,0,0.3)]">
                            <img src={ASSETS.studentsGrp} alt="Happy Students" className="w-[140px] sm:w-[170px] lg:w-[208px] h-auto object-contain" />
                        </div>
...
export const AlumniLogos = () => (
    <section className="w-full max-w-[1440px] mx-auto px-4 md:px-8 lg:px-[70px] py-12 sm:py-16 lg:py-24 pb-16 sm:pb-20 lg:pb-32 overflow-hidden">
        ...
        `}</style>
        <div
            className="font-['Open_Sans',sans-serif] font-bold text-[12px] leading-[16px] tracking-[1.2px] uppercase mb-4 text-center bg-clip-text text-transparent"
            style={{ backgroundImage: 'linear-gradient(90deg, #3E38E0 0%, #5B46C1 33%, #BF7759 66%, #F7921E 100%)' }}
        >
            SOCIAL PROOF
        </div>
