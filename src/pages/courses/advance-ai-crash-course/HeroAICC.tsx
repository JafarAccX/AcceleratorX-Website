...
export default function HeroAICC() {
    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{ backgroundImage: "url('/redesign/ai-crash-course/ai-crash course-hero.webp')" }}
            />
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10">
                ...
                <Typewriter
                    text="ACCELERATING YOUR AI JOURNEY. . ."
                ...
                {isTypingDone && (
                    ...
                    >
                        ...
                        <div className="grid lg:grid-cols-12 gap-8 items-start relative z-10">
                            ...
                            >
                                <ProgramBadge text="INTENSIVE CRASH COURSE" />
                            </motion.div>
                            ...
                            <motion.div
                                ...
                                animate={{ opacity: 1, x: 0 }}
                                transition={{ duration: 0.6, delay: 0.4 }}
                                className="lg:col-span-8 items-end flex flex-col gap-4 relative"
                            >

                                <p className="font-sans text-gray-200 relative text-lg leading-relaxed mb-10 max-w-2xl text-right lg:text-left">
                                    Master the most in-demand AI skills — from LLMs and AI Agents to automation and real-world deployment — in a fast-paced, hands-on crash course built for rapid career impact.
                                </p>
                        ...
                        >
                            ...
                            <div className="flex-1 border border-white/20 dark:border-[#848484]/30 rounded-2xl p-4 md:p-6 bg-white/5 dark:bg-[#171717]/50 backdrop-blur-sm min-w-0 md:min-w-[240px] hover:bg-white/10 dark:hover:bg-[#171717]/80 transition-all duration-300">
                                ...
                                <div className="font-sans text-gray-300 text-xs md:text-base font-medium">Average Salary Package</div>
                            </div>
                            {/* Stat 2 */}
                            <div className="flex-1 border border-white/20 dark:border-[#848484]/30 rounded-2xl p-4 md:p-6 bg-white/5 dark:bg-[#171717]/50 backdrop-blur-sm min-w-0 md:min-w-[240px] hover:bg-white/10 dark:hover:bg-[#171717]/80 transition-all duration-300">
                                <div className="mb-1 md:mb-2"><Counter end={50000} suffix=" +" /></div>
                                <div className="font-sans text-gray-300 text-xs md:text-base font-medium">AI Job Openings</div>
                            </div>
                        </motion.div>
                    </motion.div>
                )}
