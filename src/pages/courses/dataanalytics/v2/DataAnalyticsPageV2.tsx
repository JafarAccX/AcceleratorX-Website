                    ...
                    <div className="w-full flex justify-center mt-2 sm:mt-4">
                        <div className="relative group w-full max-w-[664px] min-h-[100px] sm:min-h-[111px] h-auto py-[10px] sm:py-4 cursor-pointer">
                            ...
                            <div className="relative pl-6 sm:pl-10 flex flex-col gap-1 h-full justify-center text-left">
                                <div className="flex items-center gap-3">
                                    <img src={currentPath[4].icon} alt={currentPath[4].title} loading="lazy" className="w-5 h-5 sm:w-6 sm:h-6 object-contain" />
...
const PROGRAM_BENEFITS = [
    {
        icon: <img src="/assets/COMPUTER.png" alt="1:1 Mentorship" loading="lazy" className="w-8 h-8 object-contain" />,
    ...
    {
        icon: <img src="/assets/COMPUTER.png" alt="Industry-Relevant Curriculum" loading="lazy" className="w-8 h-8 object-contain" />,
    ...
    {
        icon: <img src="/assets/COMPUTER.png" alt="Career-Focused Learning" loading="lazy" className="w-8 h-8 object-contain" />,
