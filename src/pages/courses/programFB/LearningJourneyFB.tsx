...
import ProgressBar from "../productmanagement/ProgressBar";
import WeeklyContent from "../productmanagement/WeeklyContent";

export default function LearningJourneyFB() {
