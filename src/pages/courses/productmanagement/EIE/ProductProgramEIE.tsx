                ...
                <main className="lg:w-3/4 space-y-24">
                    ...
                    <section id="checklist" className="scroll-mt-24">
                        <div className="max-w-[1267px] mx-auto text-center px-4 sm:px-6">
                            ...
                            <h2 className="font-heading text-2xl sm:text-3xl md:text-[32px] font-medium text-white mb-4 sm:mb-6 tracking-tight">AI Product Management Skill Checklist</h2>
                            <p className="text-[#CFCFCF] text-[14px] sm:text-[16px] max-w-[850px] mx-auto mb-12 sm:mb-20 leading-relaxed font-medium">
                                2,000+ learners across India are already building real AI skills
                                and getting hired at top companies. Track your progress through our industry-vetted curriculum designed to take you from product fundamentals to AI-powered PM mastery.
                            </p>
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-y-10 sm:gap-y-12 gap-x-3 sm:gap-x-4">
                                    {PM_PHASES.map((phase, i) => (
                                        <div key={i} className="flex flex-col items-center text-center group cursor-default h-full">
                                            <div className="w-14 h-14 sm:w-20 sm:h-20 rounded-full bg-[#111] border-2 border-[#45E4C9]/20 flex items-center justify-center mb-4 sm:mb-6 relative z-10 group-hover:border-[#45E4C9]/60 group-hover:bg-[#45E4C9]/5 transition-all duration-500 shadow-[0_0_15px_rgba(69,228,201,0.05)]">
                                                <div 
                                                    className="w-4 h-4 sm:w-5 sm:h-5 transition-transform duration-500 group-hover:scale-110"
                                                    style={{
                                                        backgroundColor: '#45E4C9',
                                            ...
                                            <span className="mt-auto text-[#45E4C9] text-[10px] font-bold tracking-[0.1em] uppercase">{phase.phase}</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
