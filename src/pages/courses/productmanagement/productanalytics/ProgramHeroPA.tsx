...
export default function ProgramHeroPA() {
    ...
    return (
        ...
        >
            <div className="absolute inset-0 z-0 bg-no-repeat bg-cover bg-top"
                style={{ backgroundImage: "url('/redesign/product-analytics/hero.webp')" }}
            />
                ...
                {isTypingDone && (
                    ...
                    >
                        ...
                        <div className="grid lg:grid-cols-12 gap-8 items-start">
                            ...
                            >
                                <ProgramBadge text="0+ Live Sessions • Built for PMs • Career Accelerator" />
                            </motion.div>
                            ...
                            >
                                <p className="font-sans text-gray-200 text-lg leading-relaxed mb-6 max-w-2xl text-left lg:text-right">
                                    Move beyond opinions and gut-feel. Learn to use product analytics
                                    to drive roadmap decisions, growth bets, and leadership trust.
                                </p>
