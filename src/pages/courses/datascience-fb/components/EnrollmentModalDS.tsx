...
interface EnrollmentModalDSProps {
    isOpen: boolean;
    onClose: () => void;
    onSubmit?: () => void;
    program?: {
...
function resolveBrochure(course?: string | null) {
    if (!course) return BROCHURES["Data Analytics"]; // default to DA for this modal if unknown
    ...
    return foundKey ? BROCHURES[foundKey] : BROCHURES["Data Analytics"];
}
...
export default function EnrollmentModalDS({ isOpen, onClose, onSubmit, program, customData }: EnrollmentModalDSProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Specifically for the Data Science page as requested using Generative AI Pixel if DEFAULT_PIXEL_ID is GenAI
            // The course name here is likely "Data Science Program" which won't match DA_COURSE_NAMES
