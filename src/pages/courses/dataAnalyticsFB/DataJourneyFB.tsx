...
export default function DataJourneyFB() {
    ...
    <div className="relative py-16 px-0 sm:px-4 md:px-6 lg:px-8 overflow-x-hidden bg-[#0B1120]">
      ...
      >
        ...
        <Tab.Group onChange={handleTabChange} selectedIndex={currentWeek - 1}>
          <div className="glass-effect rounded-2xl p-0.5 sm:p-2 shadow-xl backdrop-blur-sm bg-white/5">
            <Tab.List
                ...
                <Tab
                  ...
                  className={({ selected }) =>
                    clsx(
                      ...
                      "focus:outline-none ring-offset-2 ring-offset-blue-400 focus:ring-2",
                      "px-4 py-2.5 text-sm font-medium",
                      "transition-all duration-200 ease-in-out",
                      selected
                        ? "bg-white shadow-md text-black"
                        : "text-white hover:bg-white/[0.12] hover:text-white/90"
                    )
                  }
                >
                  Week {week.week}
        ...
        <div className="flex flex-row justify-center items-center gap-4 mt-8 glass-effect p-4 rounded-xl backdrop-blur-sm bg-white/5">
