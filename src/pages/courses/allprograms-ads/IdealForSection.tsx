...
export default function IdealForSection({ program }: { program: any }) {
    const idealForTags = programContent[program.label]?.idealFor || [];
        ...
        <section className="py-24 bg-black relative overflow-hidden">
            ...
            <div className="flex flex-col gap-6 w-full relative max-w-7xl mx-auto">
                ...
                <div className="relative flex overflow-hidden w-full">
                    ...
                    >
                        {[...idealForTags, ...idealForTags, ...idealForTags].map((tag, idx) => (
                            <div
                                key={idx}
