      ...
      <div className="container mx-auto px-4 relative z-10 ">
        <div className="  mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-sm text-blue-400 font-medium">GenAI for Product Managers</span>
          </div>
          ...
          <p className="text-gray-400 text-lg mb-12 max-w-3xl mx-auto">
            Learn how to leverage Generative AI to streamline product workflows, boost team productivity, and deliver better products—faster.
          </p>
...
export default GENIntroduction;
