            ...
            <div ref={containerRef} className="max-w-7xl mx-auto px-4 lg:px-8 flex flex-col lg:flex-row gap-12">
                ...
                <main className="lg:w-3/4 space-y-24">
                    ...
                    <section id="mentors" className="scroll-mt-24">
                        <h3 className="text-2xl font-serif font-bold mb-8 dark:text-white transition-colors duration-300">Mentors from Top Tech Labs</h3>
                    ...
                    <section id="career" className="scroll-mt-24">
                        <h3 className="text-2xl font-serif font-bold mb-8 dark:text-white transition-colors duration-300">Career Outcomes for AI PMs</h3>
                    ...
                    <section id="pricing" className="scroll-mt-24">
                        ...
                        <div className="flex justify-center">
                            <div className="bg-blue-50/50 dark:bg-[#171717] border border-blue-100 dark:border-[#848484]/30 rounded-2xl p-8 max-w-sm w-full text-center hover:shadow-lg transition-all duration-300">
                                <h4 className="font-bold text-gray-900 dark:text-white mb-2 transition-colors duration-300">GenAI for PM Mastery</h4>
                                <p className="text-xs text-gray-500 dark:text-gray-400 mb-6 transition-colors duration-300">8-week specialized program</p>
