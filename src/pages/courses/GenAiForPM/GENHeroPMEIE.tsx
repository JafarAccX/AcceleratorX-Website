...
export default function GENHeroPMEIE() {
    ...
    const handleModalSubmit = () => {
        if (isDownload) {
            window.open(
                "https://grdwabozcrwjwdytwpqa.supabase.co/storage/v1/object/sign/resumes/AI%20Product%20Management.pdf?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV80Njc1NTVlNS1jOGMxLTQwOTYtYmQxMC03YzkzODVjZWEyMjQiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJyZXN1bWVzL0FJIFByb2R1Y3QgTWFuYWdlbWVudC5wZGYiLCJpYXQiOjE3NTI5NDAyNTgsImV4cCI6MTkxMDYyMDI1OH0.G_76x9UvPkLjExI9dTtDhmvkh3fQdwwWZ1lugGzv1l4"
            );
        }
        handleModalClose();
    };
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10">
                ...
                >
                    <h1 className="text-5xl md:text-7xl font-serif text-white dark:text-white leading-tight font-medium">
                        ...
                        <span className="italic">GenAI for Product Managers</span>
                    </h1>
                </motion.div>
                ...
                <div className="grid lg:grid-cols-12 gap-8 items-start">
                    ...
                    >
                        <p className="text-gray-200 dark:text-gray-300 text-lg leading-relaxed mb-10 max-w-2xl text-right lg:text-left transition-colors duration-300">
                            Learn GenAI, Build Real Products, and Launch Your PM Career Into the Future — No Tech Background Needed. Master context engineering, roadmap generation, and AI agent building specifically for the PM role.
                        </p>
                ...
                >
                    ...
                    {/* Stat 2 */}
                    <div className="flex-1 border border-white/20 dark:border-[#848484]/30 rounded-2xl p-4 md:p-6 bg-white/5 dark:bg-[#171717]/50 backdrop-blur-sm min-w-0 md:min-w-[240px] hover:bg-white/10 dark:hover:bg-[#171717]/80 transition-colors duration-300">
                        <div className="mb-1 md:mb-2"><Counter end={15000} suffix=" +" /></div>
