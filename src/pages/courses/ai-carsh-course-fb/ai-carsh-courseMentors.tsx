...
const AICrashCourseMentors: React.FC = () => {
    ...
    return (
        <section className="py-20 px-4 md:px-8 max-w-7xl mx-auto">
            ...
            <div className="relative max-w-6xl mx-auto">
                {/* Scroll Buttons - Desktop Only logic if needed, but keeping simple */}
                <button
                    onClick={() => scroll('left')}
                    className="absolute -left-4 md:-left-16 top-1/2 -translate-y-1/2 z-10 w-[56px] h-[56px] rounded-[50px] shadow-[0px_0px_16px_0px_#AC0AE7] hidden md:flex items-center justify-center bg-black transition-transform hover:scale-105"
                    style={{
                ...
                <button
                    ...
                    className="absolute -right-4 md:-right-16 top-1/2 -translate-y-1/2 z-10 w-[56px] h-[56px] rounded-[50px] shadow-[0px_0px_16px_0px_#AC0AE7] hidden md:flex items-center justify-center bg-black transition-transform hover:scale-105"
                    style={{
                        background: 'linear-gradient(#000, #000) padding-box, linear-gradient(86.48deg, #AC0AE7 32.08%, #48A2EB 74.28%) border-box',
                        border: '2px solid transparent',
                    }}
                ...
                <div
                    ref={scrollRef}
                    className="flex overflow-x-auto gap-6 pb-8 snap-x snap-mandatory scrollbar-hide px-4 justify-center md:justify-start"
