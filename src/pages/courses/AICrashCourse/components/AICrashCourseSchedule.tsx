    ...
    return (
        <section className="py-20 px-4 md:px-8 max-w-7xl mx-auto text-white">
            ...
            <div className="text-center mb-16">
                <h2 className="text-3xl md:text-5xl font-['Plus_Jakarta_Sans'] font-bold mb-4">
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-center justify-center">
                ...
                <div className="flex-1 max-w-xl">
                    <h3 className="text-2xl font-bold mb-8 font-['Plus_Jakarta_Sans']">Designed for Busy Professionals</h3>
                ...
                <div className="flex-1 w-full max-w-xl bg-[#0a0a0a] border border-[#252525] rounded-2xl p-6 md:p-8 relative">
                    <div className="flex justify-between items-center mb-6">
                        <h4 className="font-bold text-lg">Your Weekly Schedule</h4>
...
const ScheduleRow = ({ day, leftText, rightText, rightColor }: { day: string, leftText: string, rightText: string, rightColor: 'purple' | 'dark' }) => (
    <div className="flex items-center gap-4 text-sm font-medium">
        <span className="w-8 text-gray-500 flex-shrink-0">{day}</span>
        <div className="grid grid-cols-2 gap-2 flex-1">
            <div className="bg-[#1A1A1A] text-gray-400 rounded-lg py-2.5 flex items-center justify-center">
                {leftText}
            </div>
            <div className={`rounded-lg py-2.5 flex items-center justify-center ${rightColor === 'purple'
