    ...
    return (
        <section className="py-20 px-4 md:px-8 max-w-7xl mx-auto">
            <div className="text-center mb-20">
                <h2 className="font-heading text-4xl md:text-5xl font-bold mb-4 pb-2 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500 ">
                    Tools & technologies <span className=" text-white">you’ll use</span>
                </h2>
                <p className="font-sans text-gray-400 mb-2">Real Stack. Real Skills.</p>
                <p className="font-sans text-gray-300">You won't just "hear about" tools. You'll build with them live</p>
                <p className="font-sans text-gray-400 mt-2 text-sm uppercase tracking-wider">Hands-on experience with:</p>
            </div>
            ...
            <div className="relative max-w-4xl mx-auto h-[500px] md:h-[600px] flex items-center justify-center">
                ...
                <div className="relative w-40 h-40 md:w-48 md:h-48 rounded-full bg-black border border-purple-500 shadow-[0_0_50px_rgba(168,85,247,0.2)] flex flex-col items-center justify-center text-center z-10 p-4">
                    ...
                    <span className="font-sans text-purple-500 text-xs font-bold tracking-widest uppercase mb-1">Central</span>
                    <span className="font-heading text-white font-bold text-lg md:text-xl leading-tight">AI SYSTEM<br />CORE</span>
                </div>
            ...
            <div className="text-center mt-12">
                <p className="font-sans text-sm md:text-base flex items-center justify-center gap-2 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500">
...
const ToolIcon = ({ img, label, className }: { img: string, label: string, className?: string }) => (
    <div className={`flex flex-col items-center  w-20 md:w-24 ${className}`}>
        ...
        <span className="font-sans text-gray-300 text-xs md:text-sm font-medium">{label}</span>
    </div>
);
