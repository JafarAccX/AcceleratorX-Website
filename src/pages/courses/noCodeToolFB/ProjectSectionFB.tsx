...
import SectionHeading from "../nocodeTool/components/SectionHeading";
import ProjectCard from "../nocodeTool/components/ProjectCard";
...
export default ProjectsSectionFB;
