        ...
        <div className={`relative flex flex-col justify-center h-full z-10 ${idx % 2 === 0 ? 'pl-5 sm:pl-8 lg:pl-12 pr-6 sm:pr-8 lg:pr-20' : 'pl-[40px] sm:pl-[64px] lg:pl-[76px] pr-5 sm:pr-8 lg:pr-12'}`}>
            <div className="flex items-center justify-between gap-2 sm:gap-4 mb-1">
                ...
                <div
                    ...
                    style={{
                        background: "linear-gradient(#0A0A0A,#0A0A0A) padding-box, linear-gradient(90deg, #3B82F6, #2563EB, #1D4ED8) border-box",
                        border: "1px solid transparent"
                    }}
                >
                    <span className="text-[#3B82F6] text-[10px] sm:text-[12px] font-semibold tracking-[0.5px] whitespace-nowrap">{role.salary}</span>
                </div>
            </div>
            ...
            <div className="w-full max-w-[1440px] mx-auto relative flex flex-col lg:flex-row items-center lg:items-start px-4 sm:px-6 lg:px-[70px] z-10 gap-10 lg:gap-0">
                <div className="w-full lg:max-w-[45%] flex flex-col gap-6 sm:gap-8 lg:mt-[60px] text-center lg:text-left">
                    ...
                    <div className="w-full lg:w-[679px] flex flex-col gap-5 items-center lg:items-start overflow-hidden">
                        <div className="text-[10px] sm:text-[11px] font-bold text-white tracking-[0.1em] uppercase opacity-60">LEARNING WORKING ACROSS 1700+ COMPANIES</div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-8 lg:gap-14 pt-12">
    ...
    return (
        <section className="min-h-[500px] lg:min-h-[815px] py-12 sm:py-16 lg:py-24 px-4 md:px-8 lg:px-[70px] bg-[#0A0A0A]">
            <div className="max-w-[1440px] mx-auto text-center">
                ...
                <p className="text-2xl sm:text-3xl md:text-[32px] font-medium text-white mb-4 px-2">AI Data Science Roadmap for Working Professionals & Freshers</p>
                <p className="text-[#C2C2C2] text-[14px] sm:text-[16px] max-w-[1047px] mx-auto mb-8 sm:mb-10 leading-relaxed font-medium px-2">2,000+ learners across India are transitioning into data-driven careers by building AI-powered analytics projects and applying data science.</p>
                ...
                <div className="flex flex-col items-center">
                    <p className="text-white font-medium text-[16px] sm:text-[18px] mb-4 tracking-tight">
                        {roadmapPath === "freshers"
                            ? "Start Your Career in AI Data Science From Zero"
                ...
                <div className="mt-12 sm:mt-16 flex justify-center">
                    ...
                    >
                        <span className="border-b-2 border-[#3B82F6] pb-1">Download Brochure</span>
            ...
            <div className="max-w-[1200px] mx-auto text-center">
                ...
                <div className="flex flex-col lg:flex-row gap-6 sm:gap-[40px] items-center justify-center max-w-[1188px] mx-auto">
                    ...
                    <div className="flex flex-col items-center gap-6 flex-shrink-0 w-full max-w-[543px]">
                        <div className="relative w-full aspect-[543/334] rounded-[24px] sm:rounded-[32px] overflow-hidden border border-white/10 bg-[#0D0D0D]/60 backdrop-blur-sm shadow-2xl">
                            <div
    ...
    return (
        <section id="programs" className="py-12 sm:py-20 lg:py-[120px] px-4 sm:px-6 bg-[#0A0A0A]">
            <div className="max-w-[1200px] mx-auto text-center">
                ...
                <h2 className="text-2xl sm:text-3xl md:text-[32px] font-medium mt-4 text-white mb-4 sm:mb-6">What You Will Learn In This AI Data Science Course</h2>
                <p className="text-[#CFCFCF] text-[14px] sm:text-[16px] max-w-[900px] mx-auto mb-10 leading-relaxed">This program covers everything from fundamentals to advanced data analytics, AI-powered dashboards, and automation systems.</p>
                                                    ...
                                                    <div className="mt-4 pt-4 border-t border-white/5 flex flex-wrap gap-2">
                                                        {session.exercise && (
                                                            <div className="px-3 py-1.5 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[12px] font-medium italic">
                                                                <span className="font-bold not-italic mr-2">Exercise:</span> {session.exercise}
                                                            </div>
                                                        )}
                                                        {session.miniCase && (
                                                            <div className="px-3 py-1.5 rounded-lg bg-amber-500/10 border border-amber-500/20 text-amber-400 text-[12px] font-medium italic">
                                                                <span className="font-bold not-italic mr-2">Mini Case:</span> {session.miniCase}
                                                            </div>
                                                        )}
                                                        {session.handsOn && (
                                                            <div className="px-3 py-1.5 rounded-lg bg-[#3B82F6]/10 border border-[#3B82F6]/20 text-[#3B82F6] text-[12px] font-medium italic">
                                                                <span className="font-bold not-italic mr-2">Hands-on:</span> {session.handsOn}
                                                            </div>
                                                        )}
                                                        {session.case && (
                                                            <div className="px-3 py-1.5 rounded-lg bg-purple-500/10 border border-purple-500/20 text-purple-400 text-[12px] font-medium italic">
                                                                <span className="font-bold not-italic mr-2">Case Study:</span> {session.case}
                                                            </div>
                                                        )}
                                                    </div>
                                                )}
    ...
    return (
        <div className="relative bg-[#0D0D0D] rounded-[40px] border border-white/5 shadow-[0_0_100px_rgba(59,130,246,0.05)] overflow-hidden w-full max-w-[1100px] mx-auto p-8 lg:p-16 mt-20">
            ...
            <div className="relative w-full aspect-[2/1] min-h-[350px]">
                ...
                {/* Chart Grid Lines */}
                <div className="absolute top-[80px] bottom-10 left-[40px] sm:left-[50px] lg:left-[60px] right-0 flex flex-col justify-between">
                    {["₹75L", "₹60L", "₹45L", "₹30L", "₹15L", "₹0L"].map((val) => (
                        <div key={val} className="relative w-full border-t border-white/[0.03] h-0">
                            <span className="absolute -top-3 -left-[35px] sm:-left-[45px] lg:-left-[55px] w-10 text-right text-[10px] lg:text-[11px] font-medium text-[#64748B]">
                                {val}
                            </span>
                        </div>
                    ))}
                ...
                {/* Chart X-axis Labels */}
                <div className="absolute bottom-0 left-[40px] sm:left-[50px] lg:left-[60px] right-0 flex justify-between px-0 text-[10px] lg:text-[11px] font-medium text-[#64748B] pt-4">
                ...
                {/* Chart Vectors */}
                <svg className="absolute top-[80px] bottom-10 left-[40px] sm:left-[50px] lg:left-[60px] w-[calc(100%-50px)] sm:w-[calc(100%-65px)] h-[calc(100%-80px-40px)] overflow-visible" viewBox="0 0 1000 500" preserveAspectRatio="none">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8 sm:gap-10">
                ...
                <div className="flex-1 relative flex justify-center lg:justify-end">
                    <div className="relative w-full max-w-[400px] sm:max-w-[654px]" style={{ aspectRatio: '654/507' }}>
                        <img src="/assets/datascience/roles.png" alt="Career Opportunities" className="w-full h-full object-contain relative z-20" />
                    </div>
                </div>
            </div>
...
const BYDP = ({ onDownloadBrochure }: { onDownloadBrochure?: () => void }) => (
    <section className="py-12 sm:py-20 lg:py-[120px] px-4 sm:px-6 bg-[#0A0A0A] border-t border-white/[0.05]">
        <div className="max-w-[1047px] mx-auto text-center">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-[32px] font-medium text-white mb-10 sm:mb-16">Build Real AI Products That Get You Hired</h2>
                ...
                <div className="max-w-[1000px]">
                    ...
                    <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mb-10 sm:mb-12">
                        {[
                            ...
                            <div key={i} className="group relative flex items-center gap-2 px-5 py-2 sm:px-6 sm:py-2.5 rounded-full border border-[#3b82f6]/40 bg-[#0A0A0A] transition-all duration-300 hover:border-[#3b82f6] hover:bg-[#3b82f6]/5 hover:scale-105 hover:-translate-y-0.5 shadow-[0_0_15px_rgba(59,130,246,0.05)] hover:shadow-[0_0_25px_rgba(59,130,246,0.25)]">
                                <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-[#3b82f6] shadow-[0_0_8px_rgba(59,130,246,0.8)] group-hover:animate-pulse"></div>
                                <span className="text-[#3b82f6] text-[15px] sm:text-[16px] font-medium tracking-wide">{item}</span>
                            </div>
                        ))}
                    </div>
                    ...
                    <button
                        onClick={onDownloadBrochure}
                        className="px-10 py-4 rounded-full bg-[#3B82F6] text-white font-bold text-[16px] sm:text-[18px] hover:brightness-110 transition-all duration-300 shadow-[0_10px_30px_rgba(59,130,246,0.3)]"
                    >
                        Apply now
                    </button>
                </div>
                    ...
                    {visibleFaqs.map((f, i) => (
                        <div key={i} className="border border-white/5 rounded-2xl overflow-hidden">
                            <button
                                ...
                                className="w-full p-6 text-left flex justify-between items-center group hover:bg-white/[0.02] transition-all"
                            >
                                <span className="font-medium text-white transition-colors">{f.q}</span>
                                <ChevronDown className={`w-5 h-5 transition-transform duration-300 ${open === i ? "rotate-180 text-[#3B82F6]" : "text-white/40"}`} />
                            </button>
                            <div className={`transition-all duration-300 ease-in-out overflow-hidden ${open === i ? "max-h-[500px] opacity-100" : "max-h-0 opacity-0"}`}>
                                <div className="p-6 text-[#C2C2C2] font-regular leading-relaxed border-t border-white/5 mt-4 pt-4 pr-12">
                                    {f.a}
                                </div>
                            </div>
                        </div>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                <div className="flex-1 flex justify-center lg:justify-end w-full">
                    <div className="relative w-full max-w-[517px]">
                        <img
                            src="/assets/certificate/AI DATA SCIENCE.png"
                            alt="AI Data Science Certificate"
                ...
                <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-10 mt-10">
                        <button
                            onClick={onDownloadBrochure}
                            className="px-8 py-3.5 rounded-full bg-[#3B82F6] text-white font-bold text-[15px] sm:text-[16px] hover:brightness-110 transition-all duration-300 shadow-[0_10px_20px_rgba(59,130,246,0.2)]"
                        >
                            Apply now
                        </button>
                        <button
                        ...
                        >
                            <span className="border-b-2 border-[#3B82F6] pb-0.5">Download Brochure</span>
