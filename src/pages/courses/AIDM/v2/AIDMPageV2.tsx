...
const programBenefits = [
    {
        icon: <img src="/assets/COMPUTER.png" alt="Mentorship" loading="lazy" className="w-8 h-8 object-contain" />,
    ...
    {
        icon: <img src="/assets/COMPUTER.png" alt="Live Campaign-Based Learning" loading="lazy" className="w-8 h-8 object-contain" />,
    ...
    {
        icon: <img src="/assets/COMPUTER.png" alt="Industry-Relevant AI Marketing Curriculum" loading="lazy" className="w-8 h-8 object-contain" />,
                ...
                <div className="flex flex-col gap-4 max-w-[1100px] mx-auto" style={{ overflowAnchor: 'none' }}>
                    {currModules.map((m: any, i) => (
                        <div
                            key={i}
                            id={`module-${i}`}
                            className={`group relative border transition-all duration-300 rounded-[24px] overflow-hidden scroll-mt-navbar ${openModule === i ? 'bg-[#111] border-[#9EFF1F]/30' : 'bg-[#0D0D0D] border-white/5 hover:border-white/10'}`}
                        >
                            <div
                                onClick={() => {
                                    if (openModule === i) {
...
const Tools = () => (
    <section className="py-16 sm:py-24 bg-[#0A0A0A] flex flex-col items-center overflow-hidden border-t border-white/5">
        <div className="max-w-[1285px] flex flex-col items-center relative px-4 sm:px-6 md:px-0">
            ...
            <InfiniteScrollTools tools={TOOLS_LIST} accentColor="#9EFF1F" speed={40} />
                    ...
                    {PM_PHASES.map((phase, i) => (
                        <div key={i} className="flex flex-col items-center text-center group cursor-default h-full">
                            <div className="w-14 h-14 sm:w-20 sm:h-20 rounded-full bg-[#111] border-2 border-[#9EFF1F]/20 flex items-center justify-center mb-4 sm:mb-6 relative z-10 group-hover:border-[#9EFF1F]/60 group-hover:bg-[#9EFF1F]/5 transition-all duration-500 shadow-[0_0_15px_rgba(161,255,0,0.05)]">
                                <img src={phase.icon} alt={phase.title} loading="lazy" className="w-4 h-4 sm:w-5 sm:h-5 object-contain drop-shadow-md group-hover:scale-110 transition-transform duration-500" />
                            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
                ...
                <div className="flex-1 relative flex justify-center lg:justify-end">
                    <div className="relative w-full max-w-[400px] sm:max-w-[654px] aspect-[654/507]">
                        <img src={ASSETS.roles} alt="Career" loading="lazy" className="w-full h-full object-contain relative z-20" />
                    </div>
                </div>
