...
export default function AdvanceGenAIPageV2() {
    const { handleBuyCourse } = useCoursePurchase(COURSE_IDS.GENERATIVE_AI, "Advanced Generative AI");
        ...
        <div className="min-h-screen w-full bg-[#0A0A0A] text-white font-['Inter',sans-serif]">
            ...
            <EnrollmentModalADS
                ...
                program={{
                    ...
                    label: "Adv Gen AI",
                    description: "Master Agentic architecture, RAG systems, and autonomous task-oriented agents.",
                    color: "#FC6401",
                    link: "",
                    hoverBorder: ""
                }}
