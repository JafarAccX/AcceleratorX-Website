        ...
        <header className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-300 ${scrolled ? "bg-black/90 backdrop-blur-md py-3 sm:py-4 border-b border-white/5" : "bg-transparent py-5 sm:py-7"}`}>
            <nav className="w-full max-w-[1300px] mx-auto flex items-center justify-between px-4 sm:px-6">
                ...
                <div className="hidden lg:flex items-center gap-8 xl:gap-10">
                    <Link to="/" className="text-[#ADAAAA] hover:text-white text-[14px] font-medium transition-all relative group">
                        Home
                    </Link>
                    <div className="relative group cursor-pointer">
                        <span className="text-white text-[14px] font-medium transition-colors flex items-center gap-1.5 relative">
            ...
            <div className="w-full max-w-[1440px] mx-auto relative flex flex-col xl:flex-row items-center xl:items-start px-4 sm:px-6 lg:px-[70px] z-10 gap-10 xl:gap-0">
                <div className="w-full xl:max-w-[45%] flex flex-col gap-6 sm:gap-8 xl:mt-[60px] text-center xl:text-left">
                    <div className="flex flex-col gap-4 sm:gap-6">
                        <h1 className="text-[28px] sm:text-[36px] md:text-[42px] lg:text-[48px] font-medium leading-[1.1] tracking-tight max-w-[618px] text-white mx-auto xl:mx-0">
                            10 Weeks{" "}
                            <span className="bg-gradient-to-r from-[#F1F1F1] via-[#F5B183] to-[#FC6401] bg-clip-text text-transparent">
                                Advanced AI & AI Agent Course
                            </span>
                        </h1>
                    ...
                    <div className="w-full xl:w-[679px] flex flex-col gap-5 items-center xl:items-start overflow-hidden">
                        ...
                        <div className="relative w-full overflow-hidden" style={{
                            ...
                            <style>{`
                                ...
                                .animate-logos {
                                    animation: slide-logos 90s linear infinite;
                                }
                            `}</style>
