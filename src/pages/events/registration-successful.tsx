    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-300 text-lg">Loading your enrollment details...</p>
        </div>
      </div>
    );
  }
    ...
    >
      <div className="max-w-2xl w-full text-center space-y-8">
        ...
        >
          ...
          <p className="text-xl text-gray-300">Your enrollment for Product Teardown has been successfully submitted.</p>
        </motion.div>
            ...
            >
              ...
              <div className="relative flex items-center gap-4 bg-gray-900 p-4 rounded-[10px] transition-all duration-300 group-hover:bg-gray-900/80">
                ...
                <div className="flex flex-col items-start">
                  <span className="font-semibold text-lg text-white group-hover:text-green-400 transition-colors duration-300">
                    Join WhatsApp
                  </span>
                </div>
              </div>
