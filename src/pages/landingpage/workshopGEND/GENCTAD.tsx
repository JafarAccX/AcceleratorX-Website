      ...
      <div className="relative py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex flex-col items-center justify-center space-y-10">
            ...
            >
              Build & Fine-Tune Your Own AI Model – Live Workshop
            </motion.h2>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full">
                <div className="bg-white/5 p-4 rounded-lg text-center">
                  ...
                  <p className="text-lg font-bold text-green-400">Train Custom Models</p>
                  <p className="text-sm text-gray-400">From dataset to fine-tuned AI.</p>
                </div>
                <div className="bg-white/5 p-4 rounded-lg text-center">
                  ...
                  <p className="text-sm text-gray-400">Learn the process with mentor-led support.</p>
                </div>
                <div className="bg-white/5 p-4 rounded-lg text-center">
                  <Code className="w-6 h-6 text-blue-400 mx-auto mb-2" />
                  <p className="text-lg font-bold text-blue-400">Real Applications</p>
                  <p className="text-sm text-gray-400">Build something that actually works.</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <p>Join 100+ learners who have already trained and deployed their own LLMs.</p>
              <p>Click Register Now and start your fine-tuning journey today!</p>
              {/* Button */}
              <button
