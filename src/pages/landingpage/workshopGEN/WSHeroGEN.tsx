...
//               </motion.div>
//               <span className="text-blue-400 font-medium">AI Productivity Workshop</span>
//             </motion.div>
...
//               >
//                 In today's fast-paced world, staying productive often means finding smarter ways to manage tasks.
//                 Generative AI tools are revolutionizing how professionals handle their daily workflows, automating
//                 repetitive tasks, enhancing decision-making, and fostering creativity. From streamlining content
//                 creation to automating data analysis, AI-powered solutions can help you save time and focus on
//                 high-impact work.
//               </motion.p>
...
//                     </motion.div>
//                     <div>
//                       <span className="block text-white/80 text-sm">{item.text}</span>
//                       <span className="text-xs text-blue-400">{item.highlight}</span>
//                     </div>
//                   </motion.div>
//                 ))}
//               </div>
...
//                         Limited seats available only for the first 50 registrations
//                       </p>
//                     </motion.div>
//                   </div>
