        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-[#0A1020] rounded-lg p-8 border border-blue-900/20 shadow-md">
            ...
            <div className="text-center mb-8">
              ...
              >
                Boost Conversions — Powered by AI
              </motion.h2>
              ...
              <div className="inline-flex items-center gap-2 bg-blue-500/10 rounded-md px-4 py-2 mb-4">
                <span className="text-base text-blue-400 font-medium">
                  Register now for AI-driven conversion optimization
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              <div className="bg-[#111827] p-4 rounded-md border border-blue-500/10 text-center">
                ...
                <p className="text-sm text-gray-400">Optimize based on real user insights.</p>
              </div>
              <div className="bg-[#111827] p-4 rounded-md border border-green-500/10 text-center">
                ...
                <p className="text-sm text-gray-400">Leverage AI for smarter optimization.</p>
              </div>
              <div className="bg-[#111827] p-4 rounded-md border border-green-500/10 text-center">
                <p className="text-xl font-bold text-green-400 mb-1">Measurable</p>
                <p className="text-sm text-gray-400">Track and improve conversion metrics.</p>
              </div>
              <div className="bg-[#111827] p-4 rounded-md border border-green-500/10 text-center">
                <p className="text-xl font-bold text-blue-400 mb-1">Actionable</p>
                <p className="text-sm text-gray-400">Get clear steps to boost conversions.</p>
              </div>
            </div>
            ...
            <div className="flex justify-center">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
              >
                Start Optimizing Conversions Today
              </motion.button>
            </div>
          </div>
