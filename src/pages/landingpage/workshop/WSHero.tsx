            ...
            <div className="space-y-6">
              ...
              <h2 className="text-2xl lg:text-3xl font-semibold">
                ...
                <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-green-400 text-transparent bg-clip-text">
                  Real-World Generative AI Applications in Business Analytics
                </span>
              </h2>
              
              <p className="text-gray-300 text-lg lg:text-xl leading-relaxed max-w-2xl mx-auto lg:mx-0">
                Join us for an exclusive masterclass on how Generative AI is revolutionizing business analytics! 🚀 Learn how to leverage cutting-edge AI models to transform your data analysis workflows, generate actionable insights, and create predictive business intelligence that drives strategic decision-making.
              </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                {[
                  ...
                  { icon: <FaCalendarAlt className="text-purple-400 mb-1" />, label: "Date", value: "March 10" },
                  { icon: <FaClock className="text-green-400 mb-1" />, label: "Time", value: "7:30 PM" },
                  { icon: <FaUserGraduate className="text-yellow-400 mb-1" />, label: "Level", value: "All Levels" }
                ].map((item, index) => (
