...
import { FaLinkedin, FaDiscord, FaWhatsapp, FaInstagram } from "react-icons/fa";
      ...
      <div className="container mx-auto px-4 lg:pr-[450px]">
        <div className="text-center lg:text-left">
          ...
          <p className="text-gray-300 mb-8">
            Connect with tech enthusiasts and industry experts. Learn, share,
            and grow together.
          </p>
