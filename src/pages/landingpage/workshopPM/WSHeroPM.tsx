    ...
    <div className="relative bg-[#0A0F1D] min-h-screen overflow-x-hidden">
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-start justify-between gap-12 lg:gap-20 mt-24 md:mt-28">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4">
                {[
                  ...
                  { label: "Date", value: "Feb 15" },
                  { label: "Time", value: "7:30 PM" },
                  { label: "Level", value: "All Levels" }
                ].map((item, index) => (
                  <div 
                    key={index} 
                    className="bg-indigo-500/5 backdrop-blur-sm rounded-lg p-4 border border-indigo-500/10 hover:bg-indigo-500/10 transition-colors duration-300"
                  >
          ...
          <div className="hidden lg:block lg:w-5/12" ref={formRef}>
