...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900/5 to-slate-900">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-blue-600/20 via-purple-600/20 to-blue-600/20 opacity-50" />
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <div className="flex justify-center mb-8">
          <div className="inline-flex items-center bg-blue-500/20 text-blue-300 border border-blue-400/30 px-4 py-2 text-sm font-medium backdrop-blur-sm rounded-full">
        ...
        {/* Main heading */}
        <h1 className="text-4xl sm:text-5xl lg:text-4xl xl:text-7xl font-bold text-white mb-6 leading-tight">
          Still Wasting Hours on Manual Lead Work?
        </h1>
