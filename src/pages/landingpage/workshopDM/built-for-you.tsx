     ...
     <div
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl lg:text-4xl font-bold text-white mb-4 leading-tight">
            ...
            return (
              ...
              >
                ...
                <div className="mb-6 flex justify-center">
                  <div className={`bg-gradient-to-r ${persona.gradient} p-4 rounded-2xl group-hover:shadow-lg transition-all duration-300`}>
        ...
        <div className="text-center mt-16">
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            No matter your role, our workshop will help you build the automation skills you need to grow faster.
          </p>
