            ...
            <div className="relative z-10 text-left mb-8">
              <div className="space-y-6">
                ...
                <p className="text-gray-400 text-lg lg:text-xl leading-relaxed max-w-2xl">
                  Learn how to run high-converting ads with proven strategies! 🚀 Join our exclusive workshop and master the art of audience targeting, ad creatives, budgeting, and optimization to maximize your ROI. Perfect for marketers, entrepreneurs, and business owners looking to scale their growth through effective advertising. Reserve your spot now!
                </p>
