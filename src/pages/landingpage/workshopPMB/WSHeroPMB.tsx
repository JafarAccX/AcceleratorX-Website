...
const WSHeroPMB = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-b from-[#050A14] via-[#0A0F1F] to-[#050A14]">
      ...
      <div className="absolute bottom-20 left-10 w-64 h-64 bg-purple-600/10 rounded-full blur-3xl"></div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-1/2 space-y-6">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20">
              <span className="text-blue-400 font-medium text-sm"> No Complexity. No Tech Overwhelm.
              </span>
            </div>
            ...
            <div className="inline-flex flex-wrap items-center gap-3 px-4 py-2 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-lg border border-blue-500/20">
              <div className="text-yellow-400 text-sm font-medium">
                Learn Software Development the Smart Way — Free Workshop
              </div>
            ...
            <div className="grid grid-cols-4 gap-4 mt-6">
              {[
                ...
                { icon: <FaCalendarAlt className="text-indigo-400 mb-1" />, label: "Date", value: "Dec 07th" },
                {
          ...
          <div className="w-full lg:w-5/12">
            <div className="relative mx-auto max-w-md">
              {/* Simple border glow */}
              <div className="absolute -inset-1 bg-gradient-to-r from-blue-500/30 to-purple-500/30 rounded-xl blur-md"></div>
