...
// Course Pages - lazy loaded for performance
...
const DataScienceFBPage = lazy(() => import("../pages/courses/datascience-fb/DataScienceFBPage"));
...
const ProductManagementPageEIE = lazy(() => import("../pages/courses/EntryPoint/ProductManagementEIE"));
