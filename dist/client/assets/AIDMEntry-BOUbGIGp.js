const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AIDMChallenges-DMedPyFn.js","assets/main-CQZRSQfQ.js","assets/main-ClQXKXUm.css","assets/alert-triangle-CYHEdolD.js","assets/clock-CNEpsEKZ.js","assets/trending-up-EA7ntbVb.js","assets/AIDMSolution-CTYekf-H.js","assets/target-C5rFwECh.js","assets/rocket-o1zTBCUr.js","assets/AIDMRoadmap-LINAb2Lh.js","assets/EnrollmentModal-kIl_IML_.js","assets/enrollmentApi-JK_WiLhq.js","assets/metaPixel-BPrv2gAs.js","assets/brain-BCL-JS2Q.js","assets/zap-DlQUUmLb.js","assets/AIDMTools-CO5wgVw4.js","assets/bar-chart-CxcpZClc.js","assets/AIDMCareerOutcomes-BmGhlja2.js","assets/trophy-BA7Z0DlJ.js","assets/users-7HEfShSi.js","assets/star-BSrzaDRl.js","assets/AIDMMentors-BE-IXznS.js","assets/linkedin-Sv2hBCqD.js","assets/AIDMCertification-DhYYRcFe.js","assets/shield-OOVydg85.js","assets/check-circle-C2udps7u.js","assets/AIDMPricing-Bjjcx1UP.js","assets/check-BF5gEgUV.js","assets/AIDMFAQ-_mb6T7UI.js","assets/minus-ZrZX3K6y.js","assets/plus-Df1uNmHq.js","assets/AIDMFinalCTA-B7fp30f5.js"])))=>i.map(i=>d[i]);
import { r as reactExports, l as useCourseContext, j as jsxRuntimeExports, k as motion, S as SEO, _ as __vitePreload } from "./main-CQZRSQfQ.js";
...
const AIDMChallenges = reactExports.lazy(() => __vitePreload(() => import("./AIDMChallenges-DMedPyFn.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0));
const AIDMSolution = reactExports.lazy(() => __vitePreload(() => import("./AIDMSolution-CTYekf-H.js"), true ? __vite__mapDeps([6,1,2,7,8]) : void 0));
const AIDMRoadmap = reactExports.lazy(() => __vitePreload(() => import("./AIDMRoadmap-LINAb2Lh.js"), true ? __vite__mapDeps([9,1,2,10,11,12,13,14,8]) : void 0));
const AIDMTools = reactExports.lazy(() => __vitePreload(() => import("./AIDMTools-CO5wgVw4.js"), true ? __vite__mapDeps([15,1,2,5,16,14]) : void 0));
const AIDMCareerOutcomes = reactExports.lazy(() => __vitePreload(() => import("./AIDMCareerOutcomes-BmGhlja2.js"), true ? __vite__mapDeps([17,1,2,18,13,7,19,20]) : void 0));
const AIDMMentors = reactExports.lazy(() => __vitePreload(() => import("./AIDMMentors-BE-IXznS.js"), true ? __vite__mapDeps([21,1,2,19,22]) : void 0));
const AIDMCertification = reactExports.lazy(() => __vitePreload(() => import("./AIDMCertification-DhYYRcFe.js"), true ? __vite__mapDeps([23,1,2,24,18,25]) : void 0));
const AIDMPricing = reactExports.lazy(() => __vitePreload(() => import("./AIDMPricing-Bjjcx1UP.js"), true ? __vite__mapDeps([26,1,2,10,11,12,20,27]) : void 0));
const AIDMFAQ = reactExports.lazy(() => __vitePreload(() => import("./AIDMFAQ-_mb6T7UI.js"), true ? __vite__mapDeps([28,1,2,10,11,12,29,30]) : void 0));
const AIDMFinalCTA = reactExports.lazy(() => __vitePreload(() => import("./AIDMFinalCTA-B7fp30f5.js"), true ? __vite__mapDeps([31,1,2]) : void 0));
const AIDMEntry = () => {
  const {
    setSelectedCourse
  } = useCourseContext();
