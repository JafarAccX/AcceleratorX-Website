import { m, q as useLocation, r as reactExports, j as jsxRuntimeExports } from "./main-B8okaWNI.js";
const PMZoomDetails = {
...
const WorkshopProvider = ({ children }) => {
  ...
  const zoomMeetingDetails = workshopType === "PMWorkshop" ? PMZoomDetails : workshopType === "GENAIWorkshop" ? GENAIZoomDetails : workshopType === "GENAIBWorkshop" ? GENAIBZoomDetails : workshopType === "GENAICWorkshop" ? GENAICZoomDetails : workshopType === "GENAIDWorkshop" ? GENAIDZoomDetails : workshopType === "DMWorkshop" ? DMZoomDetails : workshopType === "DASecondWorkshop" ? DASecondZoomDetails : DAZoomDetails;
