...
import { r as resolveElements, m as motion } from "./proxy-CXL56B2m.js";
const thresholds = {
  some: 0,
  all: 1
};
                ...
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: "flex flex-col items-start gap-3 mb-4", whileHover: { gap: "0.875rem" }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 flex items-center justify-center bg-white rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/make.webp", alt: "make.com", className: "w-12 h-12 object-contain" }) }),
