import { l as useCourseContext, j as jsxRuntimeExports, B as Briefcase, k as motion } from "./main-Ck2PwlUp.js";
import { T as Trophy } from "./trophy-CZUynkyL.js";
...
const AIDMCareerOutcomes = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-medium text-gray-400 mb-4", children: "Career Outcome" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-4xl md:text-5xl font-bold text-[#5CB338]", children: "Where does this Nano Degree in AI Digital Marketing take you?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl text-gray-600 max-w-3xl mx-auto mt-6", children: "After completing this Nano Degree in AI Digital Marketing, you will be ready for AI Marketing jobs, freelancing projects, AI Marketing Consultant and many other fast-growing roles in marketing." })
    ] }),
