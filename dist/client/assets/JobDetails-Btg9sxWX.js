import { e as createLucideIcon, g as getDefaultExportFromCjs, j as jsxRuntimeExports, d as useParams, u as useNavigate, r as reactExports, b as useUser, X, B as Briefcase, z as zt } from "./main-BHL7Gc-I.js";
import { u as useGetJobById } from "./jobs-Brq31bIg.js";
import { u as useApplyForJob } from "./customer-Vwl7w7mE.js";
import { C as ChevronLeft } from "./chevron-left-7aYoCDPm.js";
import { B as Building2 } from "./building-2-CDWZZMqR.js";
import { G as Globe } from "./globe-Cmpm5EkM.js";
import { M as MapPin } from "./map-pin-BMBxouMn.js";
import { C as Clock } from "./clock-Cyjqv321.js";
import "./useQuery-36ELdqOT.js";
/**
  ...
  const handleApplyClick = async () => {
    ...
    if (job?.EasyApply) {
      applyForJobMutation.mutate(
        ...
        {
          onSuccess: () => {
            zt.success("Application submitted successfully!");
            setShowApplying(false);
            navigate("/jobs");
          },
          onError: () => {
            zt.error("Already applied");
          }
        }
      );
    } else {
      if (!job?.JobApplyURL) {
        zt.error("Job application URL not available");
        return;
      }
      try {
        applyForJobMutation.mutate(
        ...
        zt.success("Redirecting to company application page...");
        window.open(job.JobApplyURL, "_blank");
        setShowApplying(false);
      } catch (error2) {
        console.error("Failed to process external application:", error2);
        zt.error("Failed to open application page. Please try again.");
      }
    }
  };
