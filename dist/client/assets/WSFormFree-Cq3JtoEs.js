import { c as api, u as useNavigate, O as useLocation, r as reactExports, j as jsxRuntimeExports, z as zt, P as generateFormEventId, f as axios } from "./main-CDOtXgRK.js";
import { u as useWorkshop, r as registerForZoomMeeting } from "./registration-DmMPUoVt.js";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (axios.isAxiosError(error) && error.response?.status === 409) {
        zt.error("This email or phone number is already registered.");
      } else {
        zt.error("Registration failed. Please try again later.");
      }
    } finally {
