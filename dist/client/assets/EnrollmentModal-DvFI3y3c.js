import { i as useCourseContext, u as useNavigate, r as reactExports, j as jsxRuntimeExports, X, z as zt } from "./main-DS-AYwzb.js";
import { c as createEnrollment } from "./enrollmentApi--UjIqsAr.js";
...
function EnrollmentModal({ isOpen, onClose, onSubmit }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.phone.length < 10 || formData.phone.length > 12) {
      zt.error("Please enter a valid phone number (10-12 digits)");
      return;
    }
    ...
    try {
      ...
      zt.success("Enrollment submitted successfully!");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-full max-w-md mx-auto mt-auto md:mt-0 bg-gray-800/95 rounded-xl shadow-xl overflow-y-auto md:my-6 ", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-[85vh] md:h-auto flex flex-col", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: " shadow-2xl p-6 w-full border border-gray-800/30", id: "course-form", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "p-4 space-y-3", children: [
