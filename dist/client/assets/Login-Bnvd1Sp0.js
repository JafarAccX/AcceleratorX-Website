import { f as createLucideIcon, u as useNavigate, r as reactExports, j as jsxRuntimeExports, S as SEO, l as authService, c as _t } from "./main-qWvHMlpM.js";
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (success) {
        _t.success("Login successful!");
        navigate("/admin");
      } else {
        _t.error("Invalid credentials");
      }
    } catch (error) {
      console.error("Login error:", error);
      _t.error("An error occurred during login");
    } finally {
      setLoading(false);
    }
  };
