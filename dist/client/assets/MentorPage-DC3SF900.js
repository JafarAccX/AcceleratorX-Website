import { r as reactExports, j as jsxRuntimeExports, d as api, b as useUser } from "./main-DIFEnr0T.js";
  ...
  return {
    ...
    writeMessage(message, options) {
      ...
      try {
        ...
        throw new Error(m3 + (r2.length > 0 ? ": ".concat(r2) : ""));
      }
      return json;
    },
    ...
    equals(type, a, b2) {
      ...
      return type.fields.byMember().every((m3) => {
        ...
        if (m3.repeated) {
          ...
          switch (m3.kind) {
            case "message":
              return va.every((a2, i2) => m3.T.equals(a2, vb[i2]));
            case "scalar":
              return va.every((a2, i2) => scalarEquals(m3.T, a2, vb[i2]));
            case "enum":
          ...
          case "message":
            ...
            if (m3.T.fieldWrapper) {
              if (a2 !== void 0 && !isMessage(a2)) {
                a2 = m3.T.fieldWrapper.wrapField(a2);
              }
              if (b22 !== void 0 && !isMessage(b22)) {
                b22 = m3.T.fieldWrapper.wrapField(b22);
              }
            }
            return m3.T.equals(a2, b22);
          case "enum":
...
function shimGetUserMedia$2(window2, browserDetails2) {
  ...
  const constraintsToChrome_ = function(c3) {
    ...
    Object.keys(c3).forEach((key) => {
      ...
      const r2 = typeof c3[key] === "object" ? c3[key] : {
        ideal: c3[key]
      };
...
function r$1(r2, e2, n) {
  ...
  var a = null != (i2 = n.isImmediate) && i2, u2 = null != (t = n.callback) && t, c3 = n.maxWait, v2 = Date.now(), l2 = [];
  function f2() {
    if (void 0 !== c3) {
      var r3 = Date.now() - v2;
      if (r3 + e2 >= c3) return c3 - r3;
    }
    return e2;
  }
  var d2 = function() {
...
RegionUrlProvider.fetchLock = new _$1();
...
function s$1() {
  return s$1 = Object.assign ? Object.assign.bind() : function(e2) {
    ...
    return e2;
  }, s$1.apply(null, arguments);
}
const i = new Uint8Array(0);
class r {
  static getFullOptions(e2) {
    return s$1({ clientTools: {}, onConnect: () => {
    }, onDebug: () => {
    }, onDisconnect: () => {
    }, onError: () => {
    }, onMessage: () => {
...
let m$1 = class m extends c$1 {
  constructor(e2, t, n, o2) {
    super(), this.socket = void 0, this.conversationId = void 0, this.inputFormat = void 0, this.outputFormat = void 0, this.socket = e2, this.conversationId = t, this.inputFormat = n, this.outputFormat = o2, this.socket.addEventListener("error", (e3) => {
      ...
      try {
        ...
        if (!d$1(t2)) return void this.debug({ type: "invalid_event", message: "Received invalid socket event", data: e3.data });
  ...
  static async create(e2) {
    ...
    try {
      ...
      let i2;
      const r2 = (null == (o2 = e2.overrides) || null == (o2 = o2.client) ? void 0 : o2.version) || u$1, c3 = (null == (a = e2.overrides) || null == (a = a.client) ? void 0 : a.source) || "js_sdk";
      if (e2.signedUrl) {
        const t2 = e2.signedUrl.includes("?") ? "&" : "?";
        i2 = `${e2.signedUrl}${t2}source=${c3}&version=${r2}`;
      } else i2 = `${s3}/v1/convai/conversation?agent_id=${e2.agentId}&source=${c3}&version=${r2}`;
      const h2 = ["convai"];
      ...
      const v2 = await new Promise((n2, o3) => {
        t.addEventListener("open", () => {
          ...
          const t2 = JSON.parse(e3.data);
          d$1(t2) && ("conversation_initiation_metadata" === t2.type ? n2(t2.conversation_initiation_metadata_event) : console.warn("First received message is not conversation metadata."));
        }, { once: true });
      }), { conversation_id: g2, agent_output_audio_format: f2, user_input_audio_format: w2 } = v2, _3 = l(null != w2 ? w2 : "pcm_16000"), y2 = l(f2);
      return new m(t, g2, _3, y2);
    } catch (e3) {
      var s2;
...
class y extends c$1 {
  ...
  static async create(n) {
    ...
    if ("conversationToken" in n && n.conversationToken) o2 = n.conversationToken;
      ...
      try {
        var a, s2, i2;
        const e2 = (null == (a = n.overrides) || null == (a = a.client) ? void 0 : a.version) || u$1, t = (null == (s2 = n.overrides) || null == (s2 = s2.client) ? void 0 : s2.source) || "js_sdk", c4 = `${r2 = null != (i2 = n.origin) ? i2 : "https://api.elevenlabs.io", r2.replace(/^wss:\/\//, "https://")}/v1/convai/conversation/token?agent_id=${n.agentId}&source=${t}&version=${e2}`, l2 = await fetch(c4);
    ...
    const c3 = new Room();
    try {
      const e2 = `room_${Date.now()}`, a2 = l("pcm_48000"), s3 = l("pcm_48000"), i3 = new y(c3, e2, a2, s3, n), r3 = n.livekitUrl || "wss://livekit.rtc.elevenlabs.io";
      var d2;
      await c3.connect(r3, o2), await new Promise((e3) => {
        if (i3.isConnected) e3();
        else {
          const n2 = () => {
            c3.off(RoomEvent.Connected, n2), e3();
          };
          c3.on(RoomEvent.Connected, n2);
        }
      }), c3.name && (i3.conversationId = (null == (d2 = c3.name.match(/(conv_[a-zA-Z0-9]+)/)) ? void 0 : d2[0]) || c3.name), await c3.localParticipant.setMicrophoneEnabled(true);
      const u2 = p(n);
      return i3.debug({ type: h, message: u2 }), await i3.sendMessage(u2), i3;
    } catch (e2) {
      throw await c3.disconnect(), e2;
    }
  }
  setupRoomEventListeners() {
    ...
    this.room.on(RoomEvent.Connected, async function() {
      ...
      try {
        ...
        d$1(t2) ? this.handleMessage(t2) : console.warn("Invalid socket event received:", t2);
      } catch (t2) {
  ...
  async setupAudioCapture(e2) {
    try {
      ...
      o2.connect(this.outputAnalyser), await _2(t.audioWorklet);
      ...
      this.outputAnalyser.connect(a), a.port.postMessage({ type: "setFormat", format: this.outputFormat.format, sampleRate: this.outputFormat.sampleRate }), a.port.onmessage = (e3) => {
        const [t2, n2] = e3.data;
        if (n2 > 0.01) {
          const e4 = v$1(t2.buffer), n3 = this.audioEventId++;
...
async function k(e2 = { default: 0, android: 3e3 }) {
  let t = e2.default;
  var n;
...
class C extends r {
  static async startSession(e2) {
    ...
    let n = null;
    try {
      return await k(t.connectionDelay), n = await b(e2), new C(t, n);
    } catch (e3) {
      var o2;
...
class E {
  static async create({ sampleRate: e2, format: t, preferHeadphonesForIosDevices: n, inputDeviceId: o2, workletPaths: a, libsampleratePath: i2 }) {
    let r2 = null, c3 = null;
    try {
      const l3 = s$1({ sampleRate: { ideal: e2 } }, M);
      if (S() && n) {
      ...
      await _2(r2.audioWorklet, null == a ? void 0 : a.rawAudioProcessor);
      const h2 = s$1({ voiceIsolation: true }, l3);
      c3 = await navigator.mediaDevices.getUserMedia({ audio: h2 });
      const p2 = r2.createMediaStreamSource(c3), m3 = new AudioWorkletNode(r2, "rawAudioProcessor");
      return m3.port.postMessage({ type: "setFormat", format: t, sampleRate: e2 }), p2.connect(d2), d2.connect(m3), await r2.resume(), new E(r2, d2, m3, c3, p2);
    } catch (e3) {
      var l2, u2;
      throw null == (l2 = c3) || l2.getTracks().forEach((e4) => {
        e4.stop();
  ...
  async setInputDevice(e2) {
    try {
      ...
      const n = s$1({ voiceIsolation: true }, t), o2 = await navigator.mediaDevices.getUserMedia({ audio: n });
...
class I {
  static async create({ sampleRate: e2, format: t, outputDeviceId: n, workletPaths: o2 }) {
    ...
    try {
      ...
      const c3 = a.createMediaStreamDestination();
      s2.srcObject = c3.stream, r3.connect(i3), i3.connect(c3), await A(a.audioWorklet, null == o2 ? void 0 : o2.audioConcatProcessor);
      const l2 = new AudioWorkletNode(a, "audioConcatProcessor");
      return l2.port.postMessage({ type: "setFormat", format: t }), l2.connect(r3), await a.resume(), n && s2.setSinkId && await s2.setSinkId(n), new I(a, i3, r3, l2, s2);
    } catch (e3) {
      var i2, r2;
...
class D extends r {
  static async startSession(e2) {
    ...
    let o2 = null, a = null, i2 = null, c3 = null, l2 = null;
    ...
    try {
      var u2;
      return c3 = await navigator.mediaDevices.getUserMedia({ audio: true }), await k(n.connectionDelay), a = await b(e2), [o2, i2] = await Promise.all([E.create(s$1({}, a.inputFormat, { preferHeadphonesForIosDevices: e2.preferHeadphonesForIosDevices, inputDeviceId: e2.inputDeviceId, workletPaths: e2.workletPaths, libsampleratePath: e2.libsampleratePath })), I.create(s$1({}, a.outputFormat, { outputDeviceId: e2.outputDeviceId, workletPaths: e2.workletPaths }))]), null == (u2 = c3) || u2.getTracks().forEach((e3) => {
        e3.stop();
      }), c3 = null, new D(n, a, o2, i2, l2);
    } catch (e3) {
      var d2, h2, p2, m3;
      n.onStatusChange && n.onStatusChange({ status: "disconnected" }), null == (d2 = c3) || d2.getTracks().forEach((e4) => {
        e4.stop();
      }), null == (h2 = a) || h2.close(), await (null == (p2 = o2) ? void 0 : p2.close()), await (null == (m3 = i2) ? void 0 : m3.close());
      try {
        var v2;
  ...
  constructor(e2, t, n, o2, a) {
    super(e2, t), this.input = void 0, this.output = void 0, this.wakeLock = void 0, this.inputFrequencyData = void 0, this.outputFrequencyData = void 0, this.onInputWorkletMessage = (e3) => {
      "connected" === this.status && this.connection.sendMessage({ user_audio_chunk: v$1(e3.data[0].buffer) });
      ...
      this.volume = t2, this.connection instanceof y ? this.connection.setAudioVolume(t2) : this.output.gain.gain.value = t2;
  ...
  handleAudio(e2) {
    var t, n;
    this.lastInterruptTimestamp <= e2.audio_event.event_id && (null == (t = (n = this.options).onAudio) || t.call(n, e2.audio_event.audio_base_64), this.connection instanceof y || this.addAudioBase64Chunk(e2.audio_event.audio_base_64), this.currentEventId = e2.audio_event.event_id, this.updateCanSendFeedback(), this.updateMode("speaking"));
  }
  setMicMuted(e2) {
    this.connection instanceof y ? this.connection.setMicMuted(e2) : this.input.setMuted(e2);
  }
  getInputByteFrequencyData() {
  ...
  async changeInputDevice({ sampleRate: e2, format: t, preferHeadphonesForIosDevices: n, inputDeviceId: o2 }) {
    try {
      if (this.connection instanceof m$1) try {
        return await this.input.setInputDevice(o2), this.input;
      } catch (e3) {
        console.warn("Failed to change device on existing input, recreating:", e3);
      }
      this.connection instanceof y && await this.connection.setAudioInputDevice(o2 || ""), await this.input.close();
      const a = await E.create({ sampleRate: null != e2 ? e2 : this.connection.inputFormat.sampleRate, format: null != t ? t : this.connection.inputFormat.format, preferHeadphonesForIosDevices: n, inputDeviceId: o2, workletPaths: this.options.workletPaths, libsampleratePath: this.options.libsampleratePath });
  ...
  async changeOutputDevice({ sampleRate: e2, format: t, outputDeviceId: n }) {
    try {
      ...
      const o2 = await I.create({ sampleRate: null != e2 ? e2 : this.connection.outputFormat.sampleRate, format: null != t ? t : this.connection.outputFormat.format, outputDeviceId: n, workletPaths: this.options.workletPaths });
...
var F;
!(function(e2) {
  e2.SESSION_STARTED = "session_started", e2.PARTIAL_TRANSCRIPT = "partial_transcript", e2.COMMITTED_TRANSCRIPT = "committed_transcript", e2.COMMITTED_TRANSCRIPT_WITH_TIMESTAMPS = "committed_transcript_with_timestamps", e2.AUTH_ERROR = "auth_error", e2.ERROR = "error", e2.OPEN = "open", e2.CLOSE = "close";
})(F || (F = {}));
var O, L;
!(function(e2) {
...
class W extends r {
  static startSession(e2) {
    return e2.textOnly ? C.startSession(e2) : D.startSession(e2);
  }
}
function u() {
  return u = Object.assign ? Object.assign.bind() : function(n) {
    for (var e2 = 1; e2 < arguments.length; e2++) {
      var o2 = arguments[e2];
      for (var r2 in o2) ({}).hasOwnProperty.call(o2, r2) && (n[r2] = o2[r2]);
    }
    return n;
  }, u.apply(null, arguments);
}
const c2 = ["micMuted", "volume", "serverLocation"];
function s(n = "us") {
  switch (n) {
    case "eu-residency":
    case "in-residency":
...
function d(n) {
  return { us: "wss://api.elevenlabs.io", "eu-residency": "wss://api.eu.residency.elevenlabs.io", "in-residency": "wss://api.in.residency.elevenlabs.io", global: "wss://api.elevenlabs.io" }[n];
}
function v(n) {
  return { us: "wss://livekit.rtc.elevenlabs.io", "eu-residency": "wss://livekit.rtc.eu.residency.elevenlabs.io", "in-residency": "wss://livekit.rtc.in.residency.elevenlabs.io", global: "wss://livekit.rtc.elevenlabs.io" }[n];
}
function m2(r2 = {}) {
  const { micMuted: t, volume: l2, serverLocation: a } = r2, m3 = (function(n, e2) {
    if (null == n) return {};
    var o2 = {};
    for (var r3 in n) if ({}.hasOwnProperty.call(n, r3)) {
      if (-1 !== e2.indexOf(r3)) continue;
      o2[r3] = n[r3];
    }
    return o2;
  })(r2, c2), g2 = reactExports.useRef(null), h2 = reactExports.useRef(null), [p2, C2] = reactExports.useState("disconnected"), [S2, M2] = reactExports.useState(false), [T, b2] = reactExports.useState("listening"), w2 = reactExports.useRef(t), y2 = reactExports.useRef(l2);
  return w2.current = t, y2.current = l2, reactExports.useEffect(() => {
    var n;
    void 0 !== t && (null == g2 || null == (n = g2.current) || n.setMicMuted(t));
  }, [t]), reactExports.useEffect(() => {
    var n;
    void 0 !== l2 && (null == g2 || null == (n = g2.current) || n.setVolume({ volume: l2 }));
  }, [l2]), reactExports.useEffect(() => () => {
    var n;
    null == (n = g2.current) || n.endSession();
  }, []), { startSession: async (n) => {
    var e2;
    if (null != (e2 = g2.current) && e2.isOpen()) return g2.current.getId();
    if (h2.current) return (await h2.current).getId();
    try {
      var o2, r3, t2, l3, c3, p3, S3, T2, D2, f2;
      const e3 = s((null == n ? void 0 : n.serverLocation) || a), I2 = d(e3), A2 = v(e3);
      return h2.current = W.startSession(u({}, null != m3 ? m3 : {}, null != n ? n : {}, { origin: I2, livekitUrl: A2, overrides: u({}, null != (o2 = null == m3 ? void 0 : m3.overrides) ? o2 : {}, null != (r3 = null == n ? void 0 : n.overrides) ? r3 : {}, { client: u({}, null != (t2 = null == m3 || null == (l3 = m3.overrides) ? void 0 : l3.client) ? t2 : {}, null != (c3 = null == n || null == (p3 = n.overrides) ? void 0 : p3.client) ? c3 : {}, { source: (null == n || null == (S3 = n.overrides) || null == (S3 = S3.client) ? void 0 : S3.source) || (null == m3 || null == (T2 = m3.overrides) || null == (T2 = T2.client) ? void 0 : T2.source) || "react_sdk", version: (null == n || null == (D2 = n.overrides) || null == (D2 = D2.client) ? void 0 : D2.version) || (null == m3 || null == (f2 = m3.overrides) || null == (f2 = f2.client) ? void 0 : f2.version) || "0.10.0" }) }), onConnect: (null == n ? void 0 : n.onConnect) || (null == m3 ? void 0 : m3.onConnect), onDisconnect: (null == n ? void 0 : n.onDisconnect) || (null == m3 ? void 0 : m3.onDisconnect), onError: (null == n ? void 0 : n.onError) || (null == m3 ? void 0 : m3.onError), onMessage: (null == n ? void 0 : n.onMessage) || (null == m3 ? void 0 : m3.onMessage), onAudio: (null == n ? void 0 : n.onAudio) || (null == m3 ? void 0 : m3.onAudio), onDebug: (null == n ? void 0 : n.onDebug) || (null == m3 ? void 0 : m3.onDebug), onUnhandledClientToolCall: (null == n ? void 0 : n.onUnhandledClientToolCall) || (null == m3 ? void 0 : m3.onUnhandledClientToolCall), onVadScore: (null == n ? void 0 : n.onVadScore) || (null == m3 ? void 0 : m3.onVadScore), onInterruption: (null == n ? void 0 : n.onInterruption) || (null == m3 ? void 0 : m3.onInterruption), onAgentToolResponse: (null == n ? void 0 : n.onAgentToolResponse) || (null == m3 ? void 0 : m3.onAgentToolResponse), onConversationMetadata: (null == n ? void 0 : n.onConversationMetadata) || (null == m3 ? void 0 : m3.onConversationMetadata), onMCPToolCall: (null == n ? void 0 : n.onMCPToolCall) || (null == m3 ? void 0 : m3.onMCPToolCall), onMCPConnectionStatus: (null == n ? void 0 : n.onMCPConnectionStatus) || (null == m3 ? void 0 : m3.onMCPConnectionStatus), onAsrInitiationMetadata: (null == n ? void 0 : n.onAsrInitiationMetadata) || (null == m3 ? void 0 : m3.onAsrInitiationMetadata), onAgentChatResponsePart: (null == n ? void 0 : n.onAgentChatResponsePart) || (null == m3 ? void 0 : m3.onAgentChatResponsePart), onModeChange: ({ mode: e4 }) => {
        var o3;
        b2(e4), null == (o3 = (null == n ? void 0 : n.onModeChange) || (null == m3 ? void 0 : m3.onModeChange)) || o3({ mode: e4 });
      }, onStatusChange: ({ status: e4 }) => {
        var o3;
        C2(e4), null == (o3 = (null == n ? void 0 : n.onStatusChange) || (null == m3 ? void 0 : m3.onStatusChange)) || o3({ status: e4 });
      }, onCanSendFeedbackChange: ({ canSendFeedback: e4 }) => {
        var o3;
        M2(e4), null == (o3 = (null == n ? void 0 : n.onCanSendFeedbackChange) || (null == m3 ? void 0 : m3.onCanSendFeedbackChange)) || o3({ canSendFeedback: e4 });
      } })), g2.current = await h2.current, void 0 !== w2.current && g2.current.setMicMuted(w2.current), void 0 !== y2.current && g2.current.setVolume({ volume: y2.current }), g2.current.getId();
    } finally {
      h2.current = null;
    }
  }, endSession: async () => {
    const n = g2.current;
    g2.current = null, await (null == n ? void 0 : n.endSession());
  }, setVolume: ({ volume: n }) => {
    var e2;
    null == (e2 = g2.current) || e2.setVolume({ volume: n });
  }, getInputByteFrequencyData: () => {
    var n;
    return null == (n = g2.current) ? void 0 : n.getInputByteFrequencyData();
  }, getOutputByteFrequencyData: () => {
    var n;
    return null == (n = g2.current) ? void 0 : n.getOutputByteFrequencyData();
  }, getInputVolume: () => {
    var n, e2;
    return null != (n = null == (e2 = g2.current) ? void 0 : e2.getInputVolume()) ? n : 0;
  }, getOutputVolume: () => {
    var n, e2;
    return null != (n = null == (e2 = g2.current) ? void 0 : e2.getOutputVolume()) ? n : 0;
  }, sendFeedback: (n) => {
    var e2;
    null == (e2 = g2.current) || e2.sendFeedback(n);
  }, getId: () => {
    var n;
    return null == (n = g2.current) ? void 0 : n.getId();
  }, sendContextualUpdate: (n) => {
    var e2;
    null == (e2 = g2.current) || e2.sendContextualUpdate(n);
  }, sendUserMessage: (n) => {
    var e2;
    null == (e2 = g2.current) || e2.sendUserMessage(n);
  }, sendUserActivity: () => {
    var n;
    null == (n = g2.current) || n.sendUserActivity();
  }, sendMCPToolApprovalResult: (n, e2) => {
    var o2;
    null == (o2 = g2.current) || o2.sendMCPToolApprovalResult(n, e2);
  }, changeInputDevice: async (n) => {
    if (g2.current && "changeInputDevice" in g2.current) return await g2.current.changeInputDevice(n);
    throw new Error("Device switching is only available for voice conversations");
  }, changeOutputDevice: async (n) => {
    if (g2.current && "changeOutputDevice" in g2.current) return await g2.current.changeOutputDevice(n);
    throw new Error("Device switching is only available for voice conversations");
  }, status: p2, canSendFeedback: S2, micMuted: t, isSpeaking: "speaking" === T };
}
const ElevenLabsWidget = ({ sessionData, onSessionUpdate }) => {
  const [isMicPermissionGranted, setIsMicPermissionGranted] = reactExports.useState(false);
  ...
  const [currentCallId, setCurrentCallId] = reactExports.useState(null);
  const wasTimeoutRef = reactExports.useRef(false);
  const [elapsedTime, setElapsedTime] = reactExports.useState(0);
  const elapsedTimerRef = reactExports.useRef(null);
  ...
  if (!sessionData) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "elevenlabs-widget p-4 border rounded-lg bg-gray-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-gray-600", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No active session available. Please purchase a mentor plan to start using AI support." }) }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "elevenlabs-widget p-4 border rounded-lg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg text-black font-semibold mb-2", children: "Voice Conversation" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 mb-4", children: "Connect with our AI mentor through voice. Make sure your microphone is enabled." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm text-black", children: [
          "Status: ",
          conversation.status || "disconnected"
        ] }),
        conversation.isSpeaking && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-blue-600 ml-2", children: "Agent is speaking..." })
      ] }),
      conversation.status === "connected" && sessionData && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-blue-50 border border-blue-200 rounded-lg p-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-blue-900", children: "Call Duration: " }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-blue-900", children: "Max Time: " }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm text-blue-700", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full bg-blue-200 rounded-full h-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        conversation.status !== "connected" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
        ...
        !isMicPermissionGranted && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
      ...
      conversation.status === "connected" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm", children: "Volume:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "range",
            ...
            step: "0.1",
            defaultValue: "0.8",
            onChange: (e2) => conversation.setVolume({ volume: parseFloat(e2.target.value) }),
            className: "w-24"
          }
        )
      ] }),
      (startTime || endTime) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm text-gray-600", children: [
        startTime && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          "Started: ",
          startTime.toLocaleTimeString()
        ] }),
        endTime && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          "Ended: ",
...
function MentorPage() {
  ...
  const checkActiveSession = reactExports.useCallback(async () => {
    try {
      setIsLoading(true);
  ...
  if (!isAuthenticated) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen pt-20 md:pt-40 bg-gradient-to-br from-blue-50 to-indigo-100 py-8 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold text-gray-900 mb-4", children: "AI Mentor Support" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-gray-600 mb-8", children: "Please log in to access AI mentor support." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          href: "/sign-in",
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen pt-20 md:pt-40 bg-gradient-to-br from-blue-50 to-indigo-100 py-8 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "Checking session status..." })
    ] }) });
  }
  if (error) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen pt-20 md:pt-40 bg-gradient-to-br from-blue-50 to-indigo-100 py-8 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold text-gray-900 mb-4", children: "AI Mentor Support" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-red-50 border border-red-200 rounded-lg p-4 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-800", children: error }) })
    ] }) });
  }
  if (!activeSession) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen pt-20 md:pt-40 bg-gradient-to-br from-blue-50 to-indigo-100 py-8 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold text-gray-900 mb-4", children: "AI Mentor Support" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-yellow-800 mb-2", children: "No Active Session" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-yellow-700 mb-4", children: "You don't have an active talk session. Purchase a mentor plan to start using AI mentor support." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: "/courses",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen pt-20 md:pt-40 bg-gradient-to-br from-blue-50 to-indigo-100 py-8 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold text-gray-900 mb-4", children: "AI Mentor Support" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-gray-600 max-w-2xl mx-auto mb-4", children: "Connect with our intelligent AI mentor for personalized guidance and support. Engage in natural voice conversations to get help with your learning journey." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-lg shadow-md p-4 mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-gray-900 mb-2", children: activeSession.Title }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-gray-700", children: "Remaining Time:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2 text-blue-600", children: [
              activeSession.RemainingDurationMinutes,
              " minutes"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-gray-700", children: "Used Time:" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-gray-700", children: "Total Time:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2 text-gray-600", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl shadow-lg p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ElevenLabsWidget,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: " rounded-lg p-4 max-w-2xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-blue-900 mb-2", children: "Tips for Best Experience" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "text-sm text-blue-800 space-y-1 text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "• Ensure you're in a quiet environment for clear communication" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "• Speak clearly and at a normal pace" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "• The AI mentor can help with course questions, career advice, and technical guidance" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "• Use the feedback buttons to help improve the conversation quality" })
      ] })
    ] }) })
  ] }) });
}
