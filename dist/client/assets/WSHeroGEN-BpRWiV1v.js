import { u as useNavigate, r as reactExports, j as jsxRuntimeExports, z as zt, P as generateFormEventId } from "./main-BOeEXsPM.js";
import { u as useWorkshop, r as registerForZoomMeeting, W as WorkshopProvider } from "./registration-Ypnblwt0.js";
import { W as WORKSHOP_PRICE } from "./constants_price-pJIfbaHl.js";
import { g as getUTMDataForDB, t as trackFormSubmission } from "./metaPixel-Bmpr2vms.js";
import { d as FaClock, e as FaCalendarAlt, f as FaUserGraduate, v as FaLevelUpAlt } from "./index-Bn19UuRu.js";
import { m as motion } from "./proxy-BkLUGwlU.js";
...
const WSForm = () => {
  ...
  const [paymentVerified, setPaymentVerified] = reactExports.useState(false);
  const [paymentCancelled, setPaymentCancelled] = reactExports.useState(false);
  const [showCancellationModal, setShowCancellationModal] = reactExports.useState(false);
      ...
      return new Promise((resolve, reject) => {
            ...
            try {
              ...
              if (verificationData.success) {
                ...
                await registerForZoomMeeting(
                  ...
                  zt.error(error.message || "Zoom registration failed. Please try again.");
                });
                zt.success("Registration successful!");
              ...
              zt.error(error.message || "Payment verification failed");
              reject(error);
            }
          },
          modal: {
        ...
        try {
          ...
          paymentObject.on("payment.failed", function(response2) {
            ...
            zt.error(`Payment failed: ${response2.error.description}`);
            reject(new Error(response2.error.description));
          });
          paymentObject.open();
        } catch (error) {
          console.error("Error creating Razorpay instance:", error);
          zt.error("Failed to initialize payment. Please try again.");
          reject(error);
        }
      });
    } catch (error) {
      console.error("Submission error:", error);
      zt.error(error.message || "Registration failed. Please try again.");
    } finally {
      setIsSubmitting(false);
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "  w-full border border-gray-800/30 ", id: "workshop-form", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", disabled: true, className: "text-gray-500", children: "Years of Experience" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-3 top-1/2 transform -translate-y-1/2 pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-4 h-4 text-gray-500", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M19 9l-7 7-7-7" }) }) })
        ] })
      ] }),
      ...
      paymentCancelled && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-yellow-800 text-sm", children: "Your previous payment attempt was cancelled. You can try again by clicking the register button below." }) }),
    ...
    showCancellationModal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-[100] flex items-center justify-center bg-black bg-opacity-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-lg p-8 max-w-md w-full mx-4 relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 bg-yellow-100 rounded-full flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-8 h-8 text-yellow-500", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "path",
          {
            strokeLinecap: "round",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold text-gray-900 mb-4", children: "Payment Cancelled" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 mb-6", children: "Your payment was cancelled. Would you like to try again?" }),
    ...
    showModal && paymentVerified && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-[100] flex items-center justify-center bg-black bg-opacity-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-lg p-8 max-w-md w-full mx-4 relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-8 h-8 text-green-500", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M5 13l4 4L19 7" }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold text-gray-900 mb-4", children: "Thank You for Registering!" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-50 p-4 rounded-lg mb-6 text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-gray-800 mb-2", children: "Zoom Meeting Details:" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", children: "See you in the workshop!" })
      ] })
    ] }) })
  ] });
};
const WSHeroGENC = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen overflow-hidden bg-gradient-to-b from-black via-[#0A0F1F] to-black ", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full h-screen overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "video",
        {
          ref: videoRef,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/70 z-10" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-20 flex items-start pb-20  pt-52 lg:pb-0 lg:items-center justify-start h-full px-10 md:px-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl text-white space-y-6 flex flex-col items-center lg:items-start justify-between  h-[400px] pb-24", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl md:text-6xl font-bold leading-tight text-center lg:text-start", children: "Social Media Lead Gen Magnet" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-xl md:text-4xl font-bold leading-tight text-center lg:text-start md:flex items-center gap-2 md:gap-0", children: [
          "Make your mark with",
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "pl-8 md:pl-2 flex items-center mx-auto text-start gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#daaaff] underline flex gap-2 items-center", children: "make.com " }),
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto   py-4 flex justify-between items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-44 md:w-52 hover:scale-105 transition-transform duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/companylogo-new.webp", alt: "AcceleratorX Logo", className: "w-full h-auto" }) }) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4  ", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative space-y-8 grid grid-cols-1 md:grid-cols-5  items-center justify-center md:gap-12 pt-32 lg:pt-36", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    motion.div,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-blue-400", children: "⚡" })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-blue-400 font-medium", children: "Hands-on AI Workshop" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 flex items-start justify-center flex-col ", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.h1,
                {
                  initial: { y: 20, opacity: 0 },
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: "Turn Your Social Media Into a Lead Machine" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: " text-gray-400", children: "Join our hands-on webinar where we’ll walk you through how to use Make.com to build lead-generation workflows that work while you sleep." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center gap-4 px-6 py-3 bg-gradient-to-r from-blue-500/10 to-green-500/10 rounded-xl backdrop-blur-sm border w-full border-blue-500/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between  items-center w-full  ", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-white mb-1", children: "Price" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-400", children: "Avail now to get the offer" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-3xl font-bold text-white", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: " text-gray-400 font-light line-through mx-4", children: "₹199" }),
                  "₹99"
                ] }) })
              ] }) })
            ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 mt-6", children: [
              ...
              { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FaLevelUpAlt, { className: "text-cyan-400 mb-1" }), label: "Level", value: "All Levels" }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-full mx-auto ", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative bg-gradient-to-b my-2 from-[#1A1F2B] to-[#141820] p-6 rounded-2xl shadow-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-white mb-2", children: "Reserve Your Spot Now!" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-400", children: "Limited seats available for the next session" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "workshop-registration-form", children: /* @__PURE__ */ jsxRuntimeExports.jsx(WorkshopProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(WSForm, {}) }) })
          ] }) }) })
        }
      )
    ] }) })
