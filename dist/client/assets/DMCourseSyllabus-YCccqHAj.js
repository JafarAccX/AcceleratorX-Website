...
import { u as useInView } from "./index-CSYCoh7b.js";
import { C as FaLightbulb, D as FaRocket, E as FaCrown } from "./index-zZD6c3dA.js";
import { m as motion } from "./proxy-CXL56B2m.js";
import { A as AnimatePresence } from "./index-BAcEffVT.js";
const DMCourseSyllabus = () => {
  const [ref, inView] = useInView({
    threshold: 0.1,
    triggerOnce: true
  });
  const [activeTooltip, setActiveTooltip] = reactExports.useState(null);
  const phases = [
    {
      title: "Phase 1: Foundation",
      duration: "4 weeks",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FaLightbulb, { className: "w-6 h-6" }),
    ...
    },
    {
      ...
      duration: "4 weeks",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FaRocket, { className: "w-6 h-6" }),
    ...
    },
    {
      ...
      duration: "4 weeks",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FaCrown, { className: "w-6 h-6" }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 bg-neutral-800 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ref,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl pb-2 md:text-5xl font-bold text-center mb-16 highlight-text", children: "Course Syllabus" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-neon-yellow via-neon-blue to-neon-yellow hidden md:block" }),
          phases.map((phase, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-neon-yellow", children: phase.icon })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                      ...
                      motion.div,
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-4", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden text-neon-yellow", children: phase.icon }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "span",
                              {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-neutral-100 mb-2", children: phase.title }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-neutral-100/70 font-mono mb-6", children: phase.description }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-4", children: phase.topics.map((topic, topicIndex) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "li",
                            {
                              className: "relative",
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center text-neutral-100/70 font-mono group/item", children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    motion.span,
                                    {
                                  ...
                                  topic.name,
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-2 opacity-0 group-hover/item:opacity-100 transition-opacity", children: "ℹ️" })
                                ] }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: activeTooltip === `${index}-${topicIndex}` && /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  motion.div,
                                  {
