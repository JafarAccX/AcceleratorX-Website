import { r as reactExports, l as useCourseContext, j as jsxRuntimeExports, k as motion } from "./main-Bmt1QOda.js";
import EnrollmentModal from "./EnrollmentModal-CqEnZ3W7.js";
import { S as Star } from "./star-Ev7gvjua.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-24 bg-[#0a0a0a]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-4xl md:text-5xl font-bold text-white mb-4", children: "Start You AI Marketing Journey Today" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-gray-400 max-w-2xl mx-auto", children: "We have designed a flexible enrolment plans so you can start learning without financial commitment." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8 mb-12", children: pricingOptions.map((option, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline justify-center gap-2 mb-2", children: [
