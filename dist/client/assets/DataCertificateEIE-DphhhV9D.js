import { m, j as jsxRuntimeExports, k as motion } from "./main-DqI0tNcP.js";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative inline-block", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative text-[#1A5D1A] text-lg font-semibold px-6 py-2 rounded-full border border-[#1A5D1A]/20", children: "Showcase your Mastery" })
            ] })
          }
        ),
          ...
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "relative text-4xl md:text-5xl font-bold text-[#1A5D1A]", children: "Become A Certified AI Data Analyst certifications" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-xl text-[#1F441E] max-w-2xl mx-auto", children: "Step up your career with AI-powered, industry-recognised Data Analytics certification." })
            ]
          }
        )
      ] }),
