import { f as createLucideIcon, j as jsxRuntimeExports, k as motion, r as reactExports } from "./main-YlaQtpvX.js";
...
import { A as AlertTriangle } from "./alert-triangle-CgkcXqfU.js";
import { H as HelpCircle } from "./help-circle-B26Zy8Sy.js";
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row gap-8 items-start", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.div,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-32 h-32 md:w-40 md:h-40 rounded-2xl bg-gradient-to-r from-blue-500 to-violet-500 p-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full bg-gray-900 rounded-xl p-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "img",
                      {
                    ...
                    motion.div,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mb-4", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold text-white", children: instructors[0].name }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:block text-gray-500", children: "|" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm sm:text-lg text-blue-400 font-medium", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: instructors[0].role }),
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "a",
                          {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "underline", children: "View on LinkedIn" })
                            ]
                          }
                        ) })
                      ]
        ...
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-r from-blue-900/30 to-violet-900/30 backdrop-blur-xl border border-blue-500/30 rounded-2xl p-6 hover:border-blue-400/50 transition-all duration-300", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-100 mb-4 text-lg", children: "Complete the bootcamp → get your certificate by AcceleratorX." }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-lg md:text-xl max-w-2xl mx-auto", children: "Anyone who wants to build functional AI products, not just talk about them." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function WSTools() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative z-10 py-20 bg-gradient-to-b from-[#0a0f1c] to-[#0b0a12] text-white overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-8 px-4 max-w-6xl mx-auto", children: aiTools.map((tool) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl p-2 backdrop-blur-md shadow-lg transition-all hover:border-white/20 w-full max-w-[60px] h-[60px] flex flex-col items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: tool.logo, alt: `${tool.name} - ${tool.description}`, className: " object-fill mb-2" }) }),
