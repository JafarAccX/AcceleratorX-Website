import { r as reactExports, i as useCourseContext, j as jsxRuntimeExports } from "./main-C28QhmdX.js";
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "relative text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative bg-gradient-to-r from-[#96E072] to-[#96E072]/90 bg-clip-text text-transparent ml-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-black/80 backdrop-blur-sm rounded-lg px-4 py-2 flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-amber-400", children: "Designed with artificial intelligence at the centre, work quicker, lead better, and learn smarter." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-amber-400" })
            ] }),
