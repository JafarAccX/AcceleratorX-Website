...
import { b as FiDollarSign, c as FiKey, d as FiCpu } from "./index-CEt3rW30.js";
  ...
  const features = [
    {
      ...
      description: "We keep it focused and practical — you'll work on real examples and get direct interaction with the instructor.",
      highlight: true
    },
    {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FiKey, { className: "text-white text-xl" }),
      title: "Real Projects. Real Skills.",
      description: "Apply what you learn during the session. Build a mini AI-powered analysis workflow — not just watch someone else do it.",
      highlight: true
    },
    {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FiCpu, { className: "text-white text-xl" }),
      title: "Build Confidence for a Data Career.",
      description: "Perfect for anyone planning to enter data analytics, upskill for better roles, or understand AI's real use in business analytics.",
      highlight: true
    }
  ];
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 container mx-auto px-6 ", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center justify-center mb-16 max-w-5xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-end ", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-300 text-lg leading-relaxed max-w-lg", children: '"Data is the new oil. AI is the refinery."' }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-300 text-lg leading-relaxed max-w-lg", children: "Whether you’re an aspiring data analyst, a career switcher, or a working professional — this crash course is designed to help you:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "text-slate-300 text-lg leading-relaxed max-w-lg list-disc pl-6 space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Understand how AI transforms traditional data analysis." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Learn to automate repetitive analysis tasks." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Make sense of data faster and communicate insights effectively." })
          ] })
        ] }) }),
