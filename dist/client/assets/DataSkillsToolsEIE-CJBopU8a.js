      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-gray-400 max-w-2xl mx-auto", children: "Master the essential skills and tools used by top Data Analysts" })
          ]
        }
      ),
          ...
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative inline-flex items-center", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "relative text-2xl font-bold text-white", children: "Tools You'll Master" })
              ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative inline-flex items-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-[#96E072]/20 to-transparent blur-lg" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "relative text-2xl font-bold text-white", children: "Skills You'll Develop" })
              ] }),
