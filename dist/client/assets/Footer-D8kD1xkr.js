import { f as createLucideIcon, j as jsxRuntimeExports, L as Link, i as companyLogo } from "./main-DSLYtVC7.js";
import { M as Mail } from "./mail-0bHapBIB.js";
import { P as Phone } from "./phone-DeKpKgU6.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 relative z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-4 space-y-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 max-w-md", children: "Advance your career with industry-driven programs in Data Analytics, Product                             Management, and Generative AI, designed by experts for real-world success." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-white mb-4 text-lg", children: "Connect With Us" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-4", children: footerLinks.social.links.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: link.url,
                target: "_blank",
                ...
                title: link.label,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400 group-hover:text-white transition-colors duration-300", "aria-hidden": "true", children: link.icon }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sr-only", role: "text", children: link.label })
                ]
              },
              link.label
            )) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-4 grid grid-cols-2 gap-8", children: ["services", "company"].map((key) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-white mb-4 text-lg", children: footerLinks[key].title }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-white mb-4 text-lg", children: footerLinks.contact.title }),
