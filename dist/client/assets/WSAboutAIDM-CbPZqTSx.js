...
import { c as FaCertificate } from "./index-B2pwuist.js";
import { B as Brain } from "./brain-4iRINFpu.js";
import { T as Target } from "./target-C2_-Bdj5.js";
import { T as TrendingUp } from "./trending-up-_w8a9LBp.js";
const WSAboutAIDM = () => {
  const scrollToForm = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#050A14] py-12 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row gap-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full lg:w-3/5 space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#0A1020] rounded-lg shadow-md border border-green-900/20 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center gap-2 bg-green-500/10 rounded-md px-3 py-1 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-400 text-sm font-medium", children: "AI-Powered CRO Workshop" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: toolsRef, className: "bg-[#0A1020] rounded-lg shadow-md p-5 border border-blue-900/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-bold text-white mb-4", children: "CRO Tools You'll Master" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full lg:w-2/5 space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-to-r from-blue-900/60 to-green-900/60 rounded-lg overflow-hidden shadow-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 text-white", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-200 mb-3 text-sm", children: "Upon completion of the workshop, you'll receive a professional certificate confirming your expertise in AI-powered conversion rate optimization techniques and tools." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-200 mb-3 text-sm", children: "Earn an industry-recognized certificate showcasing your CRO and AI marketing skills!" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-black/20 p-3 rounded-md text-xs text-gray-300 border border-white/10", children: "⚠️ Only those who attend the complete CRO workshop will receive the official certification." })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0A1020] rounded-lg shadow-md p-5 border border-green-900/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-5 h-5 text-green-400" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-white", children: "Workshop Benefits" })
        ] }),
