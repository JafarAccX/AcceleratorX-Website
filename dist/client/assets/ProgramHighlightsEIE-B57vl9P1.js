import { r as reactExports, j as jsxRuntimeExports, k as motion } from "./main-DSLYtVC7.js";
import { L as Lightbulb } from "./lightbulb-BFxHDXdC.js";
import { W as Workflow } from "./workflow-C8wehuxr.js";
import { R as Rocket } from "./rocket-5rZ1IuBK.js";
const features = [
  {
    ...
    image: /* @__PURE__ */ jsxRuntimeExports.jsx(Lightbulb, { className: "w-8 h-8 text-[#5CB338]" }),
  ...
  },
  {
    ...
    image: /* @__PURE__ */ jsxRuntimeExports.jsx(Workflow, { className: "w-8 h-8 text-[#5CB338]" }),
    className: "hover:shadow-[#5CB338]/20"
  },
  {
    ...
    image: /* @__PURE__ */ jsxRuntimeExports.jsx(Rocket, { className: "w-8 h-8 text-[#5CB338]" }),
    className: "hover:shadow-[#5CB338]/20"
  },
  {
...
function ProgramHighlightsEIE() {
  const [activeSection, setActiveSection] = reactExports.useState("primaryFocus");
  const renderDesignLaunchSection = () => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      initial: { opacity: 0 },
      animate: { opacity: 1 },
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 overflow-hidden rounded-3xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-transparent via-[#5CB338]/10 to-transparent shimmer" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3", children: features.map((feature, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3", children: feature.image }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-semibold text-white group-hover:text-[#5CB338] transition-colors", children: feature.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-gray-400 group-hover:text-gray-300 transition-colors", children: feature.description })
            ]
          },
          index
        )) })
  ...
  const renderPrimaryFocus = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0F0F0F] rounded-xl p-8 border border-white/10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold mb-8", children: sections.primaryFocus.title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4", children: sections.primaryFocus.content.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-[#5CB338]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-medium hover:text-[#5CB338] transition-colors", children: item.title })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-400 ml-5", children: item.description })
    ] }, index)) })
  ] });
  const renderSkillsDeveloped = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0F0F0F] rounded-xl p-8 border border-white/10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold mb-8", children: sections.skillsDeveloped.title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4", children: sections.skillsDeveloped.content.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-[#5CB338]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-medium hover:text-[#5CB338] transition-colors", children: item.title })
      ] }),
  ...
  const renderWhoCanTake = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0F0F0F] rounded-xl p-8 border border-white/10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold mb-8", children: sections.whoCanTake.title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4", children: sections.whoCanTake.content.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-[#5CB338]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-300 hover:text-white transition-colors", children: item })
    ] }, index)) })
  ] });
  const renderEligibility = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0F0F0F] rounded-xl p-8 border border-white/10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold mb-8", children: sections.eligibility.title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4", children: sections.eligibility.content.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-[#5CB338]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-300 hover:text-white transition-colors", children: item })
    ] }, index)) })
  ] });
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: activeSection, className: "py-24 bg-gray-700/10 text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-4xl md:text-5xl font-bold ", children: [
      "Why choose the AcceleratorX ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#5CB338]", children: "AI Product Management program" }),
      "?"
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-4 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky top-8 space-y-3", children: Object.entries(sections).map(([key, section]) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
