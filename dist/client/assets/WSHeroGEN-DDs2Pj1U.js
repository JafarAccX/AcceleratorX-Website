import { u as useNavigate, r as reactExports, j as jsxRuntimeExports, c as _t, U as generateFormEventId, k as motion } from "./main-pPMPSF4E.js";
import { u as useWorkshop, r as registerForZoomMeeting, W as WorkshopProvider } from "./registration-CYM-WIHG.js";
import { W as WORKSHOP_PRICE } from "./constants_price-pJIfbaHl.js";
import { g as getUTMDataForDB, t as trackFormSubmission } from "./metaPixel-DzY0zvt3.js";
import { d as FaClock, e as FaCalendarAlt, f as FaUserGraduate, l as FaLevelUpAlt } from "./index-Crl4IWfV.js";
      ...
      return new Promise((resolve, reject) => {
            ...
            try {
              ...
              if (verificationData.success) {
                ...
                await registerForZoomMeeting(
                  ...
                  _t.error(error.message || "Zoom registration failed. Please try again.");
                });
              ...
              _t.error(error.message || "Payment verification failed");
              reject(error);
            }
          },
          modal: {
        ...
        try {
          ...
          paymentObject.on("payment.failed", function(response2) {
            ...
            _t.error(`Payment failed: ${response2.error.description}`);
            reject(new Error(response2.error.description));
          });
          paymentObject.open();
        } catch (error) {
          console.error("Error creating Razorpay instance:", error);
          _t.error("Failed to initialize payment. Please try again.");
          reject(error);
        }
      });
    } catch (error) {
      console.error("Submission error:", error);
      _t.error(error.message || "Registration failed. Please try again.");
    } finally {
      setIsSubmitting(false);
    }
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen overflow-hidden bg-gradient-to-b from-black via-[#0A0F1F] to-black ", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto   py-4 flex justify-between items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-44 md:w-52 hover:scale-105 transition-transform duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/companylogo-new.webp", alt: "company logo - professional certificate in product management online", className: "w-full h-auto" }) }) })
      }
    ),
