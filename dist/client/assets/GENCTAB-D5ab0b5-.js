    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0A1020] rounded-lg p-8 border border-blue-900/20 shadow-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.h2,
          {
            ...
            children: "Smarter Marketing — Fully Automated"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center gap-2 bg-blue-500/10 rounded-md px-4 py-2 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base text-blue-400 font-medium", children: "Register now for hands-on learning in Marketing Automation" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#111827] p-4 rounded-md border border-blue-500/10 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-bold text-blue-400 mb-1", children: "AI-Powered" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-400", children: "Tools that think for you." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#111827] p-4 rounded-md border border-green-500/10 text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-400", children: "Execute campaigns automatically." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#111827] p-4 rounded-md border border-green-500/10 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-bold text-green-400 mb-1", children: "Smart" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-400", children: "Workflows built for marketers." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#111827] p-4 rounded-md border border-green-500/10 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-bold text-blue-400 mb-1", children: "Build & Launch" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-400", children: "Automation that drives measurable results." })
        ] })
      ] }),
