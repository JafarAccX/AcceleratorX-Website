...
const AIDMSolution = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 bg-[#0a0a0a]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-4xl md:text-5xl font-bold text-white mb-6", children: "Learn AI Marketing the Right Way" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl text-gray-400 max-w-3xl mx-auto", children: "This is not another AI course; it's a complete AI Marketing learning experience." })
    ] }),
