import { f as createLucideIcon, j as jsxRuntimeExports, u as useNavigate, r as reactExports, m as m$1, L as Link, l as useCourseContext, S as SEO } from "./main-DSLYtVC7.js";
...
import { L as Loader } from "./loader-DyyL9-iU.js";
...
const features = [
  {
    ...
    description: "Drive with data, develop with clarity, and innovate with impact. This program combines AI product frameworks, analytics, and growth strategy to help you design scalable products from scratch that users love.",
  ...
  },
  {
    ...
    description: "Modify data into insights. Develop thoughtful expertise in AI analytics and storytelling, encouraging you to make AI Analytical decisions that drive growth.",
    image: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "w-full h-full", viewBox: "0 0 200 200", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "pattern",
        {
  ...
  // },
  {
    ...
    title: "Generative AI",
    description: "Scale in your future with Generative AI. Learn how to use language models, prompt engineering, and AI automation to create solutions without writing a single line of code.",
    image: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "w-full h-full", viewBox: "0 0 200 200", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "pattern",
        {
  ...
  },
  {
    ...
    description: "Reshape your Creativity with AI Digital Marketing Learn the art of AI-powered automation, personalisation, and performance optimisation to craft that truly converts.",
    image: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "w-full h-full", viewBox: "0 0 200 200", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "pattern",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "g",
        {
          children: [
            ...
            ].map(({ x }, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "rect",
              {
                x,
                width: "10",
  ...
  },
  {
    ...
    description: "Understand how to use GenAI for Product Managers and become an AI-Powered Product Manager that builds and ships AI products end-to-end. Build your own real project, Automate workflows, and make smarter product decisions, no coding required.",
    image: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "w-full h-full", viewBox: "0 0 200 200", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "pattern",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "200", height: "200", fill: "url(#grid5)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "g",
        {
          stroke: "currentColor",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-7xl mx-auto py-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-3xl md:text-4xl font-bold text-white pb-2", children: [
                  "Browse Our ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-gradient-to-r from-blue-400 to-blue-600 text-transparent bg-clip-text", children: "AI Career Programs" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-lg", children: "Learn the Skills that will shape your career" })
              ]
            }
          ),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold text-white mb-4", children: "Trusted by 1700+ Organisations For Your AI Career" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-blue-200/80 max-w-2xl mx-auto", children: "Our Partners & Hiring Network:" })
          ]
        }
      ),
...
function Hero() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen w-full overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 mx-auto max-w-7xl px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex  min-h-screen h-full flex-col-reverse items-center justify-center gap-12 py-12 lg:flex-row lg:justify-between lg:py-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-xl text-lg text-gray-100 leading-relaxed", children: "Accelerate your career with a job-ready AI program. Learn how Data Analytics, Generative AI, and Digital Marketing Automation work through hands-on experience. Gain practical skills, get job-ready for high demand in AI Job roles." }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/courses/ai-digital-marketing", className: "absolute bottom-2  left-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "mt-4 px-8 py-3 text-lg font-semibold text-white bg-gradient-to-r from-green-400/40 to-emerald-500/40 hover:from-green-500 hover:to-emerald-600 rounded-lg shadow-md transition duration-200 focus:outline-none focus:ring-2 focus:ring-emerald-300 focus:ring-offset-2 ", children: "Get Started" }) })
          ]
        }
      )
    ] }) })
