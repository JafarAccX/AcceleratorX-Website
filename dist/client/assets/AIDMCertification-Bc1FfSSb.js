...
import { S as Shield } from "./shield-CH-CJnA2.js";
import { T as Trophy } from "./trophy-CsiJJshy.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        className: "relative",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative border-4 border-[#5CB338] aspect-[4/3] rounded-2xl overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 bg-[#0F0F0F] flex items-center justify-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center p-8", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 bg-[#5CB338]/10 rounded-full flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { className: "w-10 h-10 text-[#5CB338]" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-2xl font-bold text-white mb-2", children: "AI Digital Marketing" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#5CB338] font-semibold", children: "Nano-Degree Certificate" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm mt-4", children: "AcceleratorX" })
            ] }),
