import { u as useNavigate, T as useLocation, r as reactExports, j as jsxRuntimeExports, c as _t, U as generateFormEventId, h as axios } from "./main-CVqzsEIE.js";
...
import { c as createWorkshopRegistration } from "./workshopApi-CUTMYhJa.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden bg-gradient-to-b from-[#050A14] via-[#0A0F1F] to-[#050A14]", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-12 md:py-16 lg:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full lg:w-1/2 space-y-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl sm:text-4xl md:text-5xl font-bold leading-tight", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-transparent bg-clip-text bg-gradient-to-r from-white via-green-100 to-blue-100", children: "Build Your First RAG Agent in Just 90 Minutes" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-gray-300 max-w-xl", children: "Learn how to build Retrieval-Augmented Generation (RAG) agents from scratch. Discover the power of combining vector databases with large language models to create intelligent, context-aware AI applications that can answer questions and generate responses based on your custom data." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex flex-wrap items-center gap-3 px-4 py-2 bg-gradient-to-r from-green-500/10 to-blue-500/10 rounded-lg border border-green-500/20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-yellow-400 text-sm font-medium", children: "Learn RAG Agent Development for Free – No Experience Needed" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-4 mt-6", children: [
          ...
          { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FaCalendarAlt, { className: "text-indigo-400 mb-1" }), label: "Date", value: "Nov 14th" },
          {
