    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-8", children: mentors.map((mentor, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-[#0F0F0F] rounded-2xl border border-white/10 group-hover:border-[#5CB338]/50 transition-all duration-500 overflow-hidden group-hover:shadow-lg group-hover:shadow-[#5CB338]/10 group-hover:-translate-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative h-52 overflow-hidden bg-gradient-to-br from-[#5CB338]/20 to-[#5CB338]/5 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-24 bg-gradient-to-r from-[#5CB338]/20 to-[#5CB338]/40 rounded-full flex items-center justify-center border border-[#5CB338]/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#5CB338] text-2xl font-bold", children: mentor.name.split(" ").map((n) => n[0]).join("") }) }) }),
