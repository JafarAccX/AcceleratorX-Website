import { f as createLucideIcon, g as getDefaultExportFromCjs, j as jsxRuntimeExports, e as useParams, u as useNavigate, r as reactExports, b as useUser, X, B as Briefcase, c as _t } from "./main-CtSa0pDV.js";
import { u as useGetJobById } from "./jobs-BLGJ55YX.js";
import { u as useApplyForJob } from "./customer-C50QEXK7.js";
import { C as ChevronLeft } from "./chevron-left-De22uGEo.js";
import { B as Building2 } from "./building-2-WQBd2Y2f.js";
import { G as Globe } from "./globe-D5wuOc82.js";
import { M as MapPin } from "./map-pin-Ddfr2QFN.js";
import { C as Clock } from "./clock-C8COAzUG.js";
import "./useQuery-DveUR5r2.js";
/**
...
class SpliceBuffer {
  ...
  slice(start, end) {
    ...
    list2.push(...this.right.slice(this.right.length - stop + this.left.length).reverse());
    return list2;
  }
  /**
...
function JobDetails() {
    ...
    if (job?.EasyApply) {
      applyForJobMutation.mutate(
        ...
        },
        {
          ...
          onError: () => {
            _t.error("Already applied");
          }
        }
      );
    } else {
      if (!job?.JobApplyURL) {
        _t.error("Job application URL not available");
        return;
      }
      try {
        applyForJobMutation.mutate(
        ...
        _t.success("Redirecting to company application page...");
        window.open(job.JobApplyURL, "_blank");
        setShowApplying(false);
      } catch (error2) {
        console.error("Failed to process external application:", error2);
        _t.error("Failed to open application page. Please try again.");
      }
    }
  };
  ...
  if (isError || !job) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen pt-20 sm:pt-24 pb-6 sm:pb-12 bg-[#080B16] text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-4xl px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-[#0E1628] p-8 text-center border border-gray-700", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500", children: JSON.stringify(error) || "Job not found" }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen pt-20 sm:pt-24 pb-6 sm:pb-12 bg-[#080B16] text-white", children: [
    showApplying && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-50 flex items-center justify-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-[#1A1A1A] rounded-lg p-6 shadow-lg border border-gray-700 max-w-md w-full m-4 z-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: () => setShowApplying(false),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-white mb-4", children: job.EasyApply ? "Apply with Profile" : "External Application" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 mb-6 text-sm leading-relaxed", children: job.EasyApply ? "Your profile will be shared with employers. Ensure your details are up-to-date to improve your chances." : "This position requires applying directly on the company's website. You'll be redirected to their application page." }),
        !job.EasyApply && job.JobApplyURL && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 p-3 bg-blue-500/10 border border-blue-500/30 rounded-lg", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-blue-300 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { size: 16 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "External application required" })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-4 justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-screen-lg px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          onClick: () => navigate("/jobs"),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-gray-700 bg-[#0E1628] p-6 sm:p-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 flex-1", children: [
              job.CompanyLogoURL && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-xl bg-white/10 flex items-center justify-center overflow-hidden flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl sm:text-4xl font-bold text-white mb-2", children: job.JobName }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xl text-gray-300 mb-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { className: "h-5 w-5" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: job.CompanyName })
                ] }),
                job.CompanyURL && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "a",
                  {
                    href: job.CompanyURL,
                    target: "_blank",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-end gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-gray-800/30 rounded-lg", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-gray-300", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400", children: "Location" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: job.Location || `${job.City}, ${job.Country}` })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-gray-300", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { className: "h-4 w-4 text-gray-400" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400", children: "Job Type" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium capitalize", children: job.JobType.replace("fulltime", "Full-time") })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-gray-300", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-4 w-4 text-gray-400" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400", children: "Experience" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium capitalize", children: job.RequiredExperience || "Not specified" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-gray-300", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-4 w-4 text-gray-400" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400", children: "Posted" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: new Date(job.CreatedDate).toLocaleDateString() })
              ] })
            ] })
          ] }),
          job.Salary && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 p-4 bg-green-500/10 border border-green-500/30 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-green-400 text-xl font-semibold", children: [
            "₹",
            job.Salary
          ] }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold text-white mb-4", children: "Job Description" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Markdown, { children: cleanedDescription })
        ] }),
        skills.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold text-white mb-4", children: "Required Skills" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3", children: skills.map((skill, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
        ...
        job.Category && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold text-white mb-4", children: "Category" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-4 py-2 bg-purple-500/20 text-purple-300 rounded-lg text-sm font-medium border border-purple-500/30", children: job.Category })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-6 border-t border-gray-700", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
          ...
          !job.EasyApply && job.JobApplyURL && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-400 mt-2", children: [
