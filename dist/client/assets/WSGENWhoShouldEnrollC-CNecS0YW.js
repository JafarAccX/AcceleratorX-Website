import { e as createLucideIcon, j as jsxRuntimeExports, B as Briefcase } from "./main-D1W_Gn8a.js";
  ...
  const targetAudience = [
    {
      icon: Briefcase,
      title: "Professionals",
      description: "Looking to build intelligent bots, research tools, or smarter internal apps."
    },
    {
      icon: Laptop,
      title: "Students",
      description: " Eager to get hands-on with AI and build real-world tech for future careers."
    },
    {
      icon: Code,
      title: "Entrepreneurs",
      description: "Want to build their own AI product, MVP, or personal assistant app."
    },
    {
      icon: Brain,
      title: "Creatives",
      description: "Explore how to turn content, notes, and documents into searchable, intelligent tools."
    }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative py-12 bg-black px-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-3 relative z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-screen-md items-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl  l font-bold mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: "This is for you if you’ve ever thought: “AI is powerful, but I don’t know where to start.”" }) })
      ] }),
