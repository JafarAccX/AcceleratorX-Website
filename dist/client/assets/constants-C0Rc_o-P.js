...
const dataAnalyticsmodules = [
  {
    ...
    description: "Earn cutting-edge certifications powered by AI-driven learning—trusted by top employers and designed to showcase your real-world data skills.",
    image: "/assets/program/security.webp"
  },
  {
    title: "AI-Powered Tools & Tech Training",
    description: "Master the latest AI-driven tools and platforms used by leading companies to analyse data, build insights, and automate solutions.",
    image: "/assets/program/learning.webp"
  },
  {
    title: "Hands-On, AI-Integrated Learning from Day One",
    description: "Work on live projects from day one, using AI-enhanced methods to solve real-world data challenges in business and product roles.",
    image: "/assets/program/file-case.webp"
  },
  {
    title: "Comprehensive Interview Preparation",
    description: "Gain expert guidance from experienced product leaders to ace your interviews confidently.",
    image: "/assets/program/mentorship.webp"
  },
  {
    title: "Mock Interviews with Real-Time Feedback",
    description: "Refine your interview skills with tailored mock interviews and constructive feedback.",
    image: "/assets/program/meeting.webp"
  },
  {
    title: "Priority Access to Job Opportunities",
    description: "Discover exclusive job opportunities and connect with top employers to launch your career.",
    image: "/assets/program/job-portal.webp"
  },
  {
    title: "Thriving Professional Network",
    description: "Join a diverse community of ambitious product professionals eager to connect and collaborate.",
    image: "/assets/program/networking.webp"
  },
  {
    title: "Bi-weekly Career Review Calls",
    description: "Get personalized career advice and insights from seasoned leaders.",
    image: "/assets/program/state.webp"
  },
  {
    title: "Chance to win Industry Internship",
    description: "Enjoy lifetime access to all course materials, with updates to stay ahead in your career.",
