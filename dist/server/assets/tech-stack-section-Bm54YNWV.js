...
function TechStackSection() {
  ...
  return /* @__PURE__ */ jsx("section", { className: "py-20 px-4 sm:px-6 lg:px-8 bg-black", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-2 gap-16 items-center", children: [
    /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight", children: "Works Seamlessly With Your Favorite Tools" }),
      /* @__PURE__ */ jsx("p", { className: "text-xl text-gray-400 leading-relaxed max-w-lg", children: "Discover how to automate lead generation and enrichment using no-code tools. Build powerful workflows that save hours, boost accuracy, and scale effortlessly—without writing a single line of code." })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-4 gap-8 justify-items-center", children: toolsStack.map((tool, index) => /* @__PURE__ */ jsx(
      "div",
      {
