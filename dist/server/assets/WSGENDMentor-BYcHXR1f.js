            ...
            /* @__PURE__ */ jsxs("div", { className: "flex-1 text-center md:text-left", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-3 text-gray-300", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
                  ...
                  /* @__PURE__ */ jsx("p", { children: "Ph.D. in Computer Science with expertise in Large Language Models and Fine-tuning" })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
                  /* @__PURE__ */ jsx(Sparkles, { className: "w-5 h-5 text-blue-400 mt-1 flex-shrink-0" }),
                  /* @__PURE__ */ jsx("p", { children: "Fine-tuned multiple LLM models for enterprise applications and research projects" })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
                  /* @__PURE__ */ jsx(GraduationCap, { className: "w-5 h-5 text-green-400 mt-1 flex-shrink-0" }),
                  /* @__PURE__ */ jsx("p", { children: "Assistant Professor and AI Researcher at Parul University specializing in NLP" })
                ] })
              ] })
            ] })
          ] }) })
