...
const SVG = ({
  ...
  return /* @__PURE__ */ jsxs(
    motion.svg,
    {
      ...
      children: [
        paths.map((path, idx) => /* @__PURE__ */ jsx(
          motion.path,
          {
            d: path,
            stroke: colors[idx],
...
const AIDMHero = () => {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative min-h-screen bg-black overflow-hidden flex items-center", children: [
    ...
    /* @__PURE__ */ jsx(BackgroundLines, { className: "flex items-center justify-center w-full flex-col px-4", children: /* @__PURE__ */ jsx(
      motion.div,
      {
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto relative z-10", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8", children: months.map((month, index) => /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("p", { className: "font-bold text-lg text-blue-400 mb-2", children: month.title }),
