...
const AIDMCareerOutcomes = () => {
  ...
  return /* @__PURE__ */ jsx("section", { className: "py-24", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center mb-16", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-2xl font-medium text-gray-400 mb-4", children: "Career Outcome" }),
      /* @__PURE__ */ jsx("h3", { className: "text-4xl md:text-5xl font-bold text-[#5CB338]", children: "Where does this Nano Degree in AI Digital Marketing take you?" }),
      /* @__PURE__ */ jsx("p", { className: "text-xl text-gray-600 max-w-3xl mx-auto mt-6", children: "After completing this Nano Degree in AI Digital Marketing, you will be ready for AI Marketing jobs, freelancing projects, AI Marketing Consultant and many other fast-growing roles in marketing." })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12", children: benefits.map((benefit, index) => /* @__PURE__ */ jsxs(
      motion.div,
      {
