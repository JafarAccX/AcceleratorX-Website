...
import { g as getUTMDataForDB, t as trackFormSubmission } from "./metaPixel-Cw2h-5_I.js";
...
function KuppamEnrollmentModal({ isOpen, onClose, onSubmit }) {
  ...
  return /* @__PURE__ */ jsx(AnimatePresence, { children: isOpen && /* @__PURE__ */ jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsx("div", { className: "relative w-full max-w-md mx-auto mt-auto md:mt-0 bg-gray-800/95 rounded-xl shadow-xl overflow-y-auto md:my-6 ", children: /* @__PURE__ */ jsxs("div", { className: "h-[85vh] md:h-auto flex flex-col", children: [
        /* @__PURE__ */ jsxs("div", { className: "sticky top-0 bg-gray-800/95 px-4 py-3 border-b border-gray-700 z-10", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1 pr-8", children: [
            /* @__PURE__ */ jsx("h3", { className: "text-lg md:text-xl font-bold text-white", children: "Enroll for Kuppam AI Workshop" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs md:text-sm text-gray-300", children: "Choose your preferred course and language - 3-Hour AI Marathon" })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: " shadow-2xl p-6 w-full border border-gray-800/30", id: "kuppam-workshop-form", children: /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "p-4 space-y-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { htmlFor: "name", className: "block text-sm font-medium text-gray-300 mb-1", children: "Full Name" }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "text",
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex", children: [
                /* @__PURE__ */ jsx("span", { className: " bg-[#0A0A0A] text-white px-4 py-2.5 rounded-lg border border-gray-800/50 focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 outline-none transition-all placeholder:text-white text-sm", children: "+91" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "tel",
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { htmlFor: "designation", className: "block text-sm font-medium text-gray-300 mb-1", children: "Designation" }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "text",
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { htmlFor: "course", className: "block text-sm font-medium text-gray-300 mb-1", children: "Select Course" }),
              /* @__PURE__ */ jsxs(
                "select",
                {
                  id: "course",
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("option", { value: "Generative AI (En)", children: "Generative AI (English)" }),
                    /* @__PURE__ */ jsx("option", { value: "Generative AI (TL)", children: "Generative AI (Telugu)" }),
                    /* @__PURE__ */ jsx("option", { value: "Data Analytics (EN - TL)", children: "Data Analytics (English and Telugu)" })
                  ]
                }
              )
            ] })
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-4", children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-400 mb-3", children: "By submitting this form, you acknowledge that we collect non-personal campaign data for analytics purposes and agree to receive workshop updates via WhatsApp." }),
            /* @__PURE__ */ jsx(
              "button",
              {
                type: "submit",
...
const KuppamHeader = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative bg-[#0A0F1D] min-h-screen overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "relative min-h-screen flex items-center justify-center overflow-hidden bg-gray-900", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative z-10 max-w-4xl mx-auto px-6 text-center", children: [
        /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 px-4 py-2 rounded-full border border-gray-700/50 bg-gray-800/50 backdrop-blur-sm mb-8", children: [
          /* @__PURE__ */ jsx(Globe, { className: "w-4 h-4 text-gray-300" }),
          /* @__PURE__ */ jsx("span", { className: "text-gray-300 text-sm font-medium", children: "Live Workshop | 3-Hour AI Marathon" })
        ] }),
        /* @__PURE__ */ jsx("h1", { className: "text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight", children: "First Ever AI Program In" }),
        /* @__PURE__ */ jsx("h1", { className: "text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight", children: "English & Telugu" }),
      ...
      /* @__PURE__ */ jsx("div", { className: "absolute top-1/4 left-1/4 w-2 h-2 bg-blue-400/40 rounded-full blur-sm" }),
      /* @__PURE__ */ jsx("div", { className: "absolute top-3/4 right-1/3 w-1 h-1 bg-blue-300/30 rounded-full blur-sm" })
    ] }),
...
const KuppamSecond = () => {
  return /* @__PURE__ */ jsxs("div", { className: "relative bg-[#0A0F1D] min-h-screen overflow-x-hidden", children: [
    /* @__PURE__ */ jsxs("section", { className: "relative min-h-screen flex items-center justify-center overflow-hidden bg-gray-900", children: [
      /* @__PURE__ */ jsxs("div", { className: "absolute inset-0", children: [
        /* @__PURE__ */ jsx("img", { src: "/kuppam-tools.webp", alt: "Background", className: "w-full h-full object-cover" }),
        /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-black/80" }),
        /* @__PURE__ */ jsx("div", { className: "absolute inset-0 backdrop-blur-sm" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "relative z-10 max-w-4xl mx-auto px-6 text-center", children: [
        /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 px-4 py-2 rounded-full border border-gray-700/50 bg-gray-800/50 backdrop-blur-sm mb-8", children: [
          /* @__PURE__ */ jsx(Globe, { className: "w-4 h-4 text-gray-300" }),
          /* @__PURE__ */ jsx("span", { className: "text-gray-300 text-sm font-medium", children: "Exclusive AI Tools Workshop" })
        ] }),
        /* @__PURE__ */ jsx("h1", { className: "text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight", children: "Learn the skill that get you hired" }),
        /* @__PURE__ */ jsx("h1", { className: "text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight", children: "Gen AI and AI Agent Building program" })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "absolute top-1/4 left-1/4 w-2 h-2 bg-blue-400/40 rounded-full blur-sm" }),
      /* @__PURE__ */ jsx("div", { className: "absolute top-3/4 right-1/3 w-1 h-1 bg-blue-300/30 rounded-full blur-sm" })
    ] }),
...
const KuppamTopics = () => {
  return /* @__PURE__ */ jsx("div", { className: "py-16 bg-[#0A0F1D]/50 px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 items-start justify-center", children: [
    /* @__PURE__ */ jsxs("div", { className: "relative group   rounded-2xl   backdrop-blur-sm", children: [
      /* @__PURE__ */ jsx("div", { className: " p-6 ", children: /* @__PURE__ */ jsx("h3", { className: "text-2xl font-bold text-white mb-4", children: "Learn to Build Agents" }) }),
      /* @__PURE__ */ jsx("div", { className: "absolute -inset-1  opacity-30 group-hover:opacity-50 transition duration-300 blur" }),
      /* @__PURE__ */ jsx("div", { className: "relative   backdrop-blur-lg rounded-2xl p-1 h-full", children: /* @__PURE__ */ jsx("div", { className: "bg-[#0A0F1D]/80 rounded-xl overflow-hidden h-full", children: /* @__PURE__ */ jsx(
        "img",
        {
    ...
    /* @__PURE__ */ jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxs("div", { className: "relative group  rounded-2xl   backdrop-blur-sm", children: [
      /* @__PURE__ */ jsx("div", { className: " p-6 ", children: /* @__PURE__ */ jsx("h3", { className: "text-2xl font-bold text-white mb-4", children: "Vibe Coding" }) }),
      /* @__PURE__ */ jsx("div", { className: "absolute -inset-1  opacity-30 group-hover:opacity-50 transition duration-300 blur" }),
      /* @__PURE__ */ jsx("div", { className: "relative   backdrop-blur-lg rounded-2xl p-1 h-full", children: /* @__PURE__ */ jsxs("div", { className: "bg-[#0A0F1D]/90 rounded-xl overflow-hidden h-full relative", children: [
        /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-black/50 backdrop-blur-xl" }),
        /* @__PURE__ */ jsx(
          "img",
          {
            src: "/vibe_code.webp",
        ...
        /* @__PURE__ */ jsx("div", { className: "absolute inset-0 flex items-center justify-center   text-center", children: /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-br  h-full w-full from-black/60 to-indigo-900/30 p-8 rounded-2xl flex items-center justify-center", children: /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-white mb-2", children: "Build Full Stack Applications without even coding a single line of code" }) }) })
      ] }) })
    ] }) })
  ] }) }) });
};
const KuppamAnimatedSection = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative bg-[#0A0F1D] min-h-screen overflow-x-hidden", children: [
    /* @__PURE__ */ jsxs("section", { className: "relative min-h-screen flex items-center justify-center overflow-hidden bg-black", children: [
      /* @__PURE__ */ jsxs("div", { className: "relative z-10 max-w-4xl mx-auto px-6 text-center", children: [
        /* @__PURE__ */ jsx("div", { className: "h-32 md:h-40 flex items-center justify-center mb-8", children: /* @__PURE__ */ jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsx(
          motion.h1,
          {
            initial: { opacity: 0 },
            animate: { opacity: 1 },
      ...
      /* @__PURE__ */ jsx("div", { className: "absolute top-1/4 left-1/4 w-2 h-2 bg-blue-400/40 rounded-full blur-sm animate-pulse" }),
      /* @__PURE__ */ jsx("div", { className: "absolute top-3/4 right-1/3 w-1 h-1 bg-blue-300/30 rounded-full blur-sm animate-pulse" }),
      /* @__PURE__ */ jsx("div", { className: "absolute top-1/2 left-1/3 w-1.5 h-1.5 bg-purple-400/30 rounded-full blur-sm animate-pulse" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-1/2 h-1/2 bg-gradient-to-bl from-indigo-500/30 via-violet-500/20 to-transparent rounded-bl-full pointer-events-none blur-3xl" }),
    /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 w-1/2 h-1/2 bg-gradient-to-tr from-violet-500/30 via-indigo-500/20 to-transparent rounded-tr-full pointer-events-none blur-3xl" }),
    /* @__PURE__ */ jsx("div", { className: "absolute top-0 left-0 w-1/2 h-1/2 bg-gradient-to-br from-blue-500/30 via-purple-500/20 to-transparent rounded-br-full pointer-events-none blur-3xl" }),
    /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 right-0 w-1/2 h-1/2 bg-gradient-to-tl from-purple-500/30 via-blue-500/20 to-transparent rounded-tl-full pointer-events-none blur-3xl" }),
    /* @__PURE__ */ jsx(
      KuppamEnrollmentModal,
      {
        isOpen: isModalOpen,
...
const KuppamCourses = () => {
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx(SEO, {}),
    /* @__PURE__ */ jsx(KuppamHeader, {}),
    /* @__PURE__ */ jsx(KuppamSecond, {}),
    /* @__PURE__ */ jsx(KuppamTopics, {}),
    /* @__PURE__ */ jsx(KuppamAnimatedSection, {})
  ] });
};
export {
