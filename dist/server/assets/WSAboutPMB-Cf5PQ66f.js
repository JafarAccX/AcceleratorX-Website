...
const WSAboutPMB = () => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "bg-[#050A14] py-12 overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-8", children: [
    /* @__PURE__ */ jsxs("div", { className: "w-full lg:w-3/5 space-y-6", children: [
      /* @__PURE__ */ jsx("div", { className: "bg-[#0A1020] rounded-lg shadow-md border border-blue-900/20 overflow-hidden", children: /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
        /* @__PURE__ */ jsx("div", { className: "inline-flex items-center gap-2 bg-blue-500/10 rounded-md px-3 py-1 mb-4", children: /* @__PURE__ */ jsx("span", { className: "text-blue-400 text-sm font-medium", children: "One Tool. Complete Development Workflow." }) }),
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-[#111827] p-4 rounded-md border border-purple-500/10", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
              /* @__PURE__ */ jsx("div", { className: "p-1.5 bg-purple-500/10 rounded-md", children: /* @__PURE__ */ jsx(Target, { className: "w-4 h-4 text-purple-400" }) }),
            ...
            /* @__PURE__ */ jsx("ul", { className: "space-y-2", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-xs bg-purple-500/20 p-1 rounded-sm", children: index + 1 }),
              item
            ] }, index)) })
          ] })
        ] }),
      ...
      /* @__PURE__ */ jsxs("div", { ref: toolsRef, className: "bg-[#0A1020] rounded-lg shadow-md p-5 border border-blue-900/20", children: [
        /* @__PURE__ */ jsx("p", { className: "text-xl font-bold text-white mb-4", children: "Tools You'll Use" }),
          ...
          motion.div,
          {
            ...
            children: [...allTools, ...allTools].map((tool, index) => /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: "w-12 h-12 flex items-center justify-center bg-white rounded-md", children: /* @__PURE__ */ jsx("img", { src: tool.img, alt: tool.name, className: "w-12 h-12 object-contain" }) }),
    ...
    /* @__PURE__ */ jsx("div", { className: "w-full lg:w-2/5 space-y-6", children: /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-r from-blue-900/60 to-purple-900/60 rounded-lg overflow-hidden shadow-md", children: /* @__PURE__ */ jsxs("div", { className: "p-5 text-white", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "text-gray-200 mb-3 text-sm", children: "Finish the workshop and earn a professional certificate proving your ability to build, test, and deploy applications using one unified workflow." }),
      /* @__PURE__ */ jsx("div", { className: "bg-black/20 p-3 rounded-md text-xs text-gray-300 border border-white/10", children: "⚠️ You must attend the full session." })
    ] }) }) })
  ] }) }) });
};
export {
