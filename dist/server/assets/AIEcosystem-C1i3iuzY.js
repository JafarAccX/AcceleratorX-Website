...
function AIEcosystem() {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative z-10 py-20 bg-gradient-to-b from-[#0a0f1c] to-[#0b0a12] text-white overflow-hidden", children: [
    /* @__PURE__ */ jsx("div", { className: "absolute top-0 left-0 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl z-0" }),
    /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 right-0 w-[32rem] h-[32rem] bg-blue-500/10 rounded-full blur-3xl z-0" }),
    /* @__PURE__ */ jsxs("div", { className: "relative z-10 text-center px-4 mb-12", children: [
      /* @__PURE__ */ jsx(
        motion.h2,
        {
          ...
          children: "AI Data Analysis Ecosystem"
        }
      ),
      /* @__PURE__ */ jsx(
        motion.p,
        {
          ...
          children: "Master how AI integrates with tools you already use — Google Sheets, Notion, Excel, PowerBI, ChatGPT, Slack, and more — to create a seamless data workflow from raw input to powerful dashboards."
        }
      )
    ] }),
    /* @__PURE__ */ jsx("div", { className: "relative z-10 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-8 px-4 max-w-6xl mx-auto", children: aiTools.map((tool) => /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "bg-white/5 border border-white/10 rounded-2xl p-4 backdrop-blur-md shadow-lg transition-all hover:border-white/20 w-full max-w-[120px] h-[120px] flex flex-col items-center justify-center", children: [
            /* @__PURE__ */ jsx("img", { src: tool.logo, alt: `${tool.name} - ${tool.description}`, className: "w-10 h-10 object-contain mb-2" }),
