        ...
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative mt-8", children: [
              ...
              /* @__PURE__ */ jsx("h2", { className: "relative text-5xl font-bold text-[#1A5D1A] text-transparent bg-clip-text pb-3", children: "Build Your Data Analyst Portfolio" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "mt-6 text-xl text-black max-w-2xl mx-auto backdrop-blur-sm", children: "Create a portfolio that speaks for you, showcasing the real-world data analytics skills that gets you hired." })
          ]
        }
      ),
