...
import { L as Link, b as useCourseContext, S as SEO } from "../entry-server.js";
...
const features = [
  ...
  },
  {
    ...
    image: /* @__PURE__ */ jsxs("svg", { className: "w-full h-full", viewBox: "0 0 200 200", children: [
      ...
      /* @__PURE__ */ jsx("rect", { width: "200", height: "200", fill: "url(#grid5)" }),
      /* @__PURE__ */ jsxs(
        "g",
        {
          stroke: "currentColor",
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative max-w-7xl mx-auto py-12", children: [
          /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("p", { className: "text-3xl md:text-4xl font-bold text-white pb-2", children: [
                  "Browse Our ",
                  /* @__PURE__ */ jsx("span", { className: "bg-gradient-to-r from-blue-400 to-blue-600 text-transparent bg-clip-text", children: "AI Career Programs" })
                ] }),
                /* @__PURE__ */ jsx("p", { className: "text-gray-400 text-lg", children: "Learn the Skills that will shape your career" })
              ]
            }
          ),
      ...
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("h1", { className: "text-4xl font-bold text-white mb-4", children: "Trusted by 1700+ Organisations For Your AI Career" }),
            /* @__PURE__ */ jsx("p", { className: "text-lg text-blue-200/80 max-w-2xl mx-auto", children: "Our Partners & Hiring Network:" })
          ]
        }
      ),
...
function Hero() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative min-h-screen w-full overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "relative z-10 mx-auto max-w-7xl px-6", children: /* @__PURE__ */ jsxs("div", { className: "flex  min-h-screen h-full flex-col-reverse items-center justify-center gap-12 py-12 lg:flex-row lg:justify-between lg:py-20", children: [
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "max-w-xl text-lg text-gray-100 leading-relaxed", children: "Accelerate your career with a job-ready AI program. Learn how Data Analytics, Generative AI, and Digital Marketing Automation work through hands-on experience. Gain practical skills, get job-ready for high demand in AI Job roles." }),
