  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative py-12 bg-black", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "container mx-auto px-3 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: " mx-auto flex flex-col gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-gray-300 text-lg max-w-2xl", children: "A comprehensive 14-week program covering Generative AI, AI Agents, and Automation" })
      ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: " ", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4 mb-6", children: [
          /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 p-2.5 rounded-lg bg-st-500/10", children: /* @__PURE__ */ jsx(MonthIcon, { className: "w-6 h-6 text-blue-400" }) }),
        ...
        /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 gap-4", children: months[activeMonth].weeks.map((week, weekIndex) => /* @__PURE__ */ jsxs("div", { className: "bg-[#1F2937]/70 rounded-lg p-4 border border-gray-700", children: [
          /* @__PURE__ */ jsx("h4", { className: "text-lg font-semibold text-white mb-2", children: week.title }),
          /* @__PURE__ */ jsx("p", { className: "text-blue-300 text-sm mb-3 italic", children: week.goal }),
