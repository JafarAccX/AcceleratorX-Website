...
import { u as useGetJobById } from "./jobs-GT2dcr1q.js";
...
const SuccessModal = ({ onClose }) => /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-md rounded-2xl bg-[#0E1628] p-8 text-center", children: [
  /* @__PURE__ */ jsx("div", { className: "mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-green-500/10", children: /* @__PURE__ */ jsx(Check, { className: "h-8 w-8 text-green-500" }) }),
  /* @__PURE__ */ jsx("h3", { className: "mb-2 text-2xl font-bold text-white", children: "Application Submitted!" }),
  /* @__PURE__ */ jsx("p", { className: "mb-6 text-white/60", children: "Thank you for applying. We'll review your application and get back to you soon." }),
  /* @__PURE__ */ jsx(
    "button",
    {
      onClick: onClose,
...
function JobApplication() {
  ...
  if (error || !job) {
    return /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-[#080B16] pt-20 sm:pt-24 pb-6 sm:pb-12", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-4xl px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "rounded-xl bg-[#0E1628] p-8 text-center", children: [
        /* @__PURE__ */ jsx("p", { className: "text-red-500", children: error || "Job not found" }),
        /* @__PURE__ */ jsx(
          "button",
          {
            onClick: () => navigate("/jobs"),
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#080B16] pt-20 sm:pt-24 pb-6 sm:pb-12", children: [
    showSuccess && /* @__PURE__ */ jsx(SuccessModal, { onClose: () => navigate("/jobs") }),
    /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-4xl px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "rounded-xl bg-[#0E1628] p-6 sm:p-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
          /* @__PURE__ */ jsxs("h1", { className: "text-2xl sm:text-3xl font-bold text-white", children: [
            "Apply for ",
            job.title
          ] }),
          /* @__PURE__ */ jsx("p", { className: "mt-2 text-white/60", children: "Please fill out the form below to apply for this position." })
        ] }),
