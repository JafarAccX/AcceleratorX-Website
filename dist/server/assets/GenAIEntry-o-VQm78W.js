...
const GENHero = lazy(() => import("./GENHero-2SLfg3Le.js"));
const GENIntroduction = lazy(() => import("./GENIntroduction-DEV5sM6m.js"));
const GENLearningJourney = lazy(() => import("./GENLearningJourney-BV8Qqa7G.js"));
const GENMarketScope = lazy(() => import("./GENMarketScope-ByK0Lm1L.js"));
const GENPricing = lazy(() => import("./GENPricing-DmdKpz-P.js"));
const GENProjectsAndOutcomes = lazy(() => import("./GENProjectsAndOutcomes-C3Zq923q.js"));
const GENToolsYouWillLearn = lazy(() => import("./GENToolsYouWillLearn-DGj2lYOb.js"));
...
const GENMentors = lazy(() => import("./GENMentors-BbPgSgim.js"));
const GenAICourse = () => {
  const {
    setSelectedCourse
  } = useCourseContext();
