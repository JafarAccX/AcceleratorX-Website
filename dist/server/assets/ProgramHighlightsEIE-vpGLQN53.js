...
function ProgramHighlightsEIE() {
  ...
  return /* @__PURE__ */ jsx("section", { id: activeSection, className: "py-24 bg-white text-white", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxs("div", { className: "mb-16", children: [
      /* @__PURE__ */ jsxs("h2", { className: "text-2xl font-medium text-black mb-4", children: [
        "Key Highlights Of ",
        /* @__PURE__ */ jsx("span", { className: "text-black font-semibold", children: "EIE European Business School Product Management Program" })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-2", children: /* @__PURE__ */ jsxs("h3", { className: "text-4xl md:text-5xl font-bold text-[#5CB338]", children: [
        "What does this",
        " ",
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-4 gap-8", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "lg:col-span-3", children: activeSection === "bydp" ? renderBYDPSection() : /* @__PURE__ */ jsxs("div", { className: "bg-[#0F0F0F] rounded-xl p-8 border border-white/10", children: [
        /* @__PURE__ */ jsx("h3", { className: "text-2xl font-bold mb-8", children: sections[activeSection].title }),
