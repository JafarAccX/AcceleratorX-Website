  ...
  return /* @__PURE__ */ jsxs("section", { id: "pricing", className: "py-24 bg-black", children: [
    /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-3xl md:text-4xl font-bold text-white mb-4", children: "Choose Your Learning Path" }),
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
              /* @__PURE__ */ jsx("div", { className: "text-center", children: /* @__PURE__ */ jsx("h3", { className: "text-2xl mt-2 font-bold text-white mb-4", children: pricingData.title }) }),
              /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center gap-2 mb-2", children: /* @__PURE__ */ jsx("div", { className: "text-center", children: /* @__PURE__ */ jsxs("span", { className: "text-4xl font-bold text-white", children: [
                "₹",
                pricingData.mrp
              ] }) }) })
            ] }),
