  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden bg-gradient-to-b from-[#050A14] via-[#0A0F1F] to-[#050A14]", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 py-12 md:py-16 lg:py-20", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12", children: [
      /* @__PURE__ */ jsxs("div", { className: "w-full lg:w-1/2 space-y-6", children: [
        /* @__PURE__ */ jsx("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-green-500/10 border border-green-500/20", children: /* @__PURE__ */ jsx("span", { className: "text-green-400 font-medium text-sm", children: " AI-Powered Digital Marketing" }) }),
        /* @__PURE__ */ jsx("h1", { className: "text-3xl sm:text-4xl md:text-5xl font-bold leading-tight", children: /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-to-r from-white via-green-100 to-blue-100", children: "Conversion Rate Optimization with AI" }) }),
        /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-300 max-w-xl", children: "Master the art of conversion rate optimization using cutting-edge AI tools and strategies. Learn how to analyze user behavior, optimize landing pages, and implement data-driven techniques to dramatically improve your conversion rates." }),
        /* @__PURE__ */ jsxs("div", { className: "inline-flex flex-wrap items-center gap-3 px-4 py-2 bg-gradient-to-r from-green-500/10 to-blue-500/10 rounded-lg border border-green-500/20", children: [
          /* @__PURE__ */ jsx("div", { className: "text-yellow-400 text-sm font-medium", children: "Learn CRO with AI – Boost Your Conversion Rates" }),
        ...
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-4 gap-4 mt-6", children: [
          ...
          { icon: /* @__PURE__ */ jsx(FaCalendarAlt, { className: "text-indigo-400 mb-1" }), label: "Date", value: "Nov 23th" },
          {
