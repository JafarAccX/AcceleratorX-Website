  ...
  return /* @__PURE__ */ jsxs("section", { className: "py-24 bg-[#0a0a0a]", children: [
    /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
        ...
        /* @__PURE__ */ jsx("h3", { className: "text-4xl md:text-5xl font-bold text-white mb-4", children: "Choose Your Learning Path" }),
        /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-400 max-w-2xl mx-auto", children: "High-ROS (Return on Skills) that pays back in multiples" })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8 mb-12", children: pricingOptions.map((option, index) => /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "text-center mb-6", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-baseline justify-center gap-2 mb-2", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-gray-400 text-sm", children: option.description })
            ] }),
            /* @__PURE__ */ jsx(
              motion.button,
              {
