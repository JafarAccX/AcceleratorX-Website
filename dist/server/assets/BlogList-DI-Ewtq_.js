...
const BlogList = () => {
  ...
  if (loading) {
    return /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-black flex items-center justify-center", children: /* @__PURE__ */ jsx("div", { className: "animate-spin rounded-full h-12 w-12  border-blue-500" }) });
  }
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-black text-white pt-20", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 py-12", children: [
      ...
      Link,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
            /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold mb-2 line-clamp-2", children: blog.Title }),
