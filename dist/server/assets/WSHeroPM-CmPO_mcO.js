        ...
        /* @__PURE__ */ jsxs("div", { className: "relative z-10 max-w-4xl mx-auto px-6 text-center", children: [
          ...
          /* @__PURE__ */ jsx(
            motion.h1,
            {
              ...
              children: "Idea to Product Live (Bootcamp)"
            }
          ),
          /* @__PURE__ */ jsx(
            motion.p,
            {
              ...
              children: "Turn your idea into a product that works in the real world. From validation to launch, learn the exact steps to transform raw ideas into real, usable products."
            }
          ),
          /* @__PURE__ */ jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsx("p", { className: "text-yellow-200 text-sm font-medium", children: "⚠️ Note: This is a live-only workshop. No recordings will be provided." })
            }
          ),
      ...
      /* @__PURE__ */ jsx("div", { className: "container mx-auto  px-4", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col lg:flex-row items-start justify-between gap-12 lg:gap-20 my-24 md:my-28", children: /* @__PURE__ */ jsxs("div", { className: "w-full grid grid-cols-1 md:grid-cols-2  space-y-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 bg-indigo-500/10 border border-indigo-500/20 rounded-full px-4 py-2", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-sm font-medium bg-gradient-to-r from-indigo-400 to-violet-400 bg-clip-text text-transparent", children: "Limited Seats are available" })
          ] }),
          ...
          /* @__PURE__ */ jsx("p", { className: "text-gray-400   leading-relaxed", children: "Most ideas never make it beyond the notebook. This live bootcamp helps you change that. In just 3 hours, learn a proven process to validate your ideas, shape them into real products, and avoid the traps that kill most launches." }),
