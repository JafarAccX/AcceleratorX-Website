...
const N8nAutomationEntry = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen w-full bg-black", children: [
      /* @__PURE__ */ jsxs("div", { className: "relative w-full h-screen flex items-center justify-center", children: [
        /* @__PURE__ */ jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsx("div", { className: "absolute bottom-4 sm:bottom-6 md:bottom-10 left-1/2 transform -translate-x-1/2 z-10 px-4 w-full max-w-sm", children: /* @__PURE__ */ jsx(
          "button",
          {
      ...
      /* @__PURE__ */ jsx("div", { className: "w-full max-w-5xl mx-auto my-16", children: brochureImages.slice(1).map((image, index) => /* @__PURE__ */ jsx("div", { className: "w-full", children: /* @__PURE__ */ jsx(
        "img",
        {
          src: image.src,
          alt: image.alt,
      ...
      /* @__PURE__ */ jsx("div", { className: "relative bg-gradient-to-r from-gray-900 to-black py-20", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-6 text-center", children: [
        /* @__PURE__ */ jsxs("h2", { className: "text-4xl md:text-5xl font-bold text-white mb-6", children: [
          "Ready to Master ",
          /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-600", children: "n8n Automation" }),
          "?"
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-xl text-gray-300 mb-8 max-w-2xl mx-auto", children: "Join thousands of professionals who are already transforming their careers with workflow automation" }),
        /* @__PURE__ */ jsx("div", { className: "flex flex-col sm:flex-row gap-4 justify-center items-center px-4", children: /* @__PURE__ */ jsx(
          "button",
          {
            onClick: () => window.open("https://docs.google.com/forms/d/e/1FAIpQLSeJxgV3bMDrcy4m8bGdEIHqR0GLZrvVeZ5QF0itPIQqgDaC2g/viewform?usp=sharing&ouid=112961186201792362694", "_blank", "noopener,noreferrer"),
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto", children: [
          /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsx("div", { className: "text-3xl font-bold text-pink-400", children: "487%" }),
            /* @__PURE__ */ jsx("div", { className: "text-gray-300", children: "Growth in automation roles" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsx("div", { className: "text-3xl font-bold text-purple-400", children: "₹2.8L+" }),
            /* @__PURE__ */ jsx("div", { className: "text-gray-300", children: "Average salary premium" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsx("div", { className: "text-3xl font-bold text-pink-400", children: "8,500+" }),
            /* @__PURE__ */ jsx("div", { className: "text-gray-300", children: "Active job openings" })
          ] })
        ] })
      ] }) })
    ] })
