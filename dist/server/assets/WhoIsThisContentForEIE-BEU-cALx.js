...
const WhoIsThisContentForEIE = () => {
  ...
  return /* @__PURE__ */ jsx("section", { className: "py-16 bg-gradient-to-b from-[#F4F9F4] to-white", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        initial: "hidden",
        ...
        children: [
          /* @__PURE__ */ jsx("h2", { className: "text-4xl font-bold text-[#1A5D1A] mb-4", children: "Who Is This Program For?" }),
          /* @__PURE__ */ jsx("p", { className: "text-lg text-[#1F441E] max-w-3xl mx-auto", children: "Our EIE Data Analytics program is designed for ambitious professionals ready to master data-driven decision making, now featuring specialized tracks in Product Analytics" })
        ]
      }
    ),
    /* @__PURE__ */ jsx(
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "flex items-start space-x-4", children: [
              /* @__PURE__ */ jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsx(Check, { className: `w-5 h-5 ${item.highlight ? "text-amber-600" : "text-[#1A5D1A]"}` })
                }
              ) }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("h3", { className: `text-xl font-semibold mb-2 ${item.highlight ? "text-amber-600" : "text-[#1A5D1A]"}`, children: item.title }),
                /* @__PURE__ */ jsx("p", { className: "text-[#1F441E]", children: item.description })
              ] })
            ] })
          },
          index
