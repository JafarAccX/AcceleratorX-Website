  ...
  return /* @__PURE__ */ jsxs("section", { className: "py-24 ", children: [
    /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-16", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-2xl font-medium text-gray-400 mb-4", children: "Your 16 Weeks of learning Journey" }),
        /* @__PURE__ */ jsxs("h3", { className: "text-4xl md:text-5xl font-bold mb-6", children: [
          "The roadmap to becoming an",
          /* @__PURE__ */ jsx("span", { className: "text-[#5CB338]", children: " AI Marketer." })
        ] }),
      ...
      modules.map((module, moduleIndex) => /* @__PURE__ */ jsxs("div", { className: "mb-16", children: [
        /* @__PURE__ */ jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsx("h3", { className: "text-2xl font-bold text-[#5CB338]", children: module.title })
          }
        ),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2  gap-6", children: module.weeks.map((week, weekIndex) => /* @__PURE__ */ jsxs(
          motion.div,
          {
            initial: { opacity: 0, y: 20 },
            whileInView: { opacity: 1, y: 0 },
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("ul", { className: "list-disc list-inside text-gray-400 text-sm space-y-1", children: week.topics.map((topic, topicIndex) => /* @__PURE__ */ jsx("li", { children: topic }, topicIndex)) })
            ]
          },
          weekIndex
        )) })
