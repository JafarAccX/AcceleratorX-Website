  ...
  return /* @__PURE__ */ jsx("section", { className: "bg-[#050A14] py-12", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center mb-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 bg-blue-500/10 rounded-md px-3 py-1.5 mb-3", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "text-blue-400 text-sm font-medium", children: "Automate Repetitive Tasks Without Writing Code" })
      ] }),
      /* @__PURE__ */ jsxs("h1", { className: "text-3xl md:text-4xl font-bold text-white mb-3", children: [
        /* @__PURE__ */ jsx("span", { className: "text-blue-500", children: "Automate" }),
        " anything with n8n"
      ] }),
      /* @__PURE__ */ jsx("p", { className: "text-gray-400 text-base mb-8 max-w-2xl mx-auto", children: "Discover how to turn time-consuming tasks into powerful automated flows. This hands-on workshop teaches you how to use n8n to automate everything from data collection to communication—without writing a single line of code." })
    ] }),
