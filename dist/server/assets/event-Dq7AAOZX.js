...
import { AlertCircle, Users, Calendar, Clock, MapPin, Award, Zap, Star } from "lucide-react";
...
function CreateEventPage() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen  w-full  text-white", children: /* @__PURE__ */ jsx("div", { className: "max-w-3xl mx-auto ", children: /* @__PURE__ */ jsxs(
    motion.div,
    {
      ...
      children: [
        formError && /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsx(AlertCircle, { className: "mr-2", size: 18 }),
              formError
            ]
          }
        ),
        /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, children: [
          /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center mb-4", children: [
              /* @__PURE__ */ jsx(Users, { size: 18, className: "mr-2 text-purple-400" }),
              /* @__PURE__ */ jsx("h3", { className: "text-lg font-medium", children: "Participants" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
              /* @__PURE__ */ jsx("h4", { className: "text-sm font-medium text-gray-300 mb-3", children: "Participant 1" }),
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1  gap-4", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  errors.participant1 && /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-red-400", children: errors.participant1 })
                ] }),
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx(
                    "input",
                  ...
                  errors.participantsnumber1 && /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-red-400", children: errors.participantsnumber1 })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
              /* @__PURE__ */ jsx("h4", { className: "text-sm font-medium text-gray-300 mb-3", children: "Participant 2 (Optional)" }),
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1  gap-4", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx(
                    "input",
                  ...
                  errors.participant2 && /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-red-400", children: errors.participant2 })
                ] }),
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx(
                    "input",
                  ...
                  errors.participantsnumber2 && /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-red-400", children: errors.participantsnumber2 })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h4", { className: "text-sm font-medium text-gray-300 mb-3", children: "Participant 3 (Optional)" }),
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1  gap-4", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx(
                    "input",
                  ...
                  errors.participant3 && /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-red-400", children: errors.participant3 })
                ] }),
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx(
                    "input",
                  ...
                  errors.participantsnumber3 && /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-red-400", children: errors.participantsnumber3 })
                ] })
              ] })
            ] })
          ] }),
          ...
          formSuccess && /* @__PURE__ */ jsxs(
            motion.div,
            {
              ...
              transition: { duration: 0.3 },
              children: [
                /* @__PURE__ */ jsx(Calendar, { className: "mr-2", size: 18 }),
                formSuccess
              ]
            }
          )
...
function EventManagementPage() {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-to-br relative mt-14 from-gray-900 to-black text-white", children: [
    /* @__PURE__ */ jsx(SEO, {}),
    /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto p-6", children: [
      /* @__PURE__ */ jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsx("h1", { className: "text-4xl font-bold mt-2", children: "Product Inovation Challenge – The 7-Day Break-In " })
        }
      ),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [
        /* @__PURE__ */ jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsx(EventDetails, {})
          }
        ),
        /* @__PURE__ */ jsxs(
          motion.div,
            ...
            children: [
              /* @__PURE__ */ jsx(
                motion.div,
                {
                  ...
                  children: /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-br from-purple-900/30 to-pink-900/30 p-4 rounded-xl border border-purple-800/30", children: [
                    /* @__PURE__ */ jsxs("h3", { className: "text-lg font-semibold mb-3 flex items-center", children: [
                      /* @__PURE__ */ jsx(Clock, { size: 18, className: "mr-2 text-purple-400" }),
                      /* @__PURE__ */ jsx("span", { children: "Registrations closing soon" })
                    ] }),
                    /* @__PURE__ */ jsx("p", { className: "text-gray-300 text-sm mb-4", children: "Registrations close on May 4th — miss it now, and it's waitlist only. Don't scroll past your breakthrough." }),
                    /* @__PURE__ */ jsx("div", { className: "h-2 bg-gray-800 rounded-full overflow-hidden", children: /* @__PURE__ */ jsx(
                      motion.div,
                      {
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex justify-between mt-2 text-xs text-gray-400 ", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "w-full ", id: "registration", children: /* @__PURE__ */ jsx(CreateEventPage, {}) })
            ]
          }
        )
      ] })
...
function EventDetails() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-gradient-to-br from-gray-900 to-black text-white", children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto  ", children: [
    /* @__PURE__ */ jsx(
      motion.div,
      {
        ...
        animate: { opacity: 1, y: 0 },
        transition: { duration: 0.5 },
        children: /* @__PURE__ */ jsx("div", { className: "flex flex-col md:flex-row", children: /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsx(
            motion.h1,
            {
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center text-amber-400 mb-4", children: [
            /* @__PURE__ */ jsx("div", { className: "bg-amber-400/10 rounded-md p-1 mr-2", children: /* @__PURE__ */ jsx(Calendar, { size: 18, className: "text-amber-400" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("div", { className: "text-gray-300 text-sm", children: "May 8th 2025 - May 14th 2025" }),
              /* @__PURE__ */ jsx("div", { className: "text-amber-400 text-sm", children: "Daily tasks and live sessions (1–2 hours/day)" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center text-purple-400 mb-6", children: [
            /* @__PURE__ */ jsx("div", { className: "bg-purple-500/10 rounded-md p-1 mr-2", children: /* @__PURE__ */ jsx(MapPin, { size: 18 }) }),
            /* @__PURE__ */ jsx("span", { children: "Online (Zoom)" })
          ] }),
          /* @__PURE__ */ jsx(
            motion.div,
            {
              ...
              animate: { opacity: 1 },
              transition: { duration: 0.5, delay: 0.4 },
              children: /* @__PURE__ */ jsx("p", { className: "text-amber-400 mt-3 font-medium", children: "Limited spots available." })
            }
          )
        ] }) })
      }
    ...
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        transition: { duration: 0.5, delay: 0.2 },
        children: [
          /* @__PURE__ */ jsxs("h2", { className: "text-2xl font-bold mb-4 flex items-center", children: [
            /* @__PURE__ */ jsx(Award, { className: "mr-3 text-purple-400", size: 24 }),
            /* @__PURE__ */ jsx("span", { children: "What's the Product Inovation Challenge?" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-gray-300 mb-6 leading-relaxed", children: "Product Inovation is a 7-day challenge where you'll form a team of 3 (or go solo), build a product using any AI tool, and position yourself like a top-tier product manager. Along the way, you'll get access to live mentor sessions, resume reviews, a mock interview, and a shot at winning Rs 50,000*." }),
          /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-r from-purple-900/20 to-pink-900/20 p-6 rounded-xl border border-purple-800/20", children: [
            /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold mb-4", children: "Why This Challenge?" }),
            /* @__PURE__ */ jsx("ul", { className: "grid grid-cols-1 md:grid-cols-2 gap-3", children: [
              ...
              motion.li,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: "mr-2 mt-1 text-purple-400", children: "•" }),
                  /* @__PURE__ */ jsx("span", { children: item })
                ]
              },
              index
            )) }),
            /* @__PURE__ */ jsxs("p", { className: "mt-6 font-medium text-center text-lg", children: [
              /* @__PURE__ */ jsx("span", { className: "text-gray-400", children: "This isn't a passive course." }),
              /* @__PURE__ */ jsx("br", {}),
              /* @__PURE__ */ jsx("span", { className: "text-purple-400", children: "This is your proving ground." })
            ] })
          ] })
        ]
      }
      ...
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("h2", { className: "text-2xl font-bold mb-6 flex items-center", children: [
            /* @__PURE__ */ jsx(Clock, { className: "mr-3 text-purple-400", size: 24 }),
            /* @__PURE__ */ jsx("span", { children: "Challenge Timeline (What Happens Each Day)" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full", children: [
            /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "border-b border-gray-800", children: [
              /* @__PURE__ */ jsx("th", { className: "py-3 px-4 text-left text-purple-400", children: "Day" }),
              /* @__PURE__ */ jsx("th", { className: "py-3 px-4 text-left text-purple-400", children: "Activity" })
            ] }) }),
            /* @__PURE__ */ jsx("tbody", { children: timelineData.map((item, index) => /* @__PURE__ */ jsxs(
              motion.tr,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("td", { className: "py-3 px-4 font-medium", children: item.day }),
                  /* @__PURE__ */ jsx("td", { className: "py-3 px-4 text-gray-300", children: item.activity })
                ]
              },
              index
            )) })
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 mb-8", children: [
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("h2", { className: "text-2xl font-bold mb-4 flex items-center", children: [
              /* @__PURE__ */ jsx(Users, { className: "mr-3 text-purple-400", size: 24 }),
              /* @__PURE__ */ jsx("span", { children: "Who Should Join?" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-gray-300 mb-4", children: "This challenge is perfect for you if..." }),
            /* @__PURE__ */ jsx("ul", { className: "space-y-3 ", children: whoShouldJoin.map((item, index) => /* @__PURE__ */ jsxs(
              motion.li,
              {
                ...
                transition: { duration: 0.3, delay: 0.1 * index },
                children: [
                  /* @__PURE__ */ jsx("div", { className: "w-6 h-6 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center mr-3 flex-shrink-0", children: /* @__PURE__ */ jsx(Zap, { size: 14 }) }),
                  /* @__PURE__ */ jsx("span", { children: item })
                ]
              },
              index
      ...
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("h2", { className: "text-2xl font-bold mb-6 flex items-center", children: [
              /* @__PURE__ */ jsx(Star, { className: "mr-3 text-purple-400", size: 24 }),
              /* @__PURE__ */ jsx("span", { children: "Testimonials" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "relative flex-1 flex flex-col", children: [
              /* @__PURE__ */ jsx("div", { className: "absolute top-0 bottom-0 left-0 right-0", children: /* @__PURE__ */ jsx("div", { className: "h-full relative overflow-hidden", children: /* @__PURE__ */ jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsx(
                motion.div,
                {
                  ...
                  exit: { opacity: 0, x: -50 },
                  transition: { duration: 0.5 },
                  children: /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-r h-full mb-10 from-purple-900/20 to-pink-900/20 p-6 rounded-xl border border-purple-800/20 space-y-8", children: [
                    /* @__PURE__ */ jsxs("p", { className: "text-gray-300 italic mb-4", children: [
                      '"',
                      testimonials[currentTestimonial].text,
                      '"'
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
                      /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center mr-3", children: /* @__PURE__ */ jsx("span", { className: "font-bold", children: testimonials[currentTestimonial].author.charAt(0) }) }),
                      /* @__PURE__ */ jsxs("div", { children: [
                        /* @__PURE__ */ jsx("p", { className: "font-medium", children: testimonials[currentTestimonial].author }),
                        /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400", children: testimonials[currentTestimonial].role })
                      ] })
                    ] })
                  ] })
                },
              ...
              /* @__PURE__ */ jsx("div", { className: "mt-auto pt-40 flex justify-between items-center", children: /* @__PURE__ */ jsx("div", { className: "flex space-x-2", children: testimonials.map((_, index) => /* @__PURE__ */ jsx(
                "button",
                {
    ...
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        transition: { duration: 0.5, delay: 0.5 },
        children: [
          /* @__PURE__ */ jsx("h2", { className: "text-2xl md:text-3xl font-bold mb-4", children: "This 7-day challenge isn't just another event" }),
          /* @__PURE__ */ jsx("p", { className: "text-gray-300 mb-6 max-w-3xl mx-auto", children: "It's your shot to build a product, brand yourself, and stand out in a sea of job seekers. You'll learn from top PMs, compete for Rs 50,000*, and walk away with a personal story stronger than any resume." }),
          /* @__PURE__ */ jsx(
            motion.button,
            {
