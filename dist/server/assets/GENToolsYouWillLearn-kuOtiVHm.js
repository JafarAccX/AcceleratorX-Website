...
import { Rocket, Wrench, Cloud, Code, Video, Brain } from "lucide-react";
const GENToolsYouWillLearn = () => {
  const [activeCategory, setActiveCategory] = useState("Text & Language Models");
  const projects = [
    {
  ...
  return /* @__PURE__ */ jsx("section", { className: "relative py-6 ", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto flex flex-col gap-20", children: [
    /* @__PURE__ */ jsxs("div", { className: "mb-12", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-6", children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "text-2xl md:text-3xl font-bold  mb-2", children: "Learn by developing AI applications." }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-400 text-base max-w-2xl mx-auto", children: "Let's solve real-world problems by applying skills on building practical project.s" })
      ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-6 text-center flex flex-col gap-4", children: [
      ...
      /* @__PURE__ */ jsx("h2", { className: "text-2xl md:text-3xl font-bold   mb-2", children: "Master Industry-Leading AI Tools" }),
      /* @__PURE__ */ jsx("p", { className: "text-gray-600 text-base max-w-2xl mx-auto", children: "Get hands-on experience with the most powerful AI tools" }),
