  ...
  return /* @__PURE__ */ jsx("section", { className: "bg-[#050A14] py-12", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center mb-10", children: [
      /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 bg-blue-500/10 rounded-md px-3 py-1.5 mb-3", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "text-blue-400 text-sm font-medium", children: "For Doers & Builders" })
      ] }),
      ...
      /* @__PURE__ */ jsx("p", { className: "text-blue-100 max-w-xl mx-auto", children: "Anyone looking to grow faster, save time, boost creativity, and gain in-demand AI marketing skills can benefit from this workshop." })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-8 items-center", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "w-full lg:w-2/5", children: /* @__PURE__ */ jsx("div", { className: "relative rounded-lg overflow-hidden", children: /* @__PURE__ */ jsx("img", { src: "/genai.webp", alt: "AI Workflow Automation", className: "w-full h-auto object-cover" }) }) })
    ] })
  ] }) }) });
};
export {
