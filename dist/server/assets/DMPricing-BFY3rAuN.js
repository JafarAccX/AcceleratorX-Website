            ...
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "text-center mb-8", children: [
                  /* @__PURE__ */ jsx("h3", { className: "text-2xl font-mono font-bold text-neon-yellow mb-2 group-hover:text-neon-pink transition-colors duration-300", children: plan.name }),
                  /* @__PURE__ */ jsx("p", { className: "text-neutral-100/70 font-mono mb-4", children: plan.description }),
                  /* @__PURE__ */ jsxs("div", { className: "text-4xl font-mono font-bold text-neon-pink mb-2", children: [
                    "₹",
                    plan.price
                  ] })
                ] }),
