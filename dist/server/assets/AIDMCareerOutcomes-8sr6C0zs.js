...
import { Trophy, Brain, Target, Users, Briefcase, Star } from "lucide-react";
...
const AIDMCareerOutcomes = () => {
  ...
  return /* @__PURE__ */ jsx("section", { className: "py-24", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center mb-16", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-2xl font-medium text-gray-400 mb-4", children: "Career Outcomes" }),
      /* @__PURE__ */ jsx("h3", { className: "text-4xl md:text-5xl font-bold text-[#5CB338]", children: "Where This Nano-Degree Takes You" }),
      /* @__PURE__ */ jsx("p", { className: "text-xl text-gray-600 max-w-3xl mx-auto mt-6", children: "Discover the roles, skills, and ROI that await you after completing our program" })
    ] }),
