...
import { S as SEO, L as Link } from "../entry-server.js";
...
const Events = () => {
  ...
  const [workshopsTabs, setWorkshopsTabs] = useState("upcomming");
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-to-br from-gray-900 to-black", children: [
    /* @__PURE__ */ jsx(SEO, {}),
    /* @__PURE__ */ jsx("div", { className: " mt-10 md:mt-4 max-w-screen-lg mx-auto p-4 md:p-8", children: /* @__PURE__ */ jsx("div", { className: "min-h-screen  text-white md:p-6", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto mt-10", children: [
      /* @__PURE__ */ jsxs("header", { className: "flex justify-between items-center mb-10", children: [
        /* @__PURE__ */ jsx(
          motion.h1,
          {
        ...
        /* @__PURE__ */ jsx("div", { className: "bg-gray-800/50 rounded-full p-1", children: /* @__PURE__ */ jsxs("div", { className: "flex", children: [
          /* @__PURE__ */ jsx(
            "button",
            {
      ...
      /* @__PURE__ */ jsx("div", { className: "bg-gray-800/50 rounded-full p-1 mb-2 max-w-[215px]", children: /* @__PURE__ */ jsxs("div", { className: "flex", children: [
        /* @__PURE__ */ jsx(
          "button",
          {
      ...
      activeTab === "events" && /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row items-start justify-between", children: [
        eventsDetails.length <= 0 && /* @__PURE__ */ jsx("div", { className: "lg:flex-1 w-full", children: /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-br from-gray-800/70 to-gray-900/90 rounded-xl p-6 border border-gray-800", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
          /* @__PURE__ */ jsx("p", { className: "text-4xl pl-4", children: "No Events" }),
          /* @__PURE__ */ jsx(EventThumbnail, { num: 9 })
        ] }) }) }),
        eventsDetails.map((event) => /* @__PURE__ */ jsx("div", { className: "lg:flex-1 w-full", children: /* @__PURE__ */ jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsxs("h2", { className: "text-2xl font-semibold mb-4", children: [
                  " ",
                  event.name
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center text-amber-400 mb-2", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex items-center text-gray-400", children: [
                  /* @__PURE__ */ jsx(Clock, { size: 16, className: "mr-2" }),
                  /* @__PURE__ */ jsx("span", { children: event.val })
                ] }),
                /* @__PURE__ */ jsx(Link, { to: event.link, children: /* @__PURE__ */ jsxs("button", { className: "mt-6 flex items-center bg-gray-800 hover:bg-gray-700 text-gray-300 hover:text-white px-4 py-2 rounded-lg transition-all duration-300 group", children: [
                  /* @__PURE__ */ jsx("span", { children: "Event Info" }),
                  /* @__PURE__ */ jsx(
                    ArrowRight,
                    {
                      size: 16,
                ...
                /* @__PURE__ */ jsxs("p", { className: "text-gray-400 mt-2", children: [
                  " ",
                  event.time
                ] })
              ] }),
      ...
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 max-w-screen-lg items-center justify-center gap-4", children: activeTab === "workshops" && workshopsDetails.map((workshop) => /* @__PURE__ */ jsx("div", { className: "flex flex-col lg:flex-row items-start justify-between h-full", children: /* @__PURE__ */ jsx("div", { className: "lg:flex-1 w-full h-full", children: /* @__PURE__ */ jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-around h-full", children: [
            /* @__PURE__ */ jsx("h2", { className: "text-2xl font-semibold mb-4", children: workshop.name }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center text-amber-400 mb-2", children: [
              /* @__PURE__ */ jsx(MapPin, { size: 16, className: "mr-2" }),
              /* @__PURE__ */ jsx("span", { children: workshop.mode })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center text-gray-400", children: [
              /* @__PURE__ */ jsx(Clock, { size: 16, className: "mr-2" }),
              /* @__PURE__ */ jsx("p", { className: "text-gray-400 mt-2", children: workshop.time })
            ] }),
            /* @__PURE__ */ jsx(Link, { to: workshop.completed ? "" : workshop.link, "aria-disabled": true, children: /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("span", { children: workshop.completed ? "Completed" : "Workshop Info" }),
                  workshop.completed ? /* @__PURE__ */ jsx(
                    Check,
                    {
                      size: 16,
...
function EventThumbnail({ num }) {
  return /* @__PURE__ */ jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 grid-rows-3 gap-1", children: Array.from({ length: num }).map((_, i) => /* @__PURE__ */ jsx(
        motion.div,
        {
