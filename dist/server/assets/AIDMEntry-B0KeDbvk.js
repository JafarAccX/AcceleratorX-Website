...
const AIDMHero = () => {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative  border-b border-green-900 bg-black overflow-hidden", children: [
    /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-screen flex items-center justify-center", children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-2 gap-8 items-center z-20", children: [
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsx("div", { className: "inline-block mb-4 px-3 py-1 rounded-md bg-[#5CB338]/20 border border-[#5CB338]", children: /* @__PURE__ */ jsx("span", { className: "text-[#fff] font-semibold text-sm sm:text-base", children: "#1 IN AI MARKETING" }) }),
...
const AIDMRoadmap = lazy(() => import("./AIDMRoadmap-BvrMT9Fe.js"));
const AIDMTools = lazy(() => import("./AIDMTools-DwvLneL1.js"));
const AIDMCareerOutcomes = lazy(() => import("./AIDMCareerOutcomes-8sr6C0zs.js"));
const AIDMMentors = lazy(() => import("./AIDMMentors-CTNE7K49.js"));
const AIDMCertification = lazy(() => import("./AIDMCertification-kkL0_uO_.js"));
const AIDMPricing = lazy(() => import("./AIDMPricing-CAApiVi5.js"));
const AIDMFAQ = lazy(() => import("./AIDMFAQ-CWgnsvbW.js"));
const AIDMFinalCTA = lazy(() => import("./AIDMFinalCTA-C10FsxWI.js"));
const AIDMEntry = () => {
  const {
    setSelectedCourse
  } = useCourseContext();
