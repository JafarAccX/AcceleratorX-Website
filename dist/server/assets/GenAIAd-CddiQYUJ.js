...
const GENBYOAAd = lazy(() => import("./GENBYOAAd-B9k_qfs3.js"));
...
const GENMarketScopeAd = lazy(() => import("./GENMarketScopeAd-DhFoRO2S.js"));
const GENToolsYouWillLearnAd = lazy(() => import("./GENToolsYouWillLearnAd-Dqd9WG3J.js"));
const GENWhoShouldEnrollAd = lazy(() => import("./GENWhoShouldEnrollAd-1uZ1Cb-F.js"));
const GenAICourseAD = () => {
  const {
    setSelectedCourse
  } = useCourseContext();
