...
import { Calendar, ChevronLeft, ChevronRight, Rocket, Cloud, BookOpen } from "lucide-react";
...
const GENLearningJourneyAd = () => {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative py-12 bg-black", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "container mx-auto px-3 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "text-3xl md:text-4xl font-bold text-white mb-3", children: "Your Path to AI Mastery" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-300 text-lg max-w-2xl", children: "A comprehensive 3-month journey to master Generative AI and build real-world applications" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-6", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "flex items-center gap-3", children: months.map((_, index) => /* @__PURE__ */ jsx(
          "button",
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-[#111827] rounded-xl p-6 border border-gray-800", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4 mb-6", children: [
          /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 p-2.5 rounded-lg bg-blue-500/10", children: /* @__PURE__ */ jsx(MonthIcon, { className: "w-6 h-6 text-blue-400" }) }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-white mb-2", children: months[activeMonth].title }),
            /* @__PURE__ */ jsx("p", { className: "text-gray-300", children: months[activeMonth].goal })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 gap-4", children: months[activeMonth].weeks.map((week, weekIndex) => /* @__PURE__ */ jsxs("div", { className: "bg-[#1F2937] rounded-lg p-4 border border-gray-700", children: [
          /* @__PURE__ */ jsx("h4", { className: "text-lg font-semibold text-white mb-3", children: week.title }),
          /* @__PURE__ */ jsx("ul", { className: "space-y-2", children: week.content.map((point, pointIndex) => /* @__PURE__ */ jsxs("li", { className: "text-gray-300 text-sm flex items-start gap-2", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-12 text-center", children: [
      /* @__PURE__ */ jsx("p", { className: "text-gray-300 text-lg mb-6", children: "Ready to start your AI learning journey?" }),
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx(Rocket, { className: "w-5 h-5 mr-2" }),
            "Begin Your Journey"
          ]
        }
      )
