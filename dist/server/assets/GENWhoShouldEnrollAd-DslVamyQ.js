      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
        /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
          ...
          /* @__PURE__ */ jsxs("h2", { className: "text-3xl md:text-4xl font-bold mb-3", children: [
            /* @__PURE__ */ jsx("span", { className: "text-white", children: "Who Should Take " }),
            /* @__PURE__ */ jsx("span", { className: "text-blue-500", children: "This Course" }),
            /* @__PURE__ */ jsx("span", { className: "text-white", children: "?" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-lg text-blue-100", children: "Designed for professionals and beginners looking to master AI without coding" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 gap-4", children: targetAudience.map((audience, index) => /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 p-2.5 rounded-lg bg-blue-50 group-hover:bg-blue-100 transform group-hover:rotate-6 transition-all duration-300", children: /* @__PURE__ */ jsx(audience.icon, { className: "w-5 h-5 text-blue-600" }) }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-blue-900 group-hover:text-blue-700 transition-colors", children: audience.title }),
                /* @__PURE__ */ jsx("p", { className: "text-sm text-blue-700 mb-2", children: audience.description })
              ] })
            ] })
          },
          index
        )) }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-300 text-lg mb-6", children: "Whether you're a complete beginner or an experienced professional, our course is designed to help you master AI tools and concepts." }),
        /* @__PURE__ */ jsx(
          "button",
          {
