    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 relative z-10", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-12", children: [
        /* @__PURE__ */ jsxs("div", { className: "md:col-span-4 space-y-8", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-gray-400 max-w-md", children: "Empowering professionals with industry-relevant skills through expert-led programs in Product Management, Data Analytics & Generative AI." }),
          /* @__PURE__ */ jsxs("div", { className: "pt-4", children: [
            /* @__PURE__ */ jsx("h3", { className: "font-semibold text-white mb-4 text-lg", children: "Connect With Us" }),
            /* @__PURE__ */ jsx("div", { className: "flex items-center gap-4", children: footerLinks.social.links.map((link) => /* @__PURE__ */ jsx(
              "a",
              {
                href: link.url,
                target: "_blank",
                ...
                children: /* @__PURE__ */ jsx("span", { className: "text-gray-400 group-hover:text-white transition-colors duration-300", children: link.icon })
              },
              link.label
            )) })
          ] })
        ...
        /* @__PURE__ */ jsx("div", { className: "md:col-span-4 grid grid-cols-2 gap-8", children: ["services", "company"].map((key) => /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h3", { className: "font-semibold text-white mb-4 text-lg", children: footerLinks[key].title }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "md:col-span-4", children: [
          /* @__PURE__ */ jsx("h3", { className: "font-semibold text-white mb-4 text-lg", children: footerLinks.contact.title }),
