        ...
        /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center min-h-[80vh] max-w-7xl mx-auto", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
            /* @__PURE__ */ jsx("div", { className: "space-y-2", children: /* @__PURE__ */ jsxs("h1", { className: "text-5xl lg:text-6xl font-bold text-white leading-tight", children: [
              "Dashboarding with ",
              /* @__PURE__ */ jsx("span", { className: "text-5xl lg:text-6xl font-bold bg-gradient-to-r from-purple-400 to-emerald-400 bg-clip-text text-transparent leading-tight", children: "PowerBI" })
            ] }) }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-4 text-slate-300 text-lg max-w-lg", children: [
              /* @__PURE__ */ jsx("p", { className: "font-medium", children: "Learn how to create stunning interactive dashboards with PowerBI — visualize data, gain insights, and make data-driven decisions!" }),
              /* @__PURE__ */ jsx("div", { className: "bg-yellow-900/20 border border-yellow-500/30 rounded-lg p-3 mt-4", children: /* @__PURE__ */ jsx("p", { className: "text-yellow-200 text-sm font-medium", children: "⚠️ Note: This is a live-only workshop. No recordings will be provided." }) })
            ] })
          ] }),
