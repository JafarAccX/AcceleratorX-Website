        ...
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4 w-full", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-4 rounded-lg text-center", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400", children: "From blank page to working Agent" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-4 rounded-lg text-center", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400", children: "Agents that know what you mean, not just what you type" })
            ] })
          ] })
        }
      ),
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("p", { children: "100+ beginners have already built with us. Now it’s your turn." }),
            /* @__PURE__ */ jsx("p", { children: "Click Register Now – Join the live bootcamp and build your first AI Agents!" }),
            /* @__PURE__ */ jsxs(
              "button",
              {
