...
const GENBYOAAd = lazy(() => import("./GENBYOAAd-C-oysnfv.js"));
const GENFAQAd = lazy(() => import("./GENFAQAd-LCtVZJOa.js"));
const GENHeroAd = lazy(() => import("./GENHeroAd-BQqO3ZrL.js"));
const GENIntroductionAd = lazy(() => import("./GENIntroductionAd-BBT-plWX.js"));
const GENLearningJourneyAd = lazy(() => import("./GENLearningJourneyAd-CYSRXwqU.js"));
const GENMarketScopeAd = lazy(() => import("./GENMarketScopeAd-Db2npn61.js"));
const GENToolsYouWillLearnAd = lazy(() => import("./GENToolsYouWillLearnAd-Dy7KpAvv.js"));
const GENWhoShouldEnrollAd = lazy(() => import("./GENWhoShouldEnrollAd-D3nHUUB7.js"));
const GenAICourseAD = () => {
  const {
    setSelectedCourse
  } = useCourseContext();
