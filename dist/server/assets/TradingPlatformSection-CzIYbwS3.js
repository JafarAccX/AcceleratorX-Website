    ...
    /* @__PURE__ */ jsxs("div", { className: "relative z-10 container mx-auto px-6 ", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center justify-center mb-16 max-w-5xl mx-auto", children: [
        /* @__PURE__ */ jsx("div", { className: "flex items-center justify-end ", children: /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-slate-300 text-lg leading-relaxed max-w-lg", children: '"Data is the new oil. AI is the refinery."' }),
          /* @__PURE__ */ jsx("p", { className: "text-slate-300 text-lg leading-relaxed max-w-lg", children: "Whether you’re an aspiring data analyst, a career switcher, or a working professional — this crash course is designed to help you:" }),
          /* @__PURE__ */ jsxs("ul", { className: "text-slate-300 text-lg leading-relaxed max-w-lg list-disc pl-6 space-y-2", children: [
            /* @__PURE__ */ jsx("li", { children: "Understand how AI transforms traditional data analysis." }),
            /* @__PURE__ */ jsx("li", { children: "Learn to automate repetitive analysis tasks." }),
            /* @__PURE__ */ jsx("li", { children: "Make sense of data faster and communicate insights effectively." })
          ] })
        ] }) }),
