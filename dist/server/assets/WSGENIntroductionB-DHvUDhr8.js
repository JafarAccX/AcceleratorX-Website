  ...
  return /* @__PURE__ */ jsx("section", { className: "bg-[#050A14] py-12", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center mb-8", children: [
      /* @__PURE__ */ jsxs("h1", { className: "text-3xl md:text-4xl font-bold text-white mb-3", children: [
        /* @__PURE__ */ jsx("span", { className: "text-blue-500", children: "Automate & Grow Smarter" }),
        " with AI"
      ] }),
      /* @__PURE__ */ jsx("p", { className: "text-gray-400 text-base mb-8 max-w-2xl mx-auto", children: "Learn to automate, create, and scale smarter — without touching a line of code. This live, hands-on session gives you everything you need to build real workflows that save time and drive results." })
    ] }),
