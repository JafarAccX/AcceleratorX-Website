        ...
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4 w-full", children: [
            /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-4 rounded-lg text-center", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-green-400", children: "Create Automation Flows" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400", children: "From idea to working system" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-4 rounded-lg text-center", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400", children: "From visual nodes to deployment" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-4 rounded-lg text-center", children: [
              /* @__PURE__ */ jsx(Code, { className: "w-6 h-6 text-blue-400 mx-auto mb-2" }),
              /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-blue-400", children: "Functional AI Automation" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400", children: "Real workflows that solve real problems" })
            ] })
          ] })
        }
      ),
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("p", { children: "100+ beginners have already automated their workflows with Flowise. Now it's your turn." }),
            /* @__PURE__ */ jsx("p", { children: "Click Register Now and start your automation journey today!" }),
            /* @__PURE__ */ jsxs(
              "button",
              {
