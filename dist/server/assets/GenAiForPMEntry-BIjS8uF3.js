...
const GENIntroduction = () => {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative py-8 bg-black min-h-screen flex items-center overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 relative z-10 ", children: /* @__PURE__ */ jsxs("div", { className: "  mx-auto text-center", children: [
      ...
      /* @__PURE__ */ jsxs("h1", { className: "text-4xl text-white md:text-5xl font-bold mb-4", children: [
        "Supercharge Your ",
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative py-12 bg-black", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "container mx-auto px-3 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto flex flex-col gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-3xl md:text-4xl font-bold text-white mb-3", children: "Your GenAI PM Learning Path" }),
