...
const WSGENWhoShouldEnrollB = () => {
  ...
  return /* @__PURE__ */ jsx("section", { className: "bg-[#050A14] py-12", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center mb-10", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "text-blue-100 max-w-xl mx-auto", children: "Master the art of workflow automation with n8n, all without writing a single line of code." })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-8 items-center", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "w-full lg:w-2/5", children: /* @__PURE__ */ jsx("div", { className: "relative rounded-lg overflow-hidden", children: /* @__PURE__ */ jsx("img", { src: "/genai.svg", alt: "AI Workflow Automation", className: "w-full h-auto object-cover" }) }) })
    ] })
  ] }) }) });
};
export {
