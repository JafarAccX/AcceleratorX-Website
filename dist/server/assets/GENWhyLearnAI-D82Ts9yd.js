    ...
    /* @__PURE__ */ jsx("div", { className: "container mx-auto px-3 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "  mx-auto", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
        ...
        /* @__PURE__ */ jsxs("h2", { className: "text-3xl md:text-4xl font-bold mb-3", children: [
          /* @__PURE__ */ jsx("span", { className: "text-white", children: "Current Market " }),
          /* @__PURE__ */ jsx("span", { className: "text-blue-500", children: "Reality in Generative AI domain." })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-lg text-blue-100", children: "Uncover how Generative AI solves crucial challenges and develops new opportunities." })
      ] }),
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-base font-semibold  mb-1", children: challenge.title }),
        ...
        /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-3 gap-6", children: solutions.map((solution, index) => /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-base font-semibold  mb-1", children: solution.title }),
