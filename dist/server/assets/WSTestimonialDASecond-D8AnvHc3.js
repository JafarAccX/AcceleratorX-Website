...
function WSTestimonialDASecond() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("section", { className: "relative z-10 px-6 py-20 text-white max-w-4xl mx-auto", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-4xl font-bold mb-10 text-center", children: "FAQs" }),
            ...
            children: [
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("h3", { className: "text-lg font-medium", children: faq.question }),
                    /* @__PURE__ */ jsx("span", { className: "text-white bg-white/10 p-2 rounded-full transition-transform group-hover:scale-105", children: isOpen ? /* @__PURE__ */ jsx(FiArrowUpRight, { className: "text-white" }) : /* @__PURE__ */ jsx(FiArrowRight, { className: "text-white" }) })
                  ]
                }
              ),
              /* @__PURE__ */ jsx(AnimatePresence, { initial: false, children: isOpen && /* @__PURE__ */ jsx(
                motion.div,
                {
                  ...
                  children: /* @__PURE__ */ jsx("div", { className: "mt-4 text-sm text-gray-300 leading-relaxed", children: faq.answer })
                }
              ) })
            ]
          },
    ...
    /* @__PURE__ */ jsxs("section", { className: "relative z-10 bg-gradient-to-b from-[#0A0F1C] to-[#121a2e] px-6 py-24 text-white overflow-hidden", children: [
      /* @__PURE__ */ jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-1/2 -translate-x-1/2 w-[80vw] h-[40vh] bg-purple-500/10 blur-3xl rounded-full pointer-events-none z-0" }),
