    ...
    /* @__PURE__ */ jsx("div", { className: "relative py-16 sm:py-24", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-7xl px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center space-y-10", children: [
        ...
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4 w-full", children: [
            /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-4 rounded-lg text-center", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-green-400", children: "Use Your Own Data" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400", children: "PDFs, notes, websites, databases." })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-4 rounded-lg text-center", children: [
              /* @__PURE__ */ jsx(Database, { className: "w-6 h-6 text-purple-400 mx-auto mb-2" }),
              /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-purple-400", children: "Step-by-Step Guidance" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400", children: "From blank page to working app." })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-4 rounded-lg text-center", children: [
              /* @__PURE__ */ jsx(Code, { className: "w-6 h-6 text-blue-400 mx-auto mb-2" }),
              /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-blue-400", children: "Smart Responses, Your Way" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400", children: "AI that knows what you mean, not just what you type." })
            ] })
          ] })
        }
      ),
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          transition: { duration: 0.6, delay: 0.2 },
          children: [
            /* @__PURE__ */ jsx("p", { className: "bg-blue-500/10 rounded-full px-6 py-2 text-lg font-bold text-white", children: "Are You Ready to Build With AI — and Actually Enjoy It?" }),
            /* @__PURE__ */ jsx("p", { children: "100+ beginners have built with us. Now it’s your turn." }),
            /* @__PURE__ */ jsx("p", { children: "Click below. Join the live workshop. Build something real." }),
            /* @__PURE__ */ jsxs(
              "button",
              {
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-8 flex flex-col items-center space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center space-x-2", children: [
          /* @__PURE__ */ jsx("img", { src: "/favicon.svg", alt: "AcceleratorX", className: "h-6 w-6" }),
