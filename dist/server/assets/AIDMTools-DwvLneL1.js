  ...
  return /* @__PURE__ */ jsx("section", { className: "py-24 bg-[#0a0a0a]", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center mb-16", children: [
      ...
      /* @__PURE__ */ jsxs("h3", { className: "text-4xl md:text-5xl font-bold text-white mb-6", children: [
        "The ",
        /* @__PURE__ */ jsx("span", { className: "text-[#5CB338]", children: "AI Stack" }),
        " Top Recruiters Want"
      ] }),
      /* @__PURE__ */ jsx("p", { className: "text-xl text-gray-400 max-w-3xl mx-auto", children: "Master the essential AI tools and technologies that industry leaders are looking for" })
    ] }),
      ...
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "p-6 bg-[#0F0F0F] border border-white/10 rounded-2xl backdrop-blur-sm transition-all duration-300 hover:border-[#5CB338]/50 hover:shadow-lg hover:shadow-[#5CB338]/5", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-2", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-gray-400 text-sm leading-relaxed", children: category.tools })
          ] })
        ] }) })
      },
      index
