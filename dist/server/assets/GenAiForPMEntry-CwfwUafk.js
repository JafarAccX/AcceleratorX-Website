...
import { ArrowRight, Brain, Target, Users, Briefcase, Megaphone, Sparkles, Bot, Workflow, Cpu, Zap, BarChart, Linkedin, Rocket, Wrench, Code, Cloud, Check, HelpCircle, ChevronDown, TrendingUp, Calendar, ChevronLeft, ChevronRight, BookOpen, Loader } from "lucide-react";
...
const GENHero = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("section", { className: "relative min-h-screen flex items-center justify-center overflow-hidden bg-black", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 z-0", children: /* @__PURE__ */ jsx("img", { src: "/backgrounds/bg1-.webp", alt: "GenAI for PM Hero", className: "absolute w-full h-full object-cover opacity-40" }) }),
      /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 relative z-20", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto text-center", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-4xl md:text-6xl font-bold mb-6 pb-4 bg-white text-transparent bg-clip-text", children: "Ultimate 8-Week Generative AI Program for Product Managers" }),
        /* @__PURE__ */ jsx("p", { className: "text-xl md:text-2xl text-gray-300 mb-8", children: "Learn GenAI, Build Real Products, and Launch Your PM Career Into the Future — No Tech Background Needed" }),
        /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-400 mb-8 max-w-3xl mx-auto", children: "Limited Slots | No Coding Required | Starts This Month" }),
...
const GENIntroduction = () => {
  ...
  const features = [
    {
      icon: /* @__PURE__ */ jsx(Target, { className: "w-5 h-5 text-blue-500" }),
      title: "AI for Product Managers",
      description: "Master GenAI tools to automate research, roadmap planning, and user feedback analysis."
    },
    {
      icon: /* @__PURE__ */ jsx(Brain, { className: "w-5 h-5 text-blue-500" }),
      title: "No Technical Prerequisites",
      description: "Designed for PMs and aspiring PMs—focus on practical GenAI skills, not coding."
    }
  ];
  return /* @__PURE__ */ jsxs("section", { className: "relative py-8 bg-black min-h-screen flex items-center overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-black via-black/90 to-black pointer-events-none" }),
    /* @__PURE__ */ jsx("div", { className: "absolute top-0 -left-48 w-96 h-96 bg-blue-500/10 rounded-full blur-[128px] animate-pulse-slow" }),
    /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 -right-48 w-96 h-96 bg-purple-500/10 rounded-full blur-[128px] animate-pulse-slow" }),
    /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 relative z-10 ", children: /* @__PURE__ */ jsxs("div", { className: "  mx-auto text-center", children: [
      /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6", children: [
        /* @__PURE__ */ jsx(Brain, { className: "w-4 h-4 text-blue-400" }),
        /* @__PURE__ */ jsx("span", { className: "text-sm text-blue-400 font-medium", children: "GenAI for Product Managers" })
      ] }),
      /* @__PURE__ */ jsxs("h2", { className: "text-4xl text-white md:text-5xl font-bold mb-4", children: [
        "Supercharge Your ",
        /* @__PURE__ */ jsx("span", { className: "text-blue-500", children: "PM Career" }),
        " with GenAI"
      ] }),
      /* @__PURE__ */ jsx("p", { className: "text-gray-400 text-lg mb-12 max-w-3xl mx-auto", children: "Learn how to leverage Generative AI to streamline product workflows, boost team productivity, and deliver better products—faster." }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4 mb-12", children: stats.map((stat, index) => /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-6 rounded-lg backdrop-blur-sm border border-white/5", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: features.map((feature, index) => /* @__PURE__ */ jsxs(
        "div",
        {
          className: "bg-white/5 backdrop-blur-sm rounded-xl p-6 flex items-start gap-4 border border-white/10",
          children: [
            /* @__PURE__ */ jsx("div", { className: "rounded-full bg-blue-500/10 p-2.5 backdrop-blur-sm", children: feature.icon }),
...
const GENWhoShouldEnroll = () => {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative py-12 bg-black", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "container mx-auto px-3 relative z-10", children: /* @__PURE__ */ jsx("div", { className: "max-w-6xl mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-12 items-center", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
        /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
          /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 bg-white rounded-full px-4 py-2 mb-3 transform hover:scale-105 transition-all", children: [
            /* @__PURE__ */ jsx(Users, { className: "w-4 h-4 text-blue-600" }),
            /* @__PURE__ */ jsx("span", { className: "text-blue-600 text-sm font-medium", children: "Perfect For You" })
          ] }),
          /* @__PURE__ */ jsxs("h2", { className: "text-3xl md:text-4xl font-bold mb-3", children: [
            /* @__PURE__ */ jsx("span", { className: "text-white", children: "Who’s This" }),
            /* @__PURE__ */ jsx("span", { className: "text-blue-500", children: " Program " }),
            /* @__PURE__ */ jsx("span", { className: "text-white", children: "For?" })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 gap-4", children: targetAudience.map((audience, index) => /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "flex  flex-col items-start gap-3", children: [
              /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 p-2.5 rounded-lg bg-blue-50/20 group-hover:bg-blue-100 transform group-hover:rotate-6 transition-all duration-300", children: /* @__PURE__ */ jsx(audience.icon, { className: "w-5 h-5 text-blue-600" }) }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold   transition-colors", children: audience.title }),
                /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400 mb-2", children: audience.description })
              ] })
            ] })
          },
          index
...
const GENBYOA = () => {
  const features = [
    {
      icon: /* @__PURE__ */ jsx(Bot, { className: "w-5 h-5 text-blue-500" }),
    ...
    {
      icon: /* @__PURE__ */ jsx(Workflow, { className: "w-5 h-5 text-blue-500" }),
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative py-6 bg-black", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "absolute top-0 -left-48 w-96 h-96 bg-blue-500/10 rounded-full blur-[128px] animate-pulse-slow" }),
    /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 -right-48 w-96 h-96 bg-purple-500/10 rounded-full blur-[128px] animate-pulse-slow" }),
    /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto", children: [
      /* @__PURE__ */ jsx("div", { className: "flex justify-center mb-6", children: /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2", children: [
        /* @__PURE__ */ jsx(Sparkles, { className: "w-4 h-4 text-blue-400" }),
        /* @__PURE__ */ jsx("span", { className: "text-sm text-blue-400 font-medium", children: "GenAI Agents for PMs" })
      ] }) }),
      /* @__PURE__ */ jsxs("h2", { className: "text-4xl text-white font-bold mb-6 text-center", children: [
        "Build ",
        /* @__PURE__ */ jsx("span", { className: "text-blue-500", children: "GenAI Agents" }),
        " for Product Management"
      ] }),
      /* @__PURE__ */ jsx("p", { className: "text-gray-400 text-lg mb-12 text-center max-w-3xl mx-auto", children: "Learn to build, customize, and deploy GenAI agents that automate product management workflows, enhance team collaboration, and drive better product outcomes—no coding required." }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: features.map((feature, index) => /* @__PURE__ */ jsx(
        "div",
        {
          className: "group bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-blue-500/50 transition-all duration-300",
          children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
            /* @__PURE__ */ jsx("div", { className: "rounded-lg bg-blue-500/10 p-3 group-hover:bg-blue-500/20 transition-colors", children: feature.icon }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold text-white mb-2", children: feature.title }),
    ...
    /* @__PURE__ */ jsx("div", { className: "container mx-auto px-3 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "  mx-auto", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
        /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2  border border-blue-600 rounded-full px-4 py-2 mb-3 transform hover:scale-105 transition-all", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-blue-600 text-base font-medium", children: "GenAI Challenges & Solutions for PMs" })
        ] }),
        /* @__PURE__ */ jsxs("h3", { className: "text-3xl md:text-4xl font-bold mb-3", children: [
          /* @__PURE__ */ jsx("span", { className: "text-white", children: "Why PMs Need " }),
          /* @__PURE__ */ jsx("span", { className: "text-blue-500", children: "GenAI Skills" })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-lg text-blue-100", children: "See how GenAI addresses the biggest challenges in product management and opens new career paths" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx("h4", { className: "text-base font-semibold  mb-1", children: challenge.title }),
        ...
        /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-3 gap-6", children: solutions.map((solution, index) => /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("h4", { className: "text-base font-semibold  mb-1", children: solution.title }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "group p-6 rounded-xl bg-white/10  border border-white/20   transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-white/10 backdrop-blur-2xl", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-blue-900 mb-4", children: "Industries Where PMs Use GenAI" }),
...
const GENMentors = () => {
  ...
  return /* @__PURE__ */ jsx("section", { className: "relative py-16 bg-black overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsx("div", { className: "inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-4", children: /* @__PURE__ */ jsx("span", { className: "text-sm text-blue-400 font-medium", children: "Learn From Industry Experts" }) }),
      /* @__PURE__ */ jsxs("h3", { className: "text-3xl md:text-4xl font-bold text-white mb-4", children: [
        "Meet Your ",
        /* @__PURE__ */ jsx("span", { className: "text-blue-500", children: "Mentors" })
      ] }),
      /* @__PURE__ */ jsx("p", { className: "text-gray-400 text-lg max-w-3xl mx-auto", children: "Learn from experienced professionals who will guide you through your GenAI journey" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: mentors.map((mentor, index) => /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("div", { className: "w-32 h-32 rounded-full overflow-hidden bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center", children: /* @__PURE__ */ jsx(
            "img",
            {
              src: mentor.image,
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 text-center md:text-left", children: [
            /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold text-white mb-1", children: mentor.name }),
            /* @__PURE__ */ jsx("p", { className: "text-gray-400 text-sm mb-3", children: mentor.designation }),
            ...
            /* @__PURE__ */ jsxs(
              "a",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "text-sm", children: "LinkedIn Profile" })
                ]
              }
            )
          ] })
...
const GENToolsYouWillLearn = () => {
  const [activeCategory, setActiveCategory] = useState("GenAI for PMs");
  const projects = [
    {
  ...
  return /* @__PURE__ */ jsx("section", { className: "relative py-6 ", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto flex flex-col gap-20", children: [
    /* @__PURE__ */ jsxs("div", { className: "mb-12", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 bg-blue-50 rounded-full px-3 py-1.5 mb-2", children: [
          /* @__PURE__ */ jsx(Rocket, { className: "w-3.5 h-3.5 text-blue-600" }),
          /* @__PURE__ */ jsx("span", { className: "text-blue-600 text-xs font-medium", children: "Hands-on Projects" })
        ] }),
        /* @__PURE__ */ jsx("h3", { className: "text-2xl md:text-3xl font-bold  mb-2", children: "Build Real GenAI Solutions for PMs" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-400 text-base max-w-2xl mx-auto", children: "Apply your skills through practical projects that solve real product management problems" })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3", children: projects.map((project, index) => /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2 mb-2", children: [
              ...
              /* @__PURE__ */ jsx("h3", { className: "text-base font-semibold  ", children: project.title })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400 pl-3.5", children: project.description })
          ]
        },
        index
      )) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mb-6 text-center flex flex-col gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 max-w-[200px] mx-auto bg-blue-50 rounded-full px-3 py-1.5 mb-2", children: [
        /* @__PURE__ */ jsx(Wrench, { className: "w-3.5 h-3.5 text-blue-600" }),
        /* @__PURE__ */ jsx("span", { className: "text-blue-600 text-xs font-medium", children: "Tools & Technologies" })
      ] }),
      /* @__PURE__ */ jsx("h3", { className: "text-2xl md:text-3xl font-bold   mb-2", children: "Master GenAI Tools for Product Management" }),
      /* @__PURE__ */ jsx("p", { className: "text-gray-600 text-base max-w-2xl mx-auto", children: "Get hands-on experience with the most powerful GenAI tools for PMs" }),
      /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2 mb-6 justify-center", children: Object.entries(categoryInfo).map(([category, info]) => {
        ...
        return /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-sm font-medium whitespace-nowrap", children: info.name })
            ] })
          },
          category
        );
      }) }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3", children: tools.filter((tool) => tool.category === activeCategory).map((tool, index) => /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h4", { className: "text-sm font-semibold  mb-1", children: tool.name }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-400 line-clamp-2", children: tool.description })
            ] })
          ]
        },
        index
...
const GENProjectsAndOutcomes = () => {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative py-6 my-20  overflow-hidden", children: [
    /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 relative z-10", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "lg:flex items-center gap-12", children: [
      /* @__PURE__ */ jsx("div", { className: "lg:w-5/12 mb-8 lg:mb-0", children: /* @__PURE__ */ jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-blue-500/10 to-indigo-500/10 rounded-3xl" }),
        /* @__PURE__ */ jsx("img", { src: "/genibg.webp", alt: "AI Projects", className: "relative rounded-3xl shadow-lg animate-fade-in" }),
        /* @__PURE__ */ jsx("div", { className: "absolute -bottom-4 -right-4 w-24 h-24 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-full opacity-20 blur-2xl" })
      ] }) }),
      /* @__PURE__ */ jsxs("div", { className: "lg:w-7/12", children: [
        /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 bg-blue-50 rounded-full px-3 py-1.5 mb-2 animate-fade-in", children: [
            /* @__PURE__ */ jsx(Rocket, { className: "w-3.5 h-3.5 text-blue-600" }),
            /* @__PURE__ */ jsx("span", { className: "text-blue-600 text-xs font-medium", children: "Projects & Outcomes" })
          ] }),
          /* @__PURE__ */ jsx("h3", { className: "text-2xl md:text-3xl font-bold  mb-2 animate-fade-in", children: "Build Real GenAI Solutions for Product Managers" }),
          /* @__PURE__ */ jsx("p", { className: "text-gray-600 text-base max-w-2xl animate-fade-in", children: "Apply your GenAI skills through hands-on projects that solve real product management challenges" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "space-y-3", children: projects.map((project, index) => /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsx("div", { className: "w-1.5 h-1.5 rounded-full bg-blue-500 flex-shrink-0 group-hover:scale-125 transition-transform duration-300" }),
              /* @__PURE__ */ jsxs("div", { className: "flex-grow", children: [
                /* @__PURE__ */ jsx("h3", { className: "text-sm font-semibold  mb-0.5 group-hover:text-blue-600 transition-colors duration-300", children: project.title }),
                /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-400", children: project.description })
              ] })
            ] })
          },
          index
...
const GENPricing = () => {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative py-12 bg-black", children: [
    /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-blue-950/20 to-transparent" }),
    /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-2xl md:text-3xl font-bold text-white mb-3", children: "Invest in Your AI Future" }),
      /* @__PURE__ */ jsx("p", { className: "text-gray-400 text-sm", children: "Join our comprehensive AI program and master the future of technology" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "container grid grid-cols-1 gap-4 items-start js px-4 relative z-10", children: /* @__PURE__ */ jsx("div", { className: "w-full mx-auto", children: /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center gap-8 w-full mx-auto", children: plans.map((plan, index) => /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "text-center mb-8", children: [
            /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-white mb-2", children: plan.name }),
            /* @__PURE__ */ jsx("p", { className: "text-gray-400 mb-4", children: plan.description }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-baseline justify-center gap-1 mb-2", children: [
              /* @__PURE__ */ jsx("span", { className: "text-3xl font-bold text-white", children: "₹" }),
              /* @__PURE__ */ jsxs("span", { className: "text-4xl flex gap-2 items-center font-bold bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text", children: [
                plan.currentPrice,
                " ",
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-4 mb-8", children: plan.features.map((feature, featureIndex) => /* @__PURE__ */ jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsx(Check, { className: "w-4 h-4 text-blue-400 flex-shrink-0" }),
...
const GENFAQ = () => {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative py-12 bg-black", children: [
    /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-transparent to-blue-950/20" }),
    /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 bg-blue-500/10 rounded-full px-3 py-1.5 mb-3", children: [
          /* @__PURE__ */ jsx(HelpCircle, { className: "w-3.5 h-3.5 text-blue-400" }),
          /* @__PURE__ */ jsx("span", { className: "text-blue-400 text-xs font-medium", children: "FAQ" })
        ] }),
        /* @__PURE__ */ jsx("h2", { className: "text-2xl md:text-3xl font-bold text-white mb-3", children: "Frequently Asked Questions" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-400 text-sm", children: "Get answers to common questions about GenAI for Product Managers" })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "space-y-3", children: faqs.map((faq, index) => /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-white", children: faq.question }),
                  /* @__PURE__ */ jsx(
                    ChevronDown,
                    {
            ...
            openIndex === index && /* @__PURE__ */ jsx("div", { className: "px-4 pb-3 text-sm text-gray-400 animate-fade-in", children: faq.answer })
          ]
        },
        index
      )) }),
      /* @__PURE__ */ jsx("div", { className: "mt-8 text-center", children: /* @__PURE__ */ jsxs("p", { className: "text-xs text-gray-500", children: [
...
const GENMarketScope = () => {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative py-16 bg-black overflow-hidden", children: [
    /* @__PURE__ */ jsx("div", { className: "absolute inset-0", children: /* @__PURE__ */ jsx(
      "div",
      {
        className: "absolute inset-0 bg-[linear-gradient(to_right,#1a1a1a_1px,transparent_1px),linear-gradient(to_bottom,#1a1a1a_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_100%)]",
    ...
    /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-black via-black/90 to-black" }),
    /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-16", children: [
        /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6", children: [
          /* @__PURE__ */ jsx(TrendingUp, { className: "w-4 h-4 text-blue-400" }),
          /* @__PURE__ */ jsx("span", { className: "text-blue-400 text-sm font-medium", children: "GenAI Market for PMs" })
        ] }),
        /* @__PURE__ */ jsx("h2", { className: "text-3xl md:text-4xl font-bold text-white mb-4", children: "GenAI is Transforming Product Management" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-400 text-lg max-w-3xl mx-auto", children: "The rise of Generative AI is revolutionizing how product managers build, launch, and scale products. Explore the booming market and career opportunities for PMs who master GenAI." })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16", children: marketStats.map((stat, index) => /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-3", children: [
              /* @__PURE__ */ jsx("div", { className: "p-2 rounded-lg bg-white/10", children: stat.icon }),
              /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold text-white", children: stat.value })
            ] }),
            /* @__PURE__ */ jsx("h3", { className: "text-sm font-semibold text-gray-300 mb-2", children: stat.label }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400", children: stat.description })
          ]
        },
        index
      )) }),
      /* @__PURE__ */ jsxs("div", { className: "backdrop-blur-sm rounded-2xl  ", children: [
        /* @__PURE__ */ jsx("h4", { className: "text-2xl font-bold text-white mb-8 text-center", children: "High-Paying PM Roles in GenAI" }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6 bg-white/5 ", children: opportunities.map((job, index) => /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("h4", { className: "text-lg font-semibold text-white mb-2 group-hover:text-blue-400 transition-colors", children: job.title }),
                /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400 mb-3", children: job.description })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "text-sm font-medium text-emerald-400 bg-emerald-500/10 px-3 py-1 rounded-full whitespace-nowrap", children: job.salary })
            ] })
          },
          index
        )) })
...
const GENLearningJourney = () => {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative py-12 bg-black", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "container mx-auto px-3 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto flex flex-col gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 bg-white rounded-full px-4 py-2 mb-3 transform hover:scale-105 transition-all", children: [
          /* @__PURE__ */ jsx(Calendar, { className: "w-4 h-4 text-blue-600" }),
          /* @__PURE__ */ jsx("span", { className: "text-blue-600 text-sm font-medium", children: "Learning Journey" })
        ] }),
        /* @__PURE__ */ jsx("h3", { className: "text-3xl md:text-4xl font-bold text-white mb-3", children: "Your GenAI PM Learning Path" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-300 text-lg max-w-2xl", children: "An 8-week intensive journey to master GenAI for product management and accelerate your PM career" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-6", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "flex items-center gap-3", children: weeks.map((_, index) => /* @__PURE__ */ jsx(
          "button",
          {
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4 mb-6", children: [
          /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 p-2.5 rounded-lg bg-blue-500/10", children: /* @__PURE__ */ jsx(WeekIcon, { className: "w-6 h-6 text-blue-400" }) }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-white mb-2", children: weeks[activeWeek].title }),
        ...
        /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 gap-4", children: weeks[activeWeek].cards.map((card, cardIndex) => /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("h4", { className: "text-lg font-semibold text-white mb-3 flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-full bg-blue-400" }),
                card.title
              ] }),
              /* @__PURE__ */ jsx("ul", { className: "space-y-2", children: card.content.map((point, pointIndex) => /* @__PURE__ */ jsxs("li", { className: "text-gray-300 text-sm flex items-start gap-2", children: [
                /* @__PURE__ */ jsx("div", { className: "w-1 h-1 rounded-full bg-blue-400 flex-shrink-0 mt-2" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-6 flex items-center justify-between text-sm text-gray-400", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("div", { className: "w-32 h-2 bg-gray-700 rounded-full overflow-hidden", children: /* @__PURE__ */ jsx(
              "div",
              {
