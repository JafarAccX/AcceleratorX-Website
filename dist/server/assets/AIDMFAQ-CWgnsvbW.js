...
const AIDMFAQ = () => {
  ...
  return /* @__PURE__ */ jsx("section", { className: "py-24", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    ...
    /* @__PURE__ */ jsxs(motion.div, { initial: { opacity: 0, y: 20 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true }, className: "text-center mt-12 p-8 bg-[#0F0F0F] rounded-xl border border-white/10", children: [
      /* @__PURE__ */ jsx("h4", { className: "text-2xl font-bold text-white mb-4", children: "Still have questions?" }),
      /* @__PURE__ */ jsx("p", { className: "text-gray-400 mb-6", children: "Can't find the answer you're looking for? Please chat with our team." }),
      /* @__PURE__ */ jsx(
        motion.button,
        {
