  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative py-12 bg-black px-4", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-3 relative z-10", children: [
      /* @__PURE__ */ jsxs("div", { className: "max-w-screen-md items-center", children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "text-3xl  l font-bold mb-3", children: /* @__PURE__ */ jsx("span", { className: "text-white", children: "This is for you if you’ve ever thought: “AI is powerful, but I don’t know where to start.”" }) })
      ] }),
