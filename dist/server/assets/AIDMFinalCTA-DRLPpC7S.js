...
const AIDMFinalCTA = () => {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative py-24 px-4 bg-gradient-to-r from-blue-900 via-indigo-900 to-purple-900 text-white overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto text-center relative z-10", children: /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("h2", { className: "text-3xl md:text-4xl font-bold mb-4", children: "Your future begins here. Join today" }),
      /* @__PURE__ */ jsx("p", { className: "text-xl mb-8 opacity-90", children: "Get quick access to syllabus, tool checklist, and earlybird executive pricing." }),
      /* @__PURE__ */ jsx(
        "button",
        {
