...
const DMFAQs = () => {
  ...
  return /* @__PURE__ */ jsx("section", { className: "py-10 bg-neutral-900", children: /* @__PURE__ */ jsx("div", { className: "container", children: /* @__PURE__ */ jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsx("h2", { className: "text-3xl pb-2 md:text-5xl font-bold text-center mb-16 highlight-text", children: "FAQ" }),
            ...
            children: [
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("span", { className: "text-lg font-mono text-neon-yellow", children: faq.question }),
                    /* @__PURE__ */ jsx(
                      FaChevronDown,
                      {
              ...
              /* @__PURE__ */ jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsx("p", { className: "font-mono text-neutral-100/70", children: faq.answer })
                }
              )
            ]
          },
