          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-6 flex items-start justify-center flex-col ", children: [
                ...
                motion.h1,
                {
                  ...
                  children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
                    /* @__PURE__ */ jsxs("span", { className: "text-transparent bg-clip-text bg-gradient-to-r pb-4 from-white via-blue-100 to-green-200", children: [
                      /* @__PURE__ */ jsx("span", { className: " text-yellow-400 underline  ", children: "Build & Deploy" }),
                      " ",
                      /* @__PURE__ */ jsx("br", {}),
              ...
              /* @__PURE__ */ jsxs(motion.div, { initial: { y: 20, opacity: 0 }, animate: { y: 0, opacity: 1 }, transition: { duration: 0.8 }, children: [
                /* @__PURE__ */ jsx("p", { className: "  text-gray-400 max-w-xl", children: "Learn to build and deploy your own AI applications from scratch." }),
                /* @__PURE__ */ jsx("p", { className: "  text-gray-400 max-w-xl", children: "In this hands-on workshop, you'll create real AI applications step by step. No fluff. No heavy theory. Just practical skills you can apply instantly." })
              ] })
            ] }),
