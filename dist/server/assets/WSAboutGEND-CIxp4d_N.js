...
const WSAboutGEND = () => {
  return /* @__PURE__ */ jsxs("div", { className: "relative bg-[#000] py-2 overflow-hidden mt-10", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4 items-center justify-center", children: [
      /* @__PURE__ */ jsx("img", { src: "/langchain.webp", alt: "LLM Models & Fine Tuning Workshop", className: "rounded-2xl shadow-2xl" }),
      /* @__PURE__ */ jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-6", children: [
              /* @__PURE__ */ jsxs(
                motion.div,
                {
                  ...
                  transition: { duration: 0.2 },
                  children: [
                    /* @__PURE__ */ jsxs(motion.div, { className: "flex items-center gap-3 mb-4", whileHover: { gap: "0.875rem" }, children: [
                      /* @__PURE__ */ jsx(
                        motion.div,
                        {
                          ...
                          children: /* @__PURE__ */ jsx(Brain, { className: "w-5 h-5 text-blue-400" })
                        }
                      ),
                      /* @__PURE__ */ jsx("h3", { className: "font-semibold text-white", children: "What You'll Do:" })
                    ] }),
                    ...
                    /* @__PURE__ */ jsxs(motion.div, { className: "flex items-center gap-3 mb-4", whileHover: { gap: "0.875rem" }, children: [
                      /* @__PURE__ */ jsx(
                        motion.div,
                        {
                          ...
                          whileHover: { rotate: [0, -5, 5, 0] },
                          transition: { duration: 0.3 },
                          children: /* @__PURE__ */ jsx(Target, { className: "w-5 h-5 text-green-400" })
                        }
                      ),
                      /* @__PURE__ */ jsx("h3", { className: "font-semibold text-white", children: "What You'll Learn:" })
                    ] }),
                    /* @__PURE__ */ jsx("ul", { className: "space-y-3", children: [
