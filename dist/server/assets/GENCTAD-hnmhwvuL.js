        ...
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4 w-full", children: [
            /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-4 rounded-lg text-center", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-green-400", children: "Train Custom Models" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400", children: "From dataset to fine-tuned AI." })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-4 rounded-lg text-center", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400", children: "Learn the process with mentor-led support." })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-4 rounded-lg text-center", children: [
              /* @__PURE__ */ jsx(Code, { className: "w-6 h-6 text-blue-400 mx-auto mb-2" }),
              /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-blue-400", children: "Real Applications" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400", children: "Build something that actually works." })
            ] })
          ] })
        }
      ),
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("p", { children: "Join 100+ learners who have already trained and deployed their own LLMs." }),
            /* @__PURE__ */ jsx("p", { children: "Click Register Now and start your fine-tuning journey today!" }),
            /* @__PURE__ */ jsxs(
              "button",
              {
