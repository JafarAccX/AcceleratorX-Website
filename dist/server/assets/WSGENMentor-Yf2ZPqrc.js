            ...
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-center gap-6", children: [
                /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                  /* @__PURE__ */ jsx("div", { className: "w-36 h-36 rounded-2xl overflow-hidden border-2 border-indigo-500/30", children: /* @__PURE__ */ jsx("img", { src: mentor.image, alt: mentor.alt, className: "w-full h-full object-cover" }) }),
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex-1 text-center sm:text-left", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "space-y-2 text-gray-300 text-sm", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
                      ...
                      /* @__PURE__ */ jsx("p", { children: mentor.role })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
