...
function RegistrationSuccess() {
  ...
  return /* @__PURE__ */ jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "max-w-2xl w-full text-center space-y-8", children: [
        /* @__PURE__ */ jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsx("div", { className: "w-24 h-24 rounded-full bg-green-500/20 flex items-center justify-center", children: /* @__PURE__ */ jsx("svg", { className: "w-16 h-16 text-green-500", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx(
              motion.path,
              {
                strokeLinecap: "round",
        ...
        /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-xl text-gray-300", children: "Your enrollment for Product Teardown has been successfully submitted." })
            ]
          }
        ),
        /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-1 gap-4 max-w-2xl mx-auto", children: /* @__PURE__ */ jsxs(
                motion.a,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "relative flex items-center gap-4 bg-gray-900 p-4 rounded-[10px] transition-all duration-300 group-hover:bg-gray-900/80", children: [
                      ...
                      /* @__PURE__ */ jsx("div", { className: "flex flex-col items-start", children: /* @__PURE__ */ jsx("span", { className: "font-semibold text-lg text-white group-hover:text-green-400 transition-colors duration-300", children: "Join WhatsApp" }) })
                    ] })
                  ]
                }
              ) })
