  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative min-h-screen overflow-hidden bg-gradient-to-b from-black via-[#0A0F1F] to-black px-4", children: [
    ...
    /* @__PURE__ */ jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "container mx-auto   py-4 flex justify-between items-center", children: /* @__PURE__ */ jsx("div", { className: "w-44 md:w-52 hover:scale-105 transition-transform duration-300", children: /* @__PURE__ */ jsx("img", { src: "/companylogo-new.webp", alt: "company logo - professional certificate in product management online", className: "w-full h-auto" }) }) })
      }
    ),
          ...
          children: [
            /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "text-blue-400 font-medium", children: "Hands-on Automation Workshop" })
                ]
              }
            ),
            /* @__PURE__ */ jsxs("div", { className: "space-y-6 flex items-start justify-center flex-col ", children: [
                ...
                motion.h1,
                {
                  ...
                  children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
                    /* @__PURE__ */ jsxs("span", { className: "text-transparent bg-clip-text bg-gradient-to-r pb-4 from-white via-blue-100 to-green-200", children: [
                      /* @__PURE__ */ jsx("span", { className: " text-yellow-400 underline  ", children: "Start Your Automation" }),
                      " ",
                      /* @__PURE__ */ jsx("br", {}),
                      "with Flowise"
                    ] }),
              ...
              /* @__PURE__ */ jsxs(motion.div, { initial: { y: 20, opacity: 0 }, animate: { y: 0, opacity: 1 }, transition: { duration: 0.8 }, children: [
                /* @__PURE__ */ jsx("p", { className: "  text-gray-400 max-w-xl", children: "Learn how to automate workflows and build your own AI-driven systems using Flowise — no coding expertise required." }),
                /* @__PURE__ */ jsx("p", { className: "  text-gray-400 max-w-xl", children: "In this hands-on workshop, you'll learn how to create smart, automated flows step-by-step and deploy them instantly. No fluff. No theory. Just real-world automation you can implement right away." })
              ] })
            ] }),
