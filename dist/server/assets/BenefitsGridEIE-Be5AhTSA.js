...
import { Trophy, Users, BookOpen, Target, Star, Briefcase } from "lucide-react";
const benefits = [
  {
...
function BenefitsGridEIE() {
  return /* @__PURE__ */ jsx("section", { id: "benefits", className: "py-24 bg-white/5", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center mb-16", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-2xl font-medium text-gray-400 mb-4", children: "Program Benefits" }),
      /* @__PURE__ */ jsxs("h3", { className: "text-4xl md:text-5xl font-bold ", children: [
        "What Sets AcceleratorX ",
        " ",
        /* @__PURE__ */ jsx("span", { className: "text-[#5CB338]", children: "AI Product Management Program Apart" }),
        "?"
      ] })
    ] }),
